...
from click_funnels_python_sdk.model.orders_invoices_restock_get_restock401_response import OrdersInvoicesRestockGetRestock401Response as OrdersInvoicesRestockGetRestock401ResponseSchema
from click_funnels_python_sdk.model.orders_invoices_restock_get_restock_response import OrdersInvoicesRestockGetRestockResponse as OrdersInvoicesRestockGetRestockResponseSchema
from click_funnels_python_sdk.model.orders_invoices_restock_get_restock404_response import OrdersInvoicesRestockGetRestock404Response as OrdersInvoicesRestockGetRestock404ResponseSchema

from click_funnels_python_sdk.type.orders_invoices_restock_get_restock401_response import OrdersInvoicesRestockGetRestock401Response
from click_funnels_python_sdk.type.orders_invoices_restock_get_restock404_response import OrdersInvoicesRestockGetRestock404Response
from click_funnels_python_sdk.type.orders_invoices_restock_get_restock_response import OrdersInvoicesRestockGetRestockResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.orders_invoices_restock_get_restock_response import OrdersInvoicesRestockGetRestockResponse as OrdersInvoicesRestockGetRestockResponsePydantic
from click_funnels_python_sdk.pydantic.orders_invoices_restock_get_restock401_response import OrdersInvoicesRestockGetRestock401Response as OrdersInvoicesRestockGetRestock401ResponsePydantic
from click_funnels_python_sdk.pydantic.orders_invoices_restock_get_restock404_response import OrdersInvoicesRestockGetRestock404Response as OrdersInvoicesRestockGetRestock404ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OrdersInvoicesRestockGetRestockResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OrdersInvoicesRestockGetRestockResponse
...
SchemaFor401ResponseBodyApplicationJson = OrdersInvoicesRestockGetRestock401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: OrdersInvoicesRestockGetRestock401Response
...
SchemaFor404ResponseBodyApplicationJson = OrdersInvoicesRestockGetRestock404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: OrdersInvoicesRestockGetRestock404Response
    ...
    async def _aget_restock_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orders/invoices/restocks/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetRestockRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_restock(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_restock_mapped_args(
            id=id,
        )
        return await self._aget_restock_oapg(
    ...
    def get_restock(
        ...
        return self._get_restock_oapg(
            path_params=args.path,
        )

class GetRestock(BaseApi):
    ...
    async def aget_restock(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrdersInvoicesRestockGetRestockResponsePydantic:
        raw_response = await self.raw.aget_restock(
            id=id,
            **kwargs,
        )
        if validate:
            return OrdersInvoicesRestockGetRestockResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OrdersInvoicesRestockGetRestockResponsePydantic, raw_response.body)
    ...
    def get_restock(
        ...
        raw_response = self.raw.get_restock(
            id=id,
        )
        if validate:
            return OrdersInvoicesRestockGetRestockResponsePydantic(**raw_response.body)
