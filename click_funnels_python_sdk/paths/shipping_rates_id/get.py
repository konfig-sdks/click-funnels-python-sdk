...
from click_funnels_python_sdk.model.shipping_rate_get_rate_by_id404_response import ShippingRateGetRateById404Response as ShippingRateGetRateById404ResponseSchema
from click_funnels_python_sdk.model.shipping_rate_get_rate_by_id_response import ShippingRateGetRateByIdResponse as ShippingRateGetRateByIdResponseSchema
...
from click_funnels_python_sdk.type.shipping_rate_get_rate_by_id404_response import ShippingRateGetRateById404Response
from click_funnels_python_sdk.type.shipping_rate_get_rate_by_id_response import ShippingRateGetRateByIdResponse
...
from click_funnels_python_sdk.pydantic.shipping_rate_get_rate_by_id404_response import ShippingRateGetRateById404Response as ShippingRateGetRateById404ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_rate_get_rate_by_id_response import ShippingRateGetRateByIdResponse as ShippingRateGetRateByIdResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = ShippingRateGetRateByIdResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingRateGetRateByIdResponse
...
SchemaFor404ResponseBodyApplicationJson = ShippingRateGetRateById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingRateGetRateById404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_rate_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_rate_by_id_oapg(
        self,
...
class GetRateByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_rate_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_rate_by_id_mapped_args(
            id=id,
        )
        return await self._aget_rate_by_id_oapg(
    ...
    def get_rate_by_id(
        ...
        return self._get_rate_by_id_oapg(
            path_params=args.path,
        )

class GetRateById(BaseApi):
    ...
    async def aget_rate_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_rate_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_rate_by_id(
        ...
        raw_response = self.raw.get_rate_by_id(
            id=id,
        )
        if validate:
            return ShippingRateAttributesPydantic(**raw_response.body)
