...
from click_funnels_python_sdk.model.shipping_rate_update_rate_for_zone401_response import ShippingRateUpdateRateForZone401Response as ShippingRateUpdateRateForZone401ResponseSchema
from click_funnels_python_sdk.model.shipping_rate_update_rate_for_zone_request import ShippingRateUpdateRateForZoneRequest as ShippingRateUpdateRateForZoneRequestSchema
from click_funnels_python_sdk.model.shipping_rate_update_rate_for_zone_response import ShippingRateUpdateRateForZoneResponse as ShippingRateUpdateRateForZoneResponseSchema
from click_funnels_python_sdk.model.shipping_rate_update_rate_for_zone404_response import ShippingRateUpdateRateForZone404Response as ShippingRateUpdateRateForZone404ResponseSchema
from click_funnels_python_sdk.model.shipping_rate_attributes import ShippingRateAttributes as ShippingRateAttributesSchema

from click_funnels_python_sdk.type.shipping_rate_update_rate_for_zone_response import ShippingRateUpdateRateForZoneResponse
from click_funnels_python_sdk.type.shipping_rate_update_rate_for_zone_request import ShippingRateUpdateRateForZoneRequest
from click_funnels_python_sdk.type.shipping_rate_attributes import ShippingRateAttributes
from click_funnels_python_sdk.type.shipping_rate_update_rate_for_zone401_response import ShippingRateUpdateRateForZone401Response
from click_funnels_python_sdk.type.shipping_rate_update_rate_for_zone404_response import ShippingRateUpdateRateForZone404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_rate_update_rate_for_zone_request import ShippingRateUpdateRateForZoneRequest as ShippingRateUpdateRateForZoneRequestPydantic
from click_funnels_python_sdk.pydantic.shipping_rate_update_rate_for_zone404_response import ShippingRateUpdateRateForZone404Response as ShippingRateUpdateRateForZone404ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_rate_attributes import ShippingRateAttributes as ShippingRateAttributesPydantic
from click_funnels_python_sdk.pydantic.shipping_rate_update_rate_for_zone_response import ShippingRateUpdateRateForZoneResponse as ShippingRateUpdateRateForZoneResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_rate_update_rate_for_zone401_response import ShippingRateUpdateRateForZone401Response as ShippingRateUpdateRateForZone401ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ShippingRateUpdateRateForZoneRequestSchema


request_body_shipping_rate_update_rate_for_zone_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ShippingRateAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ShippingRateAttributes
...
SchemaFor400ResponseBodyApplicationJson = ShippingRateUpdateRateForZoneResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ShippingRateUpdateRateForZoneResponse
...
SchemaFor401ResponseBodyApplicationJson = ShippingRateUpdateRateForZone401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingRateUpdateRateForZone401Response
...
SchemaFor404ResponseBodyApplicationJson = ShippingRateUpdateRateForZone404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingRateUpdateRateForZone404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_rate_for_zone_mapped_args(
        self,
        id: str,
        shipping_rate: typing.Optional[ShippingRateParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if shipping_rate is not None:
            _body["shipping_rate"] = shipping_rate
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_rate_for_zone_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/shipping/rates/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_shipping_rate_update_rate_for_zone_request.serialize(body, content_type)
    ...
    def _update_rate_for_zone_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateRateForZoneRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_rate_for_zone(
        self,
        id: str,
        shipping_rate: typing.Optional[ShippingRateParameters] = None,
        **kwargs,
        ...
        args = self._update_rate_for_zone_mapped_args(
            id=id,
            shipping_rate=shipping_rate,
        )
        return await self._aupdate_rate_for_zone_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_rate_for_zone(
        self,
        id: str,
        shipping_rate: typing.Optional[ShippingRateParameters] = None,
    ) -> typing.Union[
        ...
        return self._update_rate_for_zone_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateRateForZone(BaseApi):
    ...
    async def aupdate_rate_for_zone(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShippingRateAttributesPydantic:
        raw_response = await self.raw.aupdate_rate_for_zone(
            id=id,
            shipping_rate=shipping_rate,
            **kwargs,
        )
        if validate:
            return ShippingRateAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ShippingRateAttributesPydantic, raw_response.body)
    ...
    def update_rate_for_zone(
        ...
        raw_response = self.raw.update_rate_for_zone(
            id=id,
            shipping_rate=shipping_rate,
        )
        if validate:
