...
from click_funnels_python_sdk.model.forms_submissions_answer_add_new_answer401_response import FormsSubmissionsAnswerAddNewAnswer401Response as FormsSubmissionsAnswerAddNewAnswer401ResponseSchema
from click_funnels_python_sdk.model.forms_submissions_answer_add_new_answer_response import FormsSubmissionsAnswerAddNewAnswerResponse as FormsSubmissionsAnswerAddNewAnswerResponseSchema
from click_funnels_python_sdk.model.forms_submissions_answer_add_new_answer_request import FormsSubmissionsAnswerAddNewAnswerRequest as FormsSubmissionsAnswerAddNewAnswerRequestSchema
...
from click_funnels_python_sdk.type.forms_submissions_answer_add_new_answer401_response import FormsSubmissionsAnswerAddNewAnswer401Response
from click_funnels_python_sdk.type.forms_submissions_answer_attributes import FormsSubmissionsAnswerAttributes
from click_funnels_python_sdk.type.forms_submissions_answer_add_new_answer_request import FormsSubmissionsAnswerAddNewAnswerRequest
from click_funnels_python_sdk.type.forms_submissions_answer_add_new_answer_response import FormsSubmissionsAnswerAddNewAnswerResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_submissions_answer_add_new_answer401_response import FormsSubmissionsAnswerAddNewAnswer401Response as FormsSubmissionsAnswerAddNewAnswer401ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_submissions_answer_add_new_answer_response import FormsSubmissionsAnswerAddNewAnswerResponse as FormsSubmissionsAnswerAddNewAnswerResponsePydantic
...
from click_funnels_python_sdk.pydantic.forms_submissions_answer_add_new_answer_request import FormsSubmissionsAnswerAddNewAnswerRequest as FormsSubmissionsAnswerAddNewAnswerRequestPydantic

from . import path

# Path params
SubmissionIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'submission_id': typing.Union[SubmissionIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = FormsSubmissionsAnswerAddNewAnswerRequestSchema


request_body_forms_submissions_answer_add_new_answer_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FormsSubmissionsAnswerAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = FormsSubmissionsAnswerAddNewAnswerResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormsSubmissionsAnswerAddNewAnswerResponse
...
SchemaFor401ResponseBodyApplicationJson = FormsSubmissionsAnswerAddNewAnswer401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsSubmissionsAnswerAddNewAnswer401Response
...
class BaseApi(api_client.Api):
    ...
    def _add_new_answer_mapped_args(
        self,
        submission_id: int,
    ...
    async def _aadd_new_answer_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/forms/submissions/{submission_id}/answers',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_forms_submissions_answer_add_new_answer_request.serialize(body, content_type)
...
class AddNewAnswerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_answer(
        self,
        submission_id: int,
        forms_submissions_answer: typing.Optional[FormsSubmissionsAnswerParameters] = None,
        **kwargs,
        ...
        args = self._add_new_answer_mapped_args(
            submission_id=submission_id,
            forms_submissions_answer=forms_submissions_answer,
        )
        return await self._aadd_new_answer_oapg(
            body=args.body,
    ...
    def add_new_answer(
        ...
        return self._add_new_answer_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddNewAnswer(BaseApi):
    ...
    async def aadd_new_answer(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_new_answer(
            submission_id=submission_id,
            forms_submissions_answer=forms_submissions_answer,
            **kwargs,
        )
    ...
    def add_new_answer(
        ...
        raw_response = self.raw.add_new_answer(
            submission_id=submission_id,
            forms_submissions_answer=forms_submissions_answer,
        )
        if validate:
