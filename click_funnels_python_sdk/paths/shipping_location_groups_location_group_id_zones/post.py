...
from click_funnels_python_sdk.model.shipping_zone_add_new_zone401_response import ShippingZoneAddNewZone401Response as ShippingZoneAddNewZone401ResponseSchema
from click_funnels_python_sdk.model.shipping_zone_add_new_zone_response import ShippingZoneAddNewZoneResponse as ShippingZoneAddNewZoneResponseSchema
from click_funnels_python_sdk.model.shipping_zone_add_new_zone_request import ShippingZoneAddNewZoneRequest as ShippingZoneAddNewZoneRequestSchema
...
from click_funnels_python_sdk.type.shipping_zone_add_new_zone401_response import ShippingZoneAddNewZone401Response
from click_funnels_python_sdk.type.shipping_zone_add_new_zone_response import ShippingZoneAddNewZoneResponse
from click_funnels_python_sdk.type.shipping_zone_add_new_zone_request import ShippingZoneAddNewZoneRequest
from click_funnels_python_sdk.type.shipping_zone_attributes import ShippingZoneAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_zone_add_new_zone_request import ShippingZoneAddNewZoneRequest as ShippingZoneAddNewZoneRequestPydantic
from click_funnels_python_sdk.pydantic.shipping_zone_add_new_zone_response import ShippingZoneAddNewZoneResponse as ShippingZoneAddNewZoneResponsePydantic
...
from click_funnels_python_sdk.pydantic.shipping_zone_add_new_zone401_response import ShippingZoneAddNewZone401Response as ShippingZoneAddNewZone401ResponsePydantic

from . import path

# Path params
LocationGroupIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'location_group_id': typing.Union[LocationGroupIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_location_group_id = api_client.PathParameter(
    name="location_group_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=LocationGroupIdSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = ShippingZoneAddNewZoneRequestSchema


request_body_shipping_zone_add_new_zone_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ShippingZoneAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = ShippingZoneAddNewZoneResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ShippingZoneAddNewZoneResponse
...
SchemaFor401ResponseBodyApplicationJson = ShippingZoneAddNewZone401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingZoneAddNewZone401Response
...
class BaseApi(api_client.Api):
    ...
    def _add_new_zone_mapped_args(
        ...
        if location_group_id is not None:
            _path_params["location_group_id"] = location_group_id
        args.path = _path_params
        return args

    async def _aadd_new_zone_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_location_group_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/shipping/location_groups/{location_group_id}/zones',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_shipping_zone_add_new_zone_request.serialize(body, content_type)
...
class AddNewZoneRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_zone(
        self,
        location_group_id: int,
        shipping_zone: typing.Optional[ShippingZoneParameters] = None,
        **kwargs,
        ...
        args = self._add_new_zone_mapped_args(
            location_group_id=location_group_id,
            shipping_zone=shipping_zone,
        )
        return await self._aadd_new_zone_oapg(
            body=args.body,
    ...
    def add_new_zone(
        ...
        return self._add_new_zone_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddNewZone(BaseApi):
    ...
    async def aadd_new_zone(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_new_zone(
            location_group_id=location_group_id,
            shipping_zone=shipping_zone,
            **kwargs,
        )
    ...
    def add_new_zone(
        ...
        raw_response = self.raw.add_new_zone(
            location_group_id=location_group_id,
            shipping_zone=shipping_zone,
        )
        if validate:
