...
from click_funnels_python_sdk.model.fulfillment_update_by_id_request import FulfillmentUpdateByIdRequest as FulfillmentUpdateByIdRequestSchema
from click_funnels_python_sdk.model.fulfillment_update_by_id_response import FulfillmentUpdateByIdResponse as FulfillmentUpdateByIdResponseSchema
from click_funnels_python_sdk.model.fulfillment_update_by_id404_response import FulfillmentUpdateById404Response as FulfillmentUpdateById404ResponseSchema
from click_funnels_python_sdk.model.fulfillment_update_by_id401_response import FulfillmentUpdateById401Response as FulfillmentUpdateById401ResponseSchema
from click_funnels_python_sdk.model.fulfillment_attributes import FulfillmentAttributes as FulfillmentAttributesSchema

from click_funnels_python_sdk.type.fulfillment_update_by_id404_response import FulfillmentUpdateById404Response
from click_funnels_python_sdk.type.fulfillment_update_by_id_request import FulfillmentUpdateByIdRequest
from click_funnels_python_sdk.type.fulfillment_update_by_id401_response import FulfillmentUpdateById401Response
from click_funnels_python_sdk.type.fulfillment_update_by_id_response import FulfillmentUpdateByIdResponse
from click_funnels_python_sdk.type.fulfillment_attributes import FulfillmentAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.fulfillment_update_by_id404_response import FulfillmentUpdateById404Response as FulfillmentUpdateById404ResponsePydantic
from click_funnels_python_sdk.pydantic.fulfillment_update_by_id_request import FulfillmentUpdateByIdRequest as FulfillmentUpdateByIdRequestPydantic
from click_funnels_python_sdk.pydantic.fulfillment_attributes import FulfillmentAttributes as FulfillmentAttributesPydantic
from click_funnels_python_sdk.pydantic.fulfillment_update_by_id401_response import FulfillmentUpdateById401Response as FulfillmentUpdateById401ResponsePydantic
from click_funnels_python_sdk.pydantic.fulfillment_update_by_id_response import FulfillmentUpdateByIdResponse as FulfillmentUpdateByIdResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FulfillmentUpdateByIdRequestSchema


request_body_fulfillment_update_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FulfillmentAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FulfillmentAttributes
...
SchemaFor400ResponseBodyApplicationJson = FulfillmentUpdateByIdResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FulfillmentUpdateByIdResponse
...
SchemaFor401ResponseBodyApplicationJson = FulfillmentUpdateById401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FulfillmentUpdateById401Response
...
SchemaFor404ResponseBodyApplicationJson = FulfillmentUpdateById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FulfillmentUpdateById404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_by_id_mapped_args(
        self,
        id: str,
        fulfillment: typing.Optional[FulfillmentParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if fulfillment is not None:
            _body["fulfillment"] = fulfillment
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/fulfillments/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_fulfillment_update_by_id_request.serialize(body, content_type)
...
class UpdateById(BaseApi):
    ...
    async def aupdate_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return FulfillmentAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(FulfillmentAttributesPydantic, raw_response.body)
