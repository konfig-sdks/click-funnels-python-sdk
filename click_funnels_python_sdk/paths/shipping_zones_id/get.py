...
from click_funnels_python_sdk.model.shipping_zone_get_zone_by_id_response import ShippingZoneGetZoneByIdResponse as ShippingZoneGetZoneByIdResponseSchema
from click_funnels_python_sdk.model.shipping_zone_get_zone_by_id404_response import ShippingZoneGetZoneById404Response as ShippingZoneGetZoneById404ResponseSchema
...
from click_funnels_python_sdk.type.shipping_zone_get_zone_by_id404_response import ShippingZoneGetZoneById404Response
from click_funnels_python_sdk.type.shipping_zone_get_zone_by_id_response import ShippingZoneGetZoneByIdResponse
from click_funnels_python_sdk.type.shipping_zone_attributes import ShippingZoneAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_zone_get_zone_by_id404_response import ShippingZoneGetZoneById404Response as ShippingZoneGetZoneById404ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_zone_get_zone_by_id_response import ShippingZoneGetZoneByIdResponse as ShippingZoneGetZoneByIdResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = ShippingZoneGetZoneByIdResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingZoneGetZoneByIdResponse
...
SchemaFor404ResponseBodyApplicationJson = ShippingZoneGetZoneById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingZoneGetZoneById404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_zone_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_zone_by_id_oapg(
        self,
...
class GetZoneByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_zone_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_zone_by_id_mapped_args(
            id=id,
        )
        return await self._aget_zone_by_id_oapg(
    ...
    def get_zone_by_id(
        ...
        return self._get_zone_by_id_oapg(
            path_params=args.path,
        )

class GetZoneById(BaseApi):
    ...
    async def aget_zone_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_zone_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_zone_by_id(
        ...
        raw_response = self.raw.get_zone_by_id(
            id=id,
        )
        if validate:
            return ShippingZoneAttributesPydantic(**raw_response.body)
