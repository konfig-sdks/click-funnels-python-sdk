...
from click_funnels_python_sdk.model.shipping_zone_update_zone_by_id_request import ShippingZoneUpdateZoneByIdRequest as ShippingZoneUpdateZoneByIdRequestSchema
from click_funnels_python_sdk.model.shipping_zone_update_zone_by_id404_response import ShippingZoneUpdateZoneById404Response as ShippingZoneUpdateZoneById404ResponseSchema
from click_funnels_python_sdk.model.shipping_zone_update_zone_by_id401_response import ShippingZoneUpdateZoneById401Response as ShippingZoneUpdateZoneById401ResponseSchema
from click_funnels_python_sdk.model.shipping_zone_update_zone_by_id_response import ShippingZoneUpdateZoneByIdResponse as ShippingZoneUpdateZoneByIdResponseSchema
from click_funnels_python_sdk.model.shipping_zone_attributes import ShippingZoneAttributes as ShippingZoneAttributesSchema

from click_funnels_python_sdk.type.shipping_zone_update_zone_by_id404_response import ShippingZoneUpdateZoneById404Response
from click_funnels_python_sdk.type.shipping_zone_update_zone_by_id401_response import ShippingZoneUpdateZoneById401Response
from click_funnels_python_sdk.type.shipping_zone_update_zone_by_id_response import ShippingZoneUpdateZoneByIdResponse
from click_funnels_python_sdk.type.shipping_zone_attributes import ShippingZoneAttributes
from click_funnels_python_sdk.type.shipping_zone_update_zone_by_id_request import ShippingZoneUpdateZoneByIdRequest

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_zone_update_zone_by_id_response import ShippingZoneUpdateZoneByIdResponse as ShippingZoneUpdateZoneByIdResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_zone_update_zone_by_id401_response import ShippingZoneUpdateZoneById401Response as ShippingZoneUpdateZoneById401ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_zone_attributes import ShippingZoneAttributes as ShippingZoneAttributesPydantic
from click_funnels_python_sdk.pydantic.shipping_zone_update_zone_by_id_request import ShippingZoneUpdateZoneByIdRequest as ShippingZoneUpdateZoneByIdRequestPydantic
from click_funnels_python_sdk.pydantic.shipping_zone_update_zone_by_id404_response import ShippingZoneUpdateZoneById404Response as ShippingZoneUpdateZoneById404ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ShippingZoneUpdateZoneByIdRequestSchema


request_body_shipping_zone_update_zone_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ShippingZoneAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ShippingZoneAttributes
...
SchemaFor400ResponseBodyApplicationJson = ShippingZoneUpdateZoneByIdResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ShippingZoneUpdateZoneByIdResponse
...
SchemaFor401ResponseBodyApplicationJson = ShippingZoneUpdateZoneById401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingZoneUpdateZoneById401Response
...
SchemaFor404ResponseBodyApplicationJson = ShippingZoneUpdateZoneById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingZoneUpdateZoneById404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_zone_by_id_mapped_args(
        self,
        id: str,
        shipping_zone: typing.Optional[ShippingZoneParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if shipping_zone is not None:
            _body["shipping_zone"] = shipping_zone
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_zone_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/shipping/zones/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_shipping_zone_update_zone_by_id_request.serialize(body, content_type)
...
class UpdateZoneByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_zone_by_id(
        self,
        id: str,
        shipping_zone: typing.Optional[ShippingZoneParameters] = None,
        **kwargs,
        ...
        args = self._update_zone_by_id_mapped_args(
            id=id,
            shipping_zone=shipping_zone,
        )
        return await self._aupdate_zone_by_id_oapg(
            body=args.body,
    ...
    def update_zone_by_id(
        ...
        return self._update_zone_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateZoneById(BaseApi):
    ...
    async def aupdate_zone_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShippingZoneAttributesPydantic:
        raw_response = await self.raw.aupdate_zone_by_id(
            id=id,
            shipping_zone=shipping_zone,
            **kwargs,
        )
        if validate:
            return ShippingZoneAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ShippingZoneAttributesPydantic, raw_response.body)
    ...
    def update_zone_by_id(
        ...
        raw_response = self.raw.update_zone_by_id(
            id=id,
            shipping_zone=shipping_zone,
        )
        if validate:
