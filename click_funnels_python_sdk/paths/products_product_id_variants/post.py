...
from click_funnels_python_sdk.model.products_variant_create_new_variant_request import ProductsVariantCreateNewVariantRequest as ProductsVariantCreateNewVariantRequestSchema
from click_funnels_python_sdk.model.products_variant_create_new_variant_response import ProductsVariantCreateNewVariantResponse as ProductsVariantCreateNewVariantResponseSchema
...
from click_funnels_python_sdk.model.products_variant_create_new_variant401_response import ProductsVariantCreateNewVariant401Response as ProductsVariantCreateNewVariant401ResponseSchema

from click_funnels_python_sdk.type.products_variant_create_new_variant401_response import ProductsVariantCreateNewVariant401Response
from click_funnels_python_sdk.type.products_variant_create_new_variant_request import ProductsVariantCreateNewVariantRequest
from click_funnels_python_sdk.type.products_variant_create_new_variant_response import ProductsVariantCreateNewVariantResponse
from click_funnels_python_sdk.type.products_variant_attributes import ProductsVariantAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.products_variant_create_new_variant_response import ProductsVariantCreateNewVariantResponse as ProductsVariantCreateNewVariantResponsePydantic
...
from click_funnels_python_sdk.pydantic.products_variant_create_new_variant401_response import ProductsVariantCreateNewVariant401Response as ProductsVariantCreateNewVariant401ResponsePydantic
from click_funnels_python_sdk.pydantic.products_variant_create_new_variant_request import ProductsVariantCreateNewVariantRequest as ProductsVariantCreateNewVariantRequestPydantic

from . import path

# Path params
ProductIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'product_id': typing.Union[ProductIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = ProductsVariantCreateNewVariantRequestSchema


request_body_products_variant_create_new_variant_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ProductsVariantAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = ProductsVariantCreateNewVariantResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ProductsVariantCreateNewVariantResponse
...
SchemaFor401ResponseBodyApplicationJson = ProductsVariantCreateNewVariant401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductsVariantCreateNewVariant401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_new_variant_mapped_args(
        self,
        product_id: int,
    ...
    async def _acreate_new_variant_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/{product_id}/variants',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_products_variant_create_new_variant_request.serialize(body, content_type)
...
class CreateNewVariantRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_variant(
        self,
        product_id: int,
        products_variant: typing.Optional[ProductsVariantParameters] = None,
        **kwargs,
        ...
        args = self._create_new_variant_mapped_args(
            product_id=product_id,
            products_variant=products_variant,
        )
        return await self._acreate_new_variant_oapg(
            body=args.body,
    ...
    def create_new_variant(
        ...
        return self._create_new_variant_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewVariant(BaseApi):
    ...
    async def acreate_new_variant(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_variant(
            product_id=product_id,
            products_variant=products_variant,
            **kwargs,
        )
    ...
    def create_new_variant(
        ...
        raw_response = self.raw.create_new_variant(
            product_id=product_id,
            products_variant=products_variant,
        )
        if validate:
