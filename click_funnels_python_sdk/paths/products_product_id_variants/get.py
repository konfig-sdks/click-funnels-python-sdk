...
from click_funnels_python_sdk.model.products_variant_list_response import ProductsVariantListResponse as ProductsVariantListResponseSchema
from click_funnels_python_sdk.model.products_variant_list401_response import ProductsVariantList401Response as ProductsVariantList401ResponseSchema
from click_funnels_python_sdk.model.products_variant_list404_response import ProductsVariantList404Response as ProductsVariantList404ResponseSchema

from click_funnels_python_sdk.type.products_variant_list_response import ProductsVariantListResponse
from click_funnels_python_sdk.type.products_variant_list401_response import ProductsVariantList401Response
from click_funnels_python_sdk.type.products_variant_list404_response import ProductsVariantList404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.products_variant_list_response import ProductsVariantListResponse as ProductsVariantListResponsePydantic
from click_funnels_python_sdk.pydantic.products_variant_list404_response import ProductsVariantList404Response as ProductsVariantList404ResponsePydantic
from click_funnels_python_sdk.pydantic.products_variant_list401_response import ProductsVariantList401Response as ProductsVariantList401ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProductsVariantListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ProductsVariantListResponse
...
SchemaFor401ResponseBodyApplicationJson = ProductsVariantList401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductsVariantList401Response
...
SchemaFor404ResponseBodyApplicationJson = ProductsVariantList404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ProductsVariantList404Response
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProductsVariantListResponsePydantic:
        ...
        if validate:
            return RootModel[ProductsVariantListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ProductsVariantListResponsePydantic, raw_response.body)
