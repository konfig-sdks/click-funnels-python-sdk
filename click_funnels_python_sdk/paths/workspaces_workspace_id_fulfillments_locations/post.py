...
from click_funnels_python_sdk.model.fulfillments_location_create_new_location_request import FulfillmentsLocationCreateNewLocationRequest as FulfillmentsLocationCreateNewLocationRequestSchema
from click_funnels_python_sdk.model.fulfillments_location_attributes import FulfillmentsLocationAttributes as FulfillmentsLocationAttributesSchema
from click_funnels_python_sdk.model.fulfillments_location_create_new_location_response import FulfillmentsLocationCreateNewLocationResponse as FulfillmentsLocationCreateNewLocationResponseSchema
from click_funnels_python_sdk.model.fulfillments_location_create_new_location401_response import FulfillmentsLocationCreateNewLocation401Response as FulfillmentsLocationCreateNewLocation401ResponseSchema

from click_funnels_python_sdk.type.fulfillments_location_create_new_location_request import FulfillmentsLocationCreateNewLocationRequest
from click_funnels_python_sdk.type.fulfillments_location_attributes import FulfillmentsLocationAttributes
from click_funnels_python_sdk.type.fulfillments_location_create_new_location_response import FulfillmentsLocationCreateNewLocationResponse
from click_funnels_python_sdk.type.fulfillments_location_create_new_location401_response import FulfillmentsLocationCreateNewLocation401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.fulfillments_location_attributes import FulfillmentsLocationAttributes as FulfillmentsLocationAttributesPydantic
from click_funnels_python_sdk.pydantic.fulfillments_location_create_new_location401_response import FulfillmentsLocationCreateNewLocation401Response as FulfillmentsLocationCreateNewLocation401ResponsePydantic
from click_funnels_python_sdk.pydantic.fulfillments_location_create_new_location_response import FulfillmentsLocationCreateNewLocationResponse as FulfillmentsLocationCreateNewLocationResponsePydantic
from click_funnels_python_sdk.pydantic.fulfillments_location_create_new_location_request import FulfillmentsLocationCreateNewLocationRequest as FulfillmentsLocationCreateNewLocationRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FulfillmentsLocationCreateNewLocationRequestSchema


request_body_fulfillments_location_create_new_location_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FulfillmentsLocationAttributesSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: FulfillmentsLocationAttributes
...
SchemaFor400ResponseBodyApplicationJson = FulfillmentsLocationCreateNewLocationResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FulfillmentsLocationCreateNewLocationResponse
...
SchemaFor401ResponseBodyApplicationJson = FulfillmentsLocationCreateNewLocation401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FulfillmentsLocationCreateNewLocation401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_new_location_mapped_args(
        self,
        workspace_id: int,
        fulfillments_location: typing.Optional[FulfillmentsLocationParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if fulfillments_location is not None:
            _body["fulfillments_location"] = fulfillments_location
        args.body = _body
    ...
    async def _acreate_new_location_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/fulfillments/locations',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_fulfillments_location_create_new_location_request.serialize(body, content_type)
...
class CreateNewLocationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_location(
        self,
        workspace_id: int,
        fulfillments_location: typing.Optional[FulfillmentsLocationParameters] = None,
        **kwargs,
        ...
        args = self._create_new_location_mapped_args(
            workspace_id=workspace_id,
            fulfillments_location=fulfillments_location,
        )
        return await self._acreate_new_location_oapg(
            body=args.body,
    ...
    def create_new_location(
        ...
        return self._create_new_location_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewLocation(BaseApi):
    ...
    async def acreate_new_location(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FulfillmentsLocationAttributesPydantic:
        raw_response = await self.raw.acreate_new_location(
            workspace_id=workspace_id,
            fulfillments_location=fulfillments_location,
            **kwargs,
        )
        if validate:
            return FulfillmentsLocationAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(FulfillmentsLocationAttributesPydantic, raw_response.body)
    ...
    def create_new_location(
        ...
        raw_response = self.raw.create_new_location(
            workspace_id=workspace_id,
            fulfillments_location=fulfillments_location,
        )
        if validate:
