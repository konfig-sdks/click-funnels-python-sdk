...
from click_funnels_python_sdk.model.forms_fields_option_create_new_field_option401_response import FormsFieldsOptionCreateNewFieldOption401Response as FormsFieldsOptionCreateNewFieldOption401ResponseSchema
...
from click_funnels_python_sdk.model.forms_fields_option_create_new_field_option_response import FormsFieldsOptionCreateNewFieldOptionResponse as FormsFieldsOptionCreateNewFieldOptionResponseSchema
from click_funnels_python_sdk.model.forms_fields_option_create_new_field_option_request import FormsFieldsOptionCreateNewFieldOptionRequest as FormsFieldsOptionCreateNewFieldOptionRequestSchema

from click_funnels_python_sdk.type.forms_fields_option_attributes import FormsFieldsOptionAttributes
from click_funnels_python_sdk.type.forms_fields_option_create_new_field_option401_response import FormsFieldsOptionCreateNewFieldOption401Response
from click_funnels_python_sdk.type.forms_fields_option_create_new_field_option_request import FormsFieldsOptionCreateNewFieldOptionRequest
from click_funnels_python_sdk.type.forms_fields_option_create_new_field_option_response import FormsFieldsOptionCreateNewFieldOptionResponse
...
from click_funnels_python_sdk.pydantic.forms_fields_option_create_new_field_option_request import FormsFieldsOptionCreateNewFieldOptionRequest as FormsFieldsOptionCreateNewFieldOptionRequestPydantic
from click_funnels_python_sdk.pydantic.forms_fields_option_create_new_field_option_response import FormsFieldsOptionCreateNewFieldOptionResponse as FormsFieldsOptionCreateNewFieldOptionResponsePydantic
from click_funnels_python_sdk.pydantic.forms_fields_option_create_new_field_option401_response import FormsFieldsOptionCreateNewFieldOption401Response as FormsFieldsOptionCreateNewFieldOption401ResponsePydantic

# Path params
FieldIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'field_id': typing.Union[FieldIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = FormsFieldsOptionCreateNewFieldOptionRequestSchema


request_body_forms_fields_option_create_new_field_option_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FormsFieldsOptionAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = FormsFieldsOptionCreateNewFieldOptionResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormsFieldsOptionCreateNewFieldOptionResponse
...
SchemaFor401ResponseBodyApplicationJson = FormsFieldsOptionCreateNewFieldOption401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldsOptionCreateNewFieldOption401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_new_field_option_mapped_args(
        self,
        field_id: int,
    ...
    async def _acreate_new_field_option_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/forms/fields/{field_id}/options',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_forms_fields_option_create_new_field_option_request.serialize(body, content_type)
    ...
    def _create_new_field_option_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewFieldOptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_field_option(
        self,
        field_id: int,
        forms_fields_option: typing.Optional[FormsFieldsOptionParameters] = None,
        **kwargs,
        ...
        args = self._create_new_field_option_mapped_args(
            field_id=field_id,
            forms_fields_option=forms_fields_option,
        )
        return await self._acreate_new_field_option_oapg(
            body=args.body,
    ...
    def create_new_field_option(
        ...
        return self._create_new_field_option_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewFieldOption(BaseApi):
    ...
    async def acreate_new_field_option(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_field_option(
            field_id=field_id,
            forms_fields_option=forms_fields_option,
            **kwargs,
        )
    ...
    def create_new_field_option(
        ...
        raw_response = self.raw.create_new_field_option(
            field_id=field_id,
            forms_fields_option=forms_fields_option,
        )
        if validate:
