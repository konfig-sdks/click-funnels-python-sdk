...
from click_funnels_python_sdk.model.user_list_current_account_users401_response import UserListCurrentAccountUsers401Response as UserListCurrentAccountUsers401ResponseSchema
from click_funnels_python_sdk.model.user_list_current_account_users_response import UserListCurrentAccountUsersResponse as UserListCurrentAccountUsersResponseSchema

from click_funnels_python_sdk.type.user_list_current_account_users_response import UserListCurrentAccountUsersResponse
from click_funnels_python_sdk.type.user_list_current_account_users401_response import UserListCurrentAccountUsers401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.user_list_current_account_users_response import UserListCurrentAccountUsersResponse as UserListCurrentAccountUsersResponsePydantic
from click_funnels_python_sdk.pydantic.user_list_current_account_users401_response import UserListCurrentAccountUsers401Response as UserListCurrentAccountUsers401ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UserListCurrentAccountUsersResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: UserListCurrentAccountUsersResponse
...
SchemaFor401ResponseBodyApplicationJson = UserListCurrentAccountUsers401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: UserListCurrentAccountUsers401Response
...
class BaseApi(api_client.Api):
    ...
    def _list_current_account_users_mapped_args(
        self,
    ...
    async def _alist_current_account_users_oapg(
        self,
    ...
    def _list_current_account_users_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListCurrentAccountUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_current_account_users(
        self,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_current_account_users_mapped_args(
            after=after,
            sort_order=sort_order,
        )
        return await self._alist_current_account_users_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def list_current_account_users(
        self,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._list_current_account_users_oapg(
            query_params=args.query,
        )

class ListCurrentAccountUsers(BaseApi):
    ...
    async def alist_current_account_users(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserListCurrentAccountUsersResponsePydantic:
        raw_response = await self.raw.alist_current_account_users(
            after=after,
            sort_order=sort_order,
            **kwargs,
        )
        if validate:
            return RootModel[UserListCurrentAccountUsersResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(UserListCurrentAccountUsersResponsePydantic, raw_response.body)
    ...
    def list_current_account_users(
        ...
        raw_response = self.raw.list_current_account_users(
            after=after,
            sort_order=sort_order,
        )
        if validate:
