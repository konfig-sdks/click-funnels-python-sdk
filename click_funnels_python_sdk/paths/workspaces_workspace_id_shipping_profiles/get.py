...
from click_funnels_python_sdk.model.shipping_profile_list404_response import ShippingProfileList404Response as ShippingProfileList404ResponseSchema
from click_funnels_python_sdk.model.shipping_profile_list_response import ShippingProfileListResponse as ShippingProfileListResponseSchema
from click_funnels_python_sdk.model.shipping_profile_list401_response import ShippingProfileList401Response as ShippingProfileList401ResponseSchema

from click_funnels_python_sdk.type.shipping_profile_list404_response import ShippingProfileList404Response
from click_funnels_python_sdk.type.shipping_profile_list401_response import ShippingProfileList401Response
from click_funnels_python_sdk.type.shipping_profile_list_response import ShippingProfileListResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_profile_list401_response import ShippingProfileList401Response as ShippingProfileList401ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_profile_list_response import ShippingProfileListResponse as ShippingProfileListResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_profile_list404_response import ShippingProfileList404Response as ShippingProfileList404ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ShippingProfileListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ShippingProfileListResponse
...
SchemaFor401ResponseBodyApplicationJson = ShippingProfileList401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingProfileList401Response
...
SchemaFor404ResponseBodyApplicationJson = ShippingProfileList404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingProfileList404Response
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShippingProfileListResponsePydantic:
        ...
        if validate:
            return RootModel[ShippingProfileListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ShippingProfileListResponsePydantic, raw_response.body)
