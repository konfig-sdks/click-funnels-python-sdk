...
from click_funnels_python_sdk.model.contact_attributes import ContactAttributes as ContactAttributesSchema
from click_funnels_python_sdk.model.contact_update_contact_by_id_response import ContactUpdateContactByIdResponse as ContactUpdateContactByIdResponseSchema
from click_funnels_python_sdk.model.contact_update_contact_by_id_request import ContactUpdateContactByIdRequest as ContactUpdateContactByIdRequestSchema
from click_funnels_python_sdk.model.contact_update_contact_by_id401_response import ContactUpdateContactById401Response as ContactUpdateContactById401ResponseSchema
from click_funnels_python_sdk.model.contact_update_contact_by_id404_response import ContactUpdateContactById404Response as ContactUpdateContactById404ResponseSchema

from click_funnels_python_sdk.type.contact_update_contact_by_id_request import ContactUpdateContactByIdRequest
from click_funnels_python_sdk.type.contact_update_contact_by_id404_response import ContactUpdateContactById404Response
from click_funnels_python_sdk.type.contact_attributes import ContactAttributes
from click_funnels_python_sdk.type.contact_update_contact_by_id_response import ContactUpdateContactByIdResponse
from click_funnels_python_sdk.type.contact_update_contact_by_id401_response import ContactUpdateContactById401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.contact_update_contact_by_id_response import ContactUpdateContactByIdResponse as ContactUpdateContactByIdResponsePydantic
from click_funnels_python_sdk.pydantic.contact_update_contact_by_id404_response import ContactUpdateContactById404Response as ContactUpdateContactById404ResponsePydantic
from click_funnels_python_sdk.pydantic.contact_update_contact_by_id_request import ContactUpdateContactByIdRequest as ContactUpdateContactByIdRequestPydantic
from click_funnels_python_sdk.pydantic.contact_attributes import ContactAttributes as ContactAttributesPydantic
from click_funnels_python_sdk.pydantic.contact_update_contact_by_id401_response import ContactUpdateContactById401Response as ContactUpdateContactById401ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ContactUpdateContactByIdRequestSchema


request_body_contact_update_contact_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ContactAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = ContactUpdateContactByIdResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ContactUpdateContactByIdResponse
...
SchemaFor401ResponseBodyApplicationJson = ContactUpdateContactById401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ContactUpdateContactById401Response
...
SchemaFor404ResponseBodyApplicationJson = ContactUpdateContactById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ContactUpdateContactById404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_contact_by_id_mapped_args(
        self,
        id: str,
        contact: typing.Optional[ContactParameters] = None,
    ...
    async def _aupdate_contact_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contacts/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_contact_update_contact_by_id_request.serialize(body, content_type)
    ...
    def _update_contact_by_id_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateContactByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_contact_by_id(
        self,
        id: str,
        contact: typing.Optional[ContactParameters] = None,
        **kwargs,
        ...
        args = self._update_contact_by_id_mapped_args(
            id=id,
            contact=contact,
        )
        return await self._aupdate_contact_by_id_oapg(
            body=args.body,
    ...
    def update_contact_by_id(
        ...
        return self._update_contact_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateContactById(BaseApi):
    ...
    async def aupdate_contact_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContactAttributesPydantic:
        raw_response = await self.raw.aupdate_contact_by_id(
            id=id,
            contact=contact,
            **kwargs,
        )
        if validate:
            return ContactAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContactAttributesPydantic, raw_response.body)
    ...
    def update_contact_by_id(
        ...
        raw_response = self.raw.update_contact_by_id(
            id=id,
            contact=contact,
        )
        if validate:
