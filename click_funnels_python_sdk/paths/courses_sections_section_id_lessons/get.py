...
from click_funnels_python_sdk.model.courses_lesson_list_lessons_response import CoursesLessonListLessonsResponse as CoursesLessonListLessonsResponseSchema
from click_funnels_python_sdk.model.courses_lesson_list_lessons401_response import CoursesLessonListLessons401Response as CoursesLessonListLessons401ResponseSchema
from click_funnels_python_sdk.model.courses_lesson_list_lessons404_response import CoursesLessonListLessons404Response as CoursesLessonListLessons404ResponseSchema

from click_funnels_python_sdk.type.courses_lesson_list_lessons404_response import CoursesLessonListLessons404Response
from click_funnels_python_sdk.type.courses_lesson_list_lessons_response import CoursesLessonListLessonsResponse
from click_funnels_python_sdk.type.courses_lesson_list_lessons401_response import CoursesLessonListLessons401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.courses_lesson_list_lessons404_response import CoursesLessonListLessons404Response as CoursesLessonListLessons404ResponsePydantic
from click_funnels_python_sdk.pydantic.courses_lesson_list_lessons_response import CoursesLessonListLessonsResponse as CoursesLessonListLessonsResponsePydantic
from click_funnels_python_sdk.pydantic.courses_lesson_list_lessons401_response import CoursesLessonListLessons401Response as CoursesLessonListLessons401ResponsePydantic
...
# Path params
SectionIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'section_id': typing.Union[SectionIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_section_id = api_client.PathParameter(
    name="section_id",
...
SchemaFor200ResponseBodyApplicationJson = CoursesLessonListLessonsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CoursesLessonListLessonsResponse
...
SchemaFor401ResponseBodyApplicationJson = CoursesLessonListLessons401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: CoursesLessonListLessons401Response
...
SchemaFor404ResponseBodyApplicationJson = CoursesLessonListLessons404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: CoursesLessonListLessons404Response
    ...
    async def _alist_lessons_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/courses/sections/{section_id}/lessons',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListLessonsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_lessons(
        self,
        section_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_lessons_mapped_args(
            section_id=section_id,
            after=after,
            sort_order=sort_order,
        )
        return await self._alist_lessons_oapg(
    ...
    def list_lessons(
        ...
        return self._list_lessons_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListLessons(BaseApi):
    ...
    async def alist_lessons(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CoursesLessonListLessonsResponsePydantic:
        raw_response = await self.raw.alist_lessons(
            section_id=section_id,
            after=after,
            sort_order=sort_order,
            **kwargs,
        ...
        if validate:
            return RootModel[CoursesLessonListLessonsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(CoursesLessonListLessonsResponsePydantic, raw_response.body)
    ...
    def list_lessons(
        ...
        raw_response = self.raw.list_lessons(
            section_id=section_id,
            after=after,
            sort_order=sort_order,
        )
