...
from click_funnels_python_sdk.model.shipping_package_add_to_workspace_response import ShippingPackageAddToWorkspaceResponse as ShippingPackageAddToWorkspaceResponseSchema
...
from click_funnels_python_sdk.model.shipping_package_add_to_workspace_request import ShippingPackageAddToWorkspaceRequest as ShippingPackageAddToWorkspaceRequestSchema
from click_funnels_python_sdk.model.shipping_package_add_to_workspace401_response import ShippingPackageAddToWorkspace401Response as ShippingPackageAddToWorkspace401ResponseSchema

from click_funnels_python_sdk.type.shipping_package_add_to_workspace401_response import ShippingPackageAddToWorkspace401Response
from click_funnels_python_sdk.type.shipping_package_add_to_workspace_request import ShippingPackageAddToWorkspaceRequest
from click_funnels_python_sdk.type.shipping_package_attributes import ShippingPackageAttributes
from click_funnels_python_sdk.type.shipping_package_add_to_workspace_response import ShippingPackageAddToWorkspaceResponse
...
from click_funnels_python_sdk.pydantic.shipping_package_add_to_workspace401_response import ShippingPackageAddToWorkspace401Response as ShippingPackageAddToWorkspace401ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_package_add_to_workspace_response import ShippingPackageAddToWorkspaceResponse as ShippingPackageAddToWorkspaceResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_package_add_to_workspace_request import ShippingPackageAddToWorkspaceRequest as ShippingPackageAddToWorkspaceRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ShippingPackageAddToWorkspaceRequestSchema


request_body_shipping_package_add_to_workspace_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ShippingPackageAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = ShippingPackageAddToWorkspaceResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ShippingPackageAddToWorkspaceResponse
...
SchemaFor401ResponseBodyApplicationJson = ShippingPackageAddToWorkspace401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingPackageAddToWorkspace401Response
...
class BaseApi(api_client.Api):
    ...
    def _add_to_workspace_mapped_args(
        self,
        workspace_id: int,
    ...
    async def _aadd_to_workspace_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/shipping/packages',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_shipping_package_add_to_workspace_request.serialize(body, content_type)
...
class AddToWorkspaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_to_workspace(
        self,
        workspace_id: int,
        shipping_package: typing.Optional[ShippingPackageParameters] = None,
        **kwargs,
        ...
        args = self._add_to_workspace_mapped_args(
            workspace_id=workspace_id,
            shipping_package=shipping_package,
        )
        return await self._aadd_to_workspace_oapg(
            body=args.body,
    ...
    def add_to_workspace(
        ...
        return self._add_to_workspace_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddToWorkspace(BaseApi):
    ...
    async def aadd_to_workspace(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_to_workspace(
            workspace_id=workspace_id,
            shipping_package=shipping_package,
            **kwargs,
        )
    ...
    def add_to_workspace(
        ...
        raw_response = self.raw.add_to_workspace(
            workspace_id=workspace_id,
            shipping_package=shipping_package,
        )
        if validate:
