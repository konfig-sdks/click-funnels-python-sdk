...
from click_funnels_python_sdk.model.shipping_package_update_for_workspace401_response import ShippingPackageUpdateForWorkspace401Response as ShippingPackageUpdateForWorkspace401ResponseSchema
from click_funnels_python_sdk.model.shipping_package_update_for_workspace404_response import ShippingPackageUpdateForWorkspace404Response as ShippingPackageUpdateForWorkspace404ResponseSchema
from click_funnels_python_sdk.model.shipping_package_attributes import ShippingPackageAttributes as ShippingPackageAttributesSchema
from click_funnels_python_sdk.model.shipping_package_update_for_workspace_response import ShippingPackageUpdateForWorkspaceResponse as ShippingPackageUpdateForWorkspaceResponseSchema
from click_funnels_python_sdk.model.shipping_package_update_for_workspace_request import ShippingPackageUpdateForWorkspaceRequest as ShippingPackageUpdateForWorkspaceRequestSchema

from click_funnels_python_sdk.type.shipping_package_update_for_workspace401_response import ShippingPackageUpdateForWorkspace401Response
from click_funnels_python_sdk.type.shipping_package_update_for_workspace_request import ShippingPackageUpdateForWorkspaceRequest
from click_funnels_python_sdk.type.shipping_package_update_for_workspace_response import ShippingPackageUpdateForWorkspaceResponse
from click_funnels_python_sdk.type.shipping_package_update_for_workspace404_response import ShippingPackageUpdateForWorkspace404Response
from click_funnels_python_sdk.type.shipping_package_attributes import ShippingPackageAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_package_attributes import ShippingPackageAttributes as ShippingPackageAttributesPydantic
from click_funnels_python_sdk.pydantic.shipping_package_update_for_workspace_request import ShippingPackageUpdateForWorkspaceRequest as ShippingPackageUpdateForWorkspaceRequestPydantic
from click_funnels_python_sdk.pydantic.shipping_package_update_for_workspace401_response import ShippingPackageUpdateForWorkspace401Response as ShippingPackageUpdateForWorkspace401ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_package_update_for_workspace404_response import ShippingPackageUpdateForWorkspace404Response as ShippingPackageUpdateForWorkspace404ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_package_update_for_workspace_response import ShippingPackageUpdateForWorkspaceResponse as ShippingPackageUpdateForWorkspaceResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ShippingPackageUpdateForWorkspaceRequestSchema


request_body_shipping_package_update_for_workspace_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ShippingPackageAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ShippingPackageAttributes
...
SchemaFor400ResponseBodyApplicationJson = ShippingPackageUpdateForWorkspaceResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ShippingPackageUpdateForWorkspaceResponse
...
SchemaFor401ResponseBodyApplicationJson = ShippingPackageUpdateForWorkspace401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingPackageUpdateForWorkspace401Response
...
SchemaFor404ResponseBodyApplicationJson = ShippingPackageUpdateForWorkspace404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingPackageUpdateForWorkspace404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_for_workspace_mapped_args(
        self,
        id: str,
        shipping_package: typing.Optional[ShippingPackageParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if shipping_package is not None:
            _body["shipping_package"] = shipping_package
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_for_workspace_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/shipping/packages/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_shipping_package_update_for_workspace_request.serialize(body, content_type)
    ...
    def _update_for_workspace_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateForWorkspaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_for_workspace(
        self,
        id: str,
        shipping_package: typing.Optional[ShippingPackageParameters] = None,
        **kwargs,
        ...
        args = self._update_for_workspace_mapped_args(
            id=id,
            shipping_package=shipping_package,
        )
        return await self._aupdate_for_workspace_oapg(
            body=args.body,
    ...
    def update_for_workspace(
        ...
        return self._update_for_workspace_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateForWorkspace(BaseApi):
    ...
    async def aupdate_for_workspace(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShippingPackageAttributesPydantic:
        raw_response = await self.raw.aupdate_for_workspace(
            id=id,
            shipping_package=shipping_package,
            **kwargs,
        )
        if validate:
            return ShippingPackageAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ShippingPackageAttributesPydantic, raw_response.body)
    ...
    def update_for_workspace(
        ...
        raw_response = self.raw.update_for_workspace(
            id=id,
            shipping_package=shipping_package,
        )
        if validate:
