...
from click_funnels_python_sdk.model.user_attributes import UserAttributes as UserAttributesSchema
from click_funnels_python_sdk.model.user_update_single_user_request import UserUpdateSingleUserRequest as UserUpdateSingleUserRequestSchema
from click_funnels_python_sdk.model.user_update_single_user404_response import UserUpdateSingleUser404Response as UserUpdateSingleUser404ResponseSchema
from click_funnels_python_sdk.model.user_update_single_user_response import UserUpdateSingleUserResponse as UserUpdateSingleUserResponseSchema

from click_funnels_python_sdk.type.user_update_single_user_request import UserUpdateSingleUserRequest
from click_funnels_python_sdk.type.user_update_single_user404_response import UserUpdateSingleUser404Response
from click_funnels_python_sdk.type.user_attributes import UserAttributes
from click_funnels_python_sdk.type.user_update_single_user_response import UserUpdateSingleUserResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.user_update_single_user404_response import UserUpdateSingleUser404Response as UserUpdateSingleUser404ResponsePydantic
from click_funnels_python_sdk.pydantic.user_attributes import UserAttributes as UserAttributesPydantic
from click_funnels_python_sdk.pydantic.user_update_single_user_response import UserUpdateSingleUserResponse as UserUpdateSingleUserResponsePydantic
from click_funnels_python_sdk.pydantic.user_update_single_user_request import UserUpdateSingleUserRequest as UserUpdateSingleUserRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UserUpdateSingleUserRequestSchema


request_body_user_update_single_user_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UserAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = UserUpdateSingleUserResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: UserUpdateSingleUserResponse
...
SchemaFor404ResponseBodyApplicationJson = UserUpdateSingleUser404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: UserUpdateSingleUser404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_single_user_mapped_args(
        self,
        id: str,
        user: typing.Optional[UserParameters] = None,
    ...
    async def _aupdate_single_user_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_user_update_single_user_request.serialize(body, content_type)
...
class UpdateSingleUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_single_user(
        self,
        id: str,
        user: typing.Optional[UserParameters] = None,
        **kwargs,
        ...
        args = self._update_single_user_mapped_args(
            id=id,
            user=user,
        )
        return await self._aupdate_single_user_oapg(
            body=args.body,
    ...
    def update_single_user(
        ...
        return self._update_single_user_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSingleUser(BaseApi):
    ...
    async def aupdate_single_user(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserAttributesPydantic:
        raw_response = await self.raw.aupdate_single_user(
            id=id,
            user=user,
            **kwargs,
        )
        if validate:
            return UserAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(UserAttributesPydantic, raw_response.body)
    ...
    def update_single_user(
        ...
        raw_response = self.raw.update_single_user(
            id=id,
            user=user,
        )
        if validate:
