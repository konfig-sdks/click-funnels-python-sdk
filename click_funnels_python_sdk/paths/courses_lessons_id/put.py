...
from click_funnels_python_sdk.model.courses_lesson_update_lesson_by_id_request import CoursesLessonUpdateLessonByIdRequest as CoursesLessonUpdateLessonByIdRequestSchema
from click_funnels_python_sdk.model.courses_lesson_update_lesson_by_id404_response import CoursesLessonUpdateLessonById404Response as CoursesLessonUpdateLessonById404ResponseSchema
from click_funnels_python_sdk.model.courses_lesson_update_lesson_by_id_response import CoursesLessonUpdateLessonByIdResponse as CoursesLessonUpdateLessonByIdResponseSchema
from click_funnels_python_sdk.model.courses_lesson_update_lesson_by_id401_response import CoursesLessonUpdateLessonById401Response as CoursesLessonUpdateLessonById401ResponseSchema
from click_funnels_python_sdk.model.courses_lesson_attributes import CoursesLessonAttributes as CoursesLessonAttributesSchema

from click_funnels_python_sdk.type.courses_lesson_attributes import CoursesLessonAttributes
from click_funnels_python_sdk.type.courses_lesson_update_lesson_by_id401_response import CoursesLessonUpdateLessonById401Response
from click_funnels_python_sdk.type.courses_lesson_update_lesson_by_id_response import CoursesLessonUpdateLessonByIdResponse
from click_funnels_python_sdk.type.courses_lesson_update_lesson_by_id_request import CoursesLessonUpdateLessonByIdRequest
from click_funnels_python_sdk.type.courses_lesson_update_lesson_by_id404_response import CoursesLessonUpdateLessonById404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.courses_lesson_update_lesson_by_id401_response import CoursesLessonUpdateLessonById401Response as CoursesLessonUpdateLessonById401ResponsePydantic
from click_funnels_python_sdk.pydantic.courses_lesson_update_lesson_by_id_request import CoursesLessonUpdateLessonByIdRequest as CoursesLessonUpdateLessonByIdRequestPydantic
from click_funnels_python_sdk.pydantic.courses_lesson_update_lesson_by_id404_response import CoursesLessonUpdateLessonById404Response as CoursesLessonUpdateLessonById404ResponsePydantic
from click_funnels_python_sdk.pydantic.courses_lesson_attributes import CoursesLessonAttributes as CoursesLessonAttributesPydantic
from click_funnels_python_sdk.pydantic.courses_lesson_update_lesson_by_id_response import CoursesLessonUpdateLessonByIdResponse as CoursesLessonUpdateLessonByIdResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = CoursesLessonUpdateLessonByIdRequestSchema


request_body_courses_lesson_update_lesson_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CoursesLessonAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CoursesLessonAttributes
...
SchemaFor400ResponseBodyApplicationJson = CoursesLessonUpdateLessonByIdResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: CoursesLessonUpdateLessonByIdResponse
...
SchemaFor401ResponseBodyApplicationJson = CoursesLessonUpdateLessonById401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: CoursesLessonUpdateLessonById401Response
...
SchemaFor404ResponseBodyApplicationJson = CoursesLessonUpdateLessonById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: CoursesLessonUpdateLessonById404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_lesson_by_id_mapped_args(
        self,
        id: str,
        courses_lesson: typing.Optional[CoursesLessonParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if courses_lesson is not None:
            _body["courses_lesson"] = courses_lesson
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_lesson_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/courses/lessons/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_courses_lesson_update_lesson_by_id_request.serialize(body, content_type)
...
class UpdateLessonByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_lesson_by_id(
        self,
        id: str,
        courses_lesson: typing.Optional[CoursesLessonParameters] = None,
        **kwargs,
        ...
        args = self._update_lesson_by_id_mapped_args(
            id=id,
            courses_lesson=courses_lesson,
        )
        return await self._aupdate_lesson_by_id_oapg(
            body=args.body,
    ...
    def update_lesson_by_id(
        ...
        return self._update_lesson_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateLessonById(BaseApi):
    ...
    async def aupdate_lesson_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CoursesLessonAttributesPydantic:
        raw_response = await self.raw.aupdate_lesson_by_id(
            id=id,
            courses_lesson=courses_lesson,
            **kwargs,
        )
        if validate:
            return CoursesLessonAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(CoursesLessonAttributesPydantic, raw_response.body)
    ...
    def update_lesson_by_id(
        ...
        raw_response = self.raw.update_lesson_by_id(
            id=id,
            courses_lesson=courses_lesson,
        )
        if validate:
