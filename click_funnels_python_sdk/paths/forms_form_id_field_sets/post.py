...
from click_funnels_python_sdk.model.forms_field_set_create_new_field_set_response import FormsFieldSetCreateNewFieldSetResponse as FormsFieldSetCreateNewFieldSetResponseSchema
from click_funnels_python_sdk.model.forms_field_set_create_new_field_set_request import FormsFieldSetCreateNewFieldSetRequest as FormsFieldSetCreateNewFieldSetRequestSchema
...
from click_funnels_python_sdk.model.forms_field_set_create_new_field_set401_response import FormsFieldSetCreateNewFieldSet401Response as FormsFieldSetCreateNewFieldSet401ResponseSchema

from click_funnels_python_sdk.type.forms_field_set_create_new_field_set401_response import FormsFieldSetCreateNewFieldSet401Response
from click_funnels_python_sdk.type.forms_field_set_create_new_field_set_request import FormsFieldSetCreateNewFieldSetRequest
from click_funnels_python_sdk.type.forms_field_set_create_new_field_set_response import FormsFieldSetCreateNewFieldSetResponse
from click_funnels_python_sdk.type.forms_field_set_attributes import FormsFieldSetAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_field_set_create_new_field_set_request import FormsFieldSetCreateNewFieldSetRequest as FormsFieldSetCreateNewFieldSetRequestPydantic
from click_funnels_python_sdk.pydantic.forms_field_set_create_new_field_set401_response import FormsFieldSetCreateNewFieldSet401Response as FormsFieldSetCreateNewFieldSet401ResponsePydantic
...
from click_funnels_python_sdk.pydantic.forms_field_set_create_new_field_set_response import FormsFieldSetCreateNewFieldSetResponse as FormsFieldSetCreateNewFieldSetResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FormsFieldSetCreateNewFieldSetRequestSchema


request_body_forms_field_set_create_new_field_set_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FormsFieldSetAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = FormsFieldSetCreateNewFieldSetResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormsFieldSetCreateNewFieldSetResponse
...
SchemaFor401ResponseBodyApplicationJson = FormsFieldSetCreateNewFieldSet401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldSetCreateNewFieldSet401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_new_field_set_mapped_args(
        self,
        form_id: int,
    ...
    async def _acreate_new_field_set_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/forms/{form_id}/field_sets',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_forms_field_set_create_new_field_set_request.serialize(body, content_type)
    ...
    def _create_new_field_set_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewFieldSetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_field_set(
        self,
        form_id: int,
        forms_field_set: typing.Optional[FormsFieldSetParameters] = None,
        **kwargs,
        ...
        args = self._create_new_field_set_mapped_args(
            form_id=form_id,
            forms_field_set=forms_field_set,
        )
        return await self._acreate_new_field_set_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_new_field_set(
        self,
        form_id: int,
        forms_field_set: typing.Optional[FormsFieldSetParameters] = None,
    ) -> typing.Union[
        ...
        return self._create_new_field_set_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewFieldSet(BaseApi):
    ...
    async def acreate_new_field_set(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_field_set(
            form_id=form_id,
            forms_field_set=forms_field_set,
            **kwargs,
        )
    ...
    def create_new_field_set(
        ...
        raw_response = self.raw.create_new_field_set(
            form_id=form_id,
            forms_field_set=forms_field_set,
        )
        if validate:
