...
from click_funnels_python_sdk.model.orders_tag_attributes import OrdersTagAttributes as OrdersTagAttributesSchema
from click_funnels_python_sdk.model.orders_tag_update_specific_order_tag401_response import OrdersTagUpdateSpecificOrderTag401Response as OrdersTagUpdateSpecificOrderTag401ResponseSchema
from click_funnels_python_sdk.model.orders_tag_update_specific_order_tag_request import OrdersTagUpdateSpecificOrderTagRequest as OrdersTagUpdateSpecificOrderTagRequestSchema
from click_funnels_python_sdk.model.orders_tag_update_specific_order_tag_response import OrdersTagUpdateSpecificOrderTagResponse as OrdersTagUpdateSpecificOrderTagResponseSchema
from click_funnels_python_sdk.model.orders_tag_update_specific_order_tag404_response import OrdersTagUpdateSpecificOrderTag404Response as OrdersTagUpdateSpecificOrderTag404ResponseSchema

from click_funnels_python_sdk.type.orders_tag_update_specific_order_tag_response import OrdersTagUpdateSpecificOrderTagResponse
from click_funnels_python_sdk.type.orders_tag_update_specific_order_tag_request import OrdersTagUpdateSpecificOrderTagRequest
from click_funnels_python_sdk.type.orders_tag_update_specific_order_tag404_response import OrdersTagUpdateSpecificOrderTag404Response
from click_funnels_python_sdk.type.orders_tag_update_specific_order_tag401_response import OrdersTagUpdateSpecificOrderTag401Response
from click_funnels_python_sdk.type.orders_tag_attributes import OrdersTagAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.orders_tag_attributes import OrdersTagAttributes as OrdersTagAttributesPydantic
from click_funnels_python_sdk.pydantic.orders_tag_update_specific_order_tag401_response import OrdersTagUpdateSpecificOrderTag401Response as OrdersTagUpdateSpecificOrderTag401ResponsePydantic
from click_funnels_python_sdk.pydantic.orders_tag_update_specific_order_tag404_response import OrdersTagUpdateSpecificOrderTag404Response as OrdersTagUpdateSpecificOrderTag404ResponsePydantic
from click_funnels_python_sdk.pydantic.orders_tag_update_specific_order_tag_response import OrdersTagUpdateSpecificOrderTagResponse as OrdersTagUpdateSpecificOrderTagResponsePydantic
from click_funnels_python_sdk.pydantic.orders_tag_update_specific_order_tag_request import OrdersTagUpdateSpecificOrderTagRequest as OrdersTagUpdateSpecificOrderTagRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = OrdersTagUpdateSpecificOrderTagRequestSchema


request_body_orders_tag_update_specific_order_tag_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OrdersTagAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OrdersTagAttributes
...
SchemaFor400ResponseBodyApplicationJson = OrdersTagUpdateSpecificOrderTagResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: OrdersTagUpdateSpecificOrderTagResponse
...
SchemaFor401ResponseBodyApplicationJson = OrdersTagUpdateSpecificOrderTag401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: OrdersTagUpdateSpecificOrderTag401Response
...
SchemaFor404ResponseBodyApplicationJson = OrdersTagUpdateSpecificOrderTag404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: OrdersTagUpdateSpecificOrderTag404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_specific_order_tag_mapped_args(
        self,
        id: str,
        orders_tag: typing.Optional[OrdersTagParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if orders_tag is not None:
            _body["orders_tag"] = orders_tag
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_specific_order_tag_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orders/tags/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_orders_tag_update_specific_order_tag_request.serialize(body, content_type)
    ...
    def _update_specific_order_tag_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateSpecificOrderTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_specific_order_tag(
        self,
        id: str,
        orders_tag: typing.Optional[OrdersTagParameters] = None,
        **kwargs,
        ...
        args = self._update_specific_order_tag_mapped_args(
            id=id,
            orders_tag=orders_tag,
        )
        return await self._aupdate_specific_order_tag_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_specific_order_tag(
        self,
        id: str,
        orders_tag: typing.Optional[OrdersTagParameters] = None,
    ) -> typing.Union[
        ...
        return self._update_specific_order_tag_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSpecificOrderTag(BaseApi):
    ...
    async def aupdate_specific_order_tag(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrdersTagAttributesPydantic:
        raw_response = await self.raw.aupdate_specific_order_tag(
            id=id,
            orders_tag=orders_tag,
            **kwargs,
        )
        if validate:
            return OrdersTagAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrdersTagAttributesPydantic, raw_response.body)
    ...
    def update_specific_order_tag(
        ...
        raw_response = self.raw.update_specific_order_tag(
            id=id,
            orders_tag=orders_tag,
        )
        if validate:
