...
from click_funnels_python_sdk.model.form_get_form_response import FormGetFormResponse as FormGetFormResponseSchema
from click_funnels_python_sdk.model.form_get_form404_response import FormGetForm404Response as FormGetForm404ResponseSchema
...
from click_funnels_python_sdk.type.form_get_form_response import FormGetFormResponse
from click_funnels_python_sdk.type.form_get_form404_response import FormGetForm404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.form_get_form404_response import FormGetForm404Response as FormGetForm404ResponsePydantic
from click_funnels_python_sdk.pydantic.form_attributes import FormAttributes as FormAttributesPydantic
from click_funnels_python_sdk.pydantic.form_get_form_response import FormGetFormResponse as FormGetFormResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = FormGetFormResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormGetFormResponse
...
SchemaFor404ResponseBodyApplicationJson = FormGetForm404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormGetForm404Response
...
class GetFormRaw(BaseApi):
    ...
    async def aget_form(
        ...
        **kwargs,
        ...
        args = self._get_form_mapped_args(
            id=id,
        )
        return await self._aget_form_oapg(
...
class GetForm(BaseApi):
    ...
    async def aget_form(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_form(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_form(
        ...
        raw_response = self.raw.get_form(
            id=id,
        )
        if validate:
            return FormAttributesPydantic(**raw_response.body)
