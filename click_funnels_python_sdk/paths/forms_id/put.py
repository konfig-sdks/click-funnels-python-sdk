...
from click_funnels_python_sdk.model.form_update_form_by_id404_response import FormUpdateFormById404Response as FormUpdateFormById404ResponseSchema
from click_funnels_python_sdk.model.form_update_form_by_id_request import FormUpdateFormByIdRequest as FormUpdateFormByIdRequestSchema
from click_funnels_python_sdk.model.form_update_form_by_id401_response import FormUpdateFormById401Response as FormUpdateFormById401ResponseSchema
from click_funnels_python_sdk.model.form_attributes import FormAttributes as FormAttributesSchema
from click_funnels_python_sdk.model.form_update_form_by_id_response import FormUpdateFormByIdResponse as FormUpdateFormByIdResponseSchema

from click_funnels_python_sdk.type.form_update_form_by_id_response import FormUpdateFormByIdResponse
from click_funnels_python_sdk.type.form_attributes import FormAttributes
from click_funnels_python_sdk.type.form_update_form_by_id401_response import FormUpdateFormById401Response
from click_funnels_python_sdk.type.form_update_form_by_id404_response import FormUpdateFormById404Response
from click_funnels_python_sdk.type.form_update_form_by_id_request import FormUpdateFormByIdRequest

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.form_update_form_by_id_response import FormUpdateFormByIdResponse as FormUpdateFormByIdResponsePydantic
from click_funnels_python_sdk.pydantic.form_update_form_by_id_request import FormUpdateFormByIdRequest as FormUpdateFormByIdRequestPydantic
from click_funnels_python_sdk.pydantic.form_update_form_by_id404_response import FormUpdateFormById404Response as FormUpdateFormById404ResponsePydantic
from click_funnels_python_sdk.pydantic.form_update_form_by_id401_response import FormUpdateFormById401Response as FormUpdateFormById401ResponsePydantic
from click_funnels_python_sdk.pydantic.form_attributes import FormAttributes as FormAttributesPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FormUpdateFormByIdRequestSchema


request_body_form_update_form_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FormAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = FormUpdateFormByIdResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormUpdateFormByIdResponse
...
SchemaFor401ResponseBodyApplicationJson = FormUpdateFormById401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormUpdateFormById401Response
...
SchemaFor404ResponseBodyApplicationJson = FormUpdateFormById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormUpdateFormById404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_form_by_id_mapped_args(
        self,
        id: str,
        form: typing.Optional[FormParameters] = None,
    ...
    async def _aupdate_form_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/forms/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_form_update_form_by_id_request.serialize(body, content_type)
...
class UpdateFormByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_form_by_id(
        self,
        id: str,
        form: typing.Optional[FormParameters] = None,
        **kwargs,
        ...
        args = self._update_form_by_id_mapped_args(
            id=id,
            form=form,
        )
        return await self._aupdate_form_by_id_oapg(
            body=args.body,
    ...
    def update_form_by_id(
        ...
        return self._update_form_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFormById(BaseApi):
    ...
    async def aupdate_form_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FormAttributesPydantic:
        raw_response = await self.raw.aupdate_form_by_id(
            id=id,
            form=form,
            **kwargs,
        )
        if validate:
            return FormAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(FormAttributesPydantic, raw_response.body)
    ...
    def update_form_by_id(
        ...
        raw_response = self.raw.update_form_by_id(
            id=id,
            form=form,
        )
        if validate:
