...
from click_funnels_python_sdk.model.contacts_applied_tag_create_applied_tag_request import ContactsAppliedTagCreateAppliedTagRequest as ContactsAppliedTagCreateAppliedTagRequestSchema
from click_funnels_python_sdk.model.contacts_applied_tag_create_applied_tag401_response import ContactsAppliedTagCreateAppliedTag401Response as ContactsAppliedTagCreateAppliedTag401ResponseSchema
from click_funnels_python_sdk.model.contacts_applied_tag_attributes import ContactsAppliedTagAttributes as ContactsAppliedTagAttributesSchema
from click_funnels_python_sdk.model.contacts_applied_tag_create_applied_tag_response import ContactsAppliedTagCreateAppliedTagResponse as ContactsAppliedTagCreateAppliedTagResponseSchema

from click_funnels_python_sdk.type.contacts_applied_tag_create_applied_tag_request import ContactsAppliedTagCreateAppliedTagRequest
from click_funnels_python_sdk.type.contacts_applied_tag_create_applied_tag_response import ContactsAppliedTagCreateAppliedTagResponse
from click_funnels_python_sdk.type.contacts_applied_tag_create_applied_tag401_response import ContactsAppliedTagCreateAppliedTag401Response
from click_funnels_python_sdk.type.contacts_applied_tag_attributes import ContactsAppliedTagAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.contacts_applied_tag_attributes import ContactsAppliedTagAttributes as ContactsAppliedTagAttributesPydantic
from click_funnels_python_sdk.pydantic.contacts_applied_tag_create_applied_tag_request import ContactsAppliedTagCreateAppliedTagRequest as ContactsAppliedTagCreateAppliedTagRequestPydantic
from click_funnels_python_sdk.pydantic.contacts_applied_tag_create_applied_tag401_response import ContactsAppliedTagCreateAppliedTag401Response as ContactsAppliedTagCreateAppliedTag401ResponsePydantic
from click_funnels_python_sdk.pydantic.contacts_applied_tag_create_applied_tag_response import ContactsAppliedTagCreateAppliedTagResponse as ContactsAppliedTagCreateAppliedTagResponsePydantic

from . import path

# Path params
ContactIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'contact_id': typing.Union[ContactIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = ContactsAppliedTagCreateAppliedTagRequestSchema


request_body_contacts_applied_tag_create_applied_tag_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ContactsAppliedTagAttributesSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ContactsAppliedTagAttributes
...
SchemaFor400ResponseBodyApplicationJson = ContactsAppliedTagCreateAppliedTagResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ContactsAppliedTagCreateAppliedTagResponse
...
SchemaFor401ResponseBodyApplicationJson = ContactsAppliedTagCreateAppliedTag401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ContactsAppliedTagCreateAppliedTag401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_applied_tag_mapped_args(
        self,
        contact_id: int,
        contacts_applied_tag: typing.Optional[ContactsAppliedTagParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if contacts_applied_tag is not None:
            _body["contacts_applied_tag"] = contacts_applied_tag
        args.body = _body
    ...
    async def _acreate_applied_tag_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contacts/{contact_id}/applied_tags',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_contacts_applied_tag_create_applied_tag_request.serialize(body, content_type)
...
class CreateAppliedTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_applied_tag(
        self,
        contact_id: int,
        contacts_applied_tag: typing.Optional[ContactsAppliedTagParameters] = None,
        **kwargs,
        ...
        args = self._create_applied_tag_mapped_args(
            contact_id=contact_id,
            contacts_applied_tag=contacts_applied_tag,
        )
        return await self._acreate_applied_tag_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_applied_tag(
        self,
        contact_id: int,
        contacts_applied_tag: typing.Optional[ContactsAppliedTagParameters] = None,
    ) -> typing.Union[
        ...
        return self._create_applied_tag_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateAppliedTag(BaseApi):
    ...
    async def acreate_applied_tag(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContactsAppliedTagAttributesPydantic:
        raw_response = await self.raw.acreate_applied_tag(
            contact_id=contact_id,
            contacts_applied_tag=contacts_applied_tag,
            **kwargs,
        )
        if validate:
            return ContactsAppliedTagAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContactsAppliedTagAttributesPydantic, raw_response.body)
    ...
    def create_applied_tag(
        ...
        raw_response = self.raw.create_applied_tag(
            contact_id=contact_id,
            contacts_applied_tag=contacts_applied_tag,
        )
        if validate:
