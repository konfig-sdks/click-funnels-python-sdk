...
from click_funnels_python_sdk.model.contacts_applied_tag_get_for_contact404_response import ContactsAppliedTagGetForContact404Response as ContactsAppliedTagGetForContact404ResponseSchema
from click_funnels_python_sdk.model.contacts_applied_tag_get_for_contact_response import ContactsAppliedTagGetForContactResponse as ContactsAppliedTagGetForContactResponseSchema

from click_funnels_python_sdk.type.contacts_applied_tag_attributes import ContactsAppliedTagAttributes
from click_funnels_python_sdk.type.contacts_applied_tag_get_for_contact404_response import ContactsAppliedTagGetForContact404Response
from click_funnels_python_sdk.type.contacts_applied_tag_get_for_contact_response import ContactsAppliedTagGetForContactResponse
...
from click_funnels_python_sdk.pydantic.contacts_applied_tag_get_for_contact404_response import ContactsAppliedTagGetForContact404Response as ContactsAppliedTagGetForContact404ResponsePydantic
from click_funnels_python_sdk.pydantic.contacts_applied_tag_get_for_contact_response import ContactsAppliedTagGetForContactResponse as ContactsAppliedTagGetForContactResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ContactsAppliedTagAttributesSchema
...
SchemaFor401ResponseBodyApplicationJson = ContactsAppliedTagGetForContactResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ContactsAppliedTagGetForContactResponse
...
SchemaFor404ResponseBodyApplicationJson = ContactsAppliedTagGetForContact404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ContactsAppliedTagGetForContact404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_for_contact_mapped_args(
        self,
        id: str,
    ...
    async def _aget_for_contact_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contacts/applied_tags/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetForContactRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_for_contact(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_for_contact_mapped_args(
            id=id,
        )
        return await self._aget_for_contact_oapg(
    ...
    def get_for_contact(
        ...
        return self._get_for_contact_oapg(
            path_params=args.path,
        )

class GetForContact(BaseApi):
    ...
    async def aget_for_contact(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_for_contact(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_for_contact(
        ...
        raw_response = self.raw.get_for_contact(
            id=id,
        )
        if validate:
            return ContactsAppliedTagAttributesPydantic(**raw_response.body)
