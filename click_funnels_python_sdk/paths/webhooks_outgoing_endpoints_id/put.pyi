...
from click_funnels_python_sdk.model.webhooks_outgoing_endpoint_update_endpoint_request import WebhooksOutgoingEndpointUpdateEndpointRequest as WebhooksOutgoingEndpointUpdateEndpointRequestSchema
from click_funnels_python_sdk.model.webhooks_outgoing_endpoint_update_endpoint401_response import WebhooksOutgoingEndpointUpdateEndpoint401Response as WebhooksOutgoingEndpointUpdateEndpoint401ResponseSchema
from click_funnels_python_sdk.model.webhooks_outgoing_endpoint_update_endpoint_response import WebhooksOutgoingEndpointUpdateEndpointResponse as WebhooksOutgoingEndpointUpdateEndpointResponseSchema
from click_funnels_python_sdk.model.webhooks_outgoing_endpoint_attributes import WebhooksOutgoingEndpointAttributes as WebhooksOutgoingEndpointAttributesSchema
from click_funnels_python_sdk.model.webhooks_outgoing_endpoint_update_endpoint404_response import WebhooksOutgoingEndpointUpdateEndpoint404Response as WebhooksOutgoingEndpointUpdateEndpoint404ResponseSchema

from click_funnels_python_sdk.type.webhooks_outgoing_endpoint_update_endpoint_response import WebhooksOutgoingEndpointUpdateEndpointResponse
from click_funnels_python_sdk.type.webhooks_outgoing_endpoint_update_endpoint_request import WebhooksOutgoingEndpointUpdateEndpointRequest
from click_funnels_python_sdk.type.webhooks_outgoing_endpoint_update_endpoint401_response import WebhooksOutgoingEndpointUpdateEndpoint401Response
from click_funnels_python_sdk.type.webhooks_outgoing_endpoint_attributes import WebhooksOutgoingEndpointAttributes
from click_funnels_python_sdk.type.webhooks_outgoing_endpoint_update_endpoint404_response import WebhooksOutgoingEndpointUpdateEndpoint404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.webhooks_outgoing_endpoint_update_endpoint404_response import WebhooksOutgoingEndpointUpdateEndpoint404Response as WebhooksOutgoingEndpointUpdateEndpoint404ResponsePydantic
from click_funnels_python_sdk.pydantic.webhooks_outgoing_endpoint_attributes import WebhooksOutgoingEndpointAttributes as WebhooksOutgoingEndpointAttributesPydantic
from click_funnels_python_sdk.pydantic.webhooks_outgoing_endpoint_update_endpoint_request import WebhooksOutgoingEndpointUpdateEndpointRequest as WebhooksOutgoingEndpointUpdateEndpointRequestPydantic
from click_funnels_python_sdk.pydantic.webhooks_outgoing_endpoint_update_endpoint401_response import WebhooksOutgoingEndpointUpdateEndpoint401Response as WebhooksOutgoingEndpointUpdateEndpoint401ResponsePydantic
from click_funnels_python_sdk.pydantic.webhooks_outgoing_endpoint_update_endpoint_response import WebhooksOutgoingEndpointUpdateEndpointResponse as WebhooksOutgoingEndpointUpdateEndpointResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = WebhooksOutgoingEndpointUpdateEndpointRequestSchema


request_body_webhooks_outgoing_endpoint_update_endpoint_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WebhooksOutgoingEndpointAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksOutgoingEndpointAttributes
...
SchemaFor400ResponseBodyApplicationJson = WebhooksOutgoingEndpointUpdateEndpointResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: WebhooksOutgoingEndpointUpdateEndpointResponse
...
SchemaFor401ResponseBodyApplicationJson = WebhooksOutgoingEndpointUpdateEndpoint401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: WebhooksOutgoingEndpointUpdateEndpoint401Response
...
SchemaFor404ResponseBodyApplicationJson = WebhooksOutgoingEndpointUpdateEndpoint404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: WebhooksOutgoingEndpointUpdateEndpoint404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_endpoint_mapped_args(
        self,
        id: str,
        webhooks_outgoing_endpoint: typing.Optional[WebhooksOutgoingEndpointParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if webhooks_outgoing_endpoint is not None:
            _body["webhooks_outgoing_endpoint"] = webhooks_outgoing_endpoint
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_endpoint_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/webhooks/outgoing/endpoints/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_webhooks_outgoing_endpoint_update_endpoint_request.serialize(body, content_type)
...
class UpdateEndpointRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_endpoint(
        self,
        id: str,
        webhooks_outgoing_endpoint: typing.Optional[WebhooksOutgoingEndpointParameters] = None,
        **kwargs,
        ...
        args = self._update_endpoint_mapped_args(
            id=id,
            webhooks_outgoing_endpoint=webhooks_outgoing_endpoint,
        )
        return await self._aupdate_endpoint_oapg(
            body=args.body,
    ...
    def update_endpoint(
        ...
        return self._update_endpoint_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateEndpoint(BaseApi):
    ...
    async def aupdate_endpoint(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksOutgoingEndpointAttributesPydantic:
        raw_response = await self.raw.aupdate_endpoint(
            id=id,
            webhooks_outgoing_endpoint=webhooks_outgoing_endpoint,
            **kwargs,
        )
        if validate:
            return WebhooksOutgoingEndpointAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksOutgoingEndpointAttributesPydantic, raw_response.body)
    ...
    def update_endpoint(
        ...
        raw_response = self.raw.update_endpoint(
            id=id,
            webhooks_outgoing_endpoint=webhooks_outgoing_endpoint,
        )
        if validate:
