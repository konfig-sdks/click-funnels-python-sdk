...
from click_funnels_python_sdk.model.contact_list_for_workspace_response import ContactListForWorkspaceResponse as ContactListForWorkspaceResponseSchema
from click_funnels_python_sdk.model.contact_list_for_workspace404_response import ContactListForWorkspace404Response as ContactListForWorkspace404ResponseSchema
from click_funnels_python_sdk.model.contact_list_for_workspace401_response import ContactListForWorkspace401Response as ContactListForWorkspace401ResponseSchema

from click_funnels_python_sdk.type.contact_list_for_workspace_response import ContactListForWorkspaceResponse
from click_funnels_python_sdk.type.contact_list_for_workspace404_response import ContactListForWorkspace404Response
from click_funnels_python_sdk.type.contact_list_for_workspace401_response import ContactListForWorkspace401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.contact_list_for_workspace_response import ContactListForWorkspaceResponse as ContactListForWorkspaceResponsePydantic
from click_funnels_python_sdk.pydantic.contact_list_for_workspace401_response import ContactListForWorkspace401Response as ContactListForWorkspace401ResponsePydantic
from click_funnels_python_sdk.pydantic.contact_list_for_workspace404_response import ContactListForWorkspace404Response as ContactListForWorkspace404ResponsePydantic
...
class FilterSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email_address", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email_address", "id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        email_address: typing.Union[MetaOapg.properties.email_address, list, tuple, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = ContactListForWorkspaceResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ContactListForWorkspaceResponse
...
SchemaFor401ResponseBodyApplicationJson = ContactListForWorkspace401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ContactListForWorkspace401Response
...
SchemaFor404ResponseBodyApplicationJson = ContactListForWorkspace404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ContactListForWorkspace404Response
...
class BaseApi(api_client.Api):
    ...
    def _list_for_workspace_mapped_args(
        ...
        filter: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
    ...
    async def _alist_for_workspace_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/contacts',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListForWorkspace(BaseApi):
    ...
    async def alist_for_workspace(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContactListForWorkspaceResponsePydantic:
        ...
        if validate:
            return RootModel[ContactListForWorkspaceResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ContactListForWorkspaceResponsePydantic, raw_response.body)
