...
from click_funnels_python_sdk.model.forms_submission_create_new_submission401_response import FormsSubmissionCreateNewSubmission401Response as FormsSubmissionCreateNewSubmission401ResponseSchema
from click_funnels_python_sdk.model.forms_submission_create_new_submission_request import FormsSubmissionCreateNewSubmissionRequest as FormsSubmissionCreateNewSubmissionRequestSchema
...
from click_funnels_python_sdk.model.forms_submission_create_new_submission_response import FormsSubmissionCreateNewSubmissionResponse as FormsSubmissionCreateNewSubmissionResponseSchema

from click_funnels_python_sdk.type.forms_submission_create_new_submission401_response import FormsSubmissionCreateNewSubmission401Response
from click_funnels_python_sdk.type.forms_submission_create_new_submission_response import FormsSubmissionCreateNewSubmissionResponse
from click_funnels_python_sdk.type.forms_submission_create_new_submission_request import FormsSubmissionCreateNewSubmissionRequest
from click_funnels_python_sdk.type.forms_submission_attributes import FormsSubmissionAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_submission_create_new_submission_response import FormsSubmissionCreateNewSubmissionResponse as FormsSubmissionCreateNewSubmissionResponsePydantic
from click_funnels_python_sdk.pydantic.forms_submission_create_new_submission_request import FormsSubmissionCreateNewSubmissionRequest as FormsSubmissionCreateNewSubmissionRequestPydantic
from click_funnels_python_sdk.pydantic.forms_submission_create_new_submission401_response import FormsSubmissionCreateNewSubmission401Response as FormsSubmissionCreateNewSubmission401ResponsePydantic
...
# Path params
FormIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'form_id': typing.Union[FormIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = FormsSubmissionCreateNewSubmissionRequestSchema


request_body_forms_submission_create_new_submission_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FormsSubmissionAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = FormsSubmissionCreateNewSubmissionResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormsSubmissionCreateNewSubmissionResponse
...
SchemaFor401ResponseBodyApplicationJson = FormsSubmissionCreateNewSubmission401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsSubmissionCreateNewSubmission401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_new_submission_mapped_args(
        self,
        form_id: int,
    ...
    async def _acreate_new_submission_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_forms_submission_create_new_submission_request.serialize(body, content_type)
    ...
    def _create_new_submission_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewSubmissionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_submission(
        self,
        form_id: int,
        forms_submission: typing.Optional[FormsSubmissionParameters] = None,
        **kwargs,
        ...
        args = self._create_new_submission_mapped_args(
            form_id=form_id,
            forms_submission=forms_submission,
        )
        return await self._acreate_new_submission_oapg(
            body=args.body,
    ...
    def create_new_submission(
        ...
        return self._create_new_submission_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewSubmission(BaseApi):
    ...
    async def acreate_new_submission(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_submission(
            form_id=form_id,
            forms_submission=forms_submission,
            **kwargs,
        )
    ...
    def create_new_submission(
        ...
        raw_response = self.raw.create_new_submission(
            form_id=form_id,
            forms_submission=forms_submission,
        )
        if validate:
