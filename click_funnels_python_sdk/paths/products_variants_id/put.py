...
from click_funnels_python_sdk.model.products_variant_update_single401_response import ProductsVariantUpdateSingle401Response as ProductsVariantUpdateSingle401ResponseSchema
from click_funnels_python_sdk.model.products_variant_attributes import ProductsVariantAttributes as ProductsVariantAttributesSchema
from click_funnels_python_sdk.model.products_variant_update_single404_response import ProductsVariantUpdateSingle404Response as ProductsVariantUpdateSingle404ResponseSchema
from click_funnels_python_sdk.model.products_variant_update_single_request import ProductsVariantUpdateSingleRequest as ProductsVariantUpdateSingleRequestSchema
from click_funnels_python_sdk.model.products_variant_update_single_response import ProductsVariantUpdateSingleResponse as ProductsVariantUpdateSingleResponseSchema

from click_funnels_python_sdk.type.products_variant_update_single_request import ProductsVariantUpdateSingleRequest
from click_funnels_python_sdk.type.products_variant_update_single_response import ProductsVariantUpdateSingleResponse
from click_funnels_python_sdk.type.products_variant_update_single404_response import ProductsVariantUpdateSingle404Response
from click_funnels_python_sdk.type.products_variant_update_single401_response import ProductsVariantUpdateSingle401Response
from click_funnels_python_sdk.type.products_variant_attributes import ProductsVariantAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.products_variant_update_single404_response import ProductsVariantUpdateSingle404Response as ProductsVariantUpdateSingle404ResponsePydantic
from click_funnels_python_sdk.pydantic.products_variant_update_single_request import ProductsVariantUpdateSingleRequest as ProductsVariantUpdateSingleRequestPydantic
from click_funnels_python_sdk.pydantic.products_variant_attributes import ProductsVariantAttributes as ProductsVariantAttributesPydantic
from click_funnels_python_sdk.pydantic.products_variant_update_single401_response import ProductsVariantUpdateSingle401Response as ProductsVariantUpdateSingle401ResponsePydantic
from click_funnels_python_sdk.pydantic.products_variant_update_single_response import ProductsVariantUpdateSingleResponse as ProductsVariantUpdateSingleResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProductsVariantUpdateSingleRequestSchema


request_body_products_variant_update_single_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProductsVariantAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProductsVariantAttributes
...
SchemaFor400ResponseBodyApplicationJson = ProductsVariantUpdateSingleResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ProductsVariantUpdateSingleResponse
...
SchemaFor401ResponseBodyApplicationJson = ProductsVariantUpdateSingle401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductsVariantUpdateSingle401Response
...
SchemaFor404ResponseBodyApplicationJson = ProductsVariantUpdateSingle404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ProductsVariantUpdateSingle404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_single_mapped_args(
        self,
        id: str,
        products_variant: typing.Optional[ProductsVariantParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if products_variant is not None:
            _body["products_variant"] = products_variant
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_single_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/variants/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_products_variant_update_single_request.serialize(body, content_type)
...
class UpdateSingleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_single(
        self,
        id: str,
        products_variant: typing.Optional[ProductsVariantParameters] = None,
        **kwargs,
        ...
        args = self._update_single_mapped_args(
            id=id,
            products_variant=products_variant,
        )
        return await self._aupdate_single_oapg(
            body=args.body,
    ...
    def update_single(
        ...
        return self._update_single_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSingle(BaseApi):
    ...
    async def aupdate_single(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProductsVariantAttributesPydantic:
        raw_response = await self.raw.aupdate_single(
            id=id,
            products_variant=products_variant,
            **kwargs,
        )
        if validate:
            return ProductsVariantAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ProductsVariantAttributesPydantic, raw_response.body)
    ...
    def update_single(
        ...
        raw_response = self.raw.update_single(
            id=id,
            products_variant=products_variant,
        )
        if validate:
