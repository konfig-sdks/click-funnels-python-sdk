...
from click_funnels_python_sdk.model.orders_invoice_get_for_order_response import OrdersInvoiceGetForOrderResponse as OrdersInvoiceGetForOrderResponseSchema
from click_funnels_python_sdk.model.orders_invoice_attributes import OrdersInvoiceAttributes as OrdersInvoiceAttributesSchema
from click_funnels_python_sdk.model.orders_invoice_get_for_order404_response import OrdersInvoiceGetForOrder404Response as OrdersInvoiceGetForOrder404ResponseSchema

from click_funnels_python_sdk.type.orders_invoice_get_for_order404_response import OrdersInvoiceGetForOrder404Response
from click_funnels_python_sdk.type.orders_invoice_attributes import OrdersInvoiceAttributes
from click_funnels_python_sdk.type.orders_invoice_get_for_order_response import OrdersInvoiceGetForOrderResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.orders_invoice_attributes import OrdersInvoiceAttributes as OrdersInvoiceAttributesPydantic
from click_funnels_python_sdk.pydantic.orders_invoice_get_for_order_response import OrdersInvoiceGetForOrderResponse as OrdersInvoiceGetForOrderResponsePydantic
from click_funnels_python_sdk.pydantic.orders_invoice_get_for_order404_response import OrdersInvoiceGetForOrder404Response as OrdersInvoiceGetForOrder404ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OrdersInvoiceAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OrdersInvoiceAttributes
...
SchemaFor401ResponseBodyApplicationJson = OrdersInvoiceGetForOrderResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: OrdersInvoiceGetForOrderResponse
...
SchemaFor404ResponseBodyApplicationJson = OrdersInvoiceGetForOrder404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: OrdersInvoiceGetForOrder404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_for_order_mapped_args(
        self,
        id: str,
    ...
    async def _aget_for_order_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orders/invoices/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetForOrderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_for_order(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_for_order_mapped_args(
            id=id,
        )
        return await self._aget_for_order_oapg(
    ...
    def get_for_order(
        ...
        return self._get_for_order_oapg(
            path_params=args.path,
        )

class GetForOrder(BaseApi):
    ...
    async def aget_for_order(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrdersInvoiceAttributesPydantic:
        raw_response = await self.raw.aget_for_order(
            id=id,
            **kwargs,
        )
        if validate:
            return OrdersInvoiceAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrdersInvoiceAttributesPydantic, raw_response.body)
    ...
    def get_for_order(
        ...
        raw_response = self.raw.get_for_order(
            id=id,
        )
        if validate:
            return OrdersInvoiceAttributesPydantic(**raw_response.body)
