...
from click_funnels_python_sdk.model.workspace_attributes import WorkspaceAttributes as WorkspaceAttributesSchema
from click_funnels_python_sdk.model.workspace_update401_response import WorkspaceUpdate401Response as WorkspaceUpdate401ResponseSchema
from click_funnels_python_sdk.model.workspace_update_response import WorkspaceUpdateResponse as WorkspaceUpdateResponseSchema
from click_funnels_python_sdk.model.workspace_update404_response import WorkspaceUpdate404Response as WorkspaceUpdate404ResponseSchema
from click_funnels_python_sdk.model.workspace_update_request import WorkspaceUpdateRequest as WorkspaceUpdateRequestSchema

from click_funnels_python_sdk.type.workspace_attributes import WorkspaceAttributes
from click_funnels_python_sdk.type.workspace_update401_response import WorkspaceUpdate401Response
from click_funnels_python_sdk.type.workspace_update_response import WorkspaceUpdateResponse
from click_funnels_python_sdk.type.workspace_update404_response import WorkspaceUpdate404Response
from click_funnels_python_sdk.type.workspace_update_request import WorkspaceUpdateRequest

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.workspace_update_request import WorkspaceUpdateRequest as WorkspaceUpdateRequestPydantic
from click_funnels_python_sdk.pydantic.workspace_update404_response import WorkspaceUpdate404Response as WorkspaceUpdate404ResponsePydantic
from click_funnels_python_sdk.pydantic.workspace_update_response import WorkspaceUpdateResponse as WorkspaceUpdateResponsePydantic
from click_funnels_python_sdk.pydantic.workspace_attributes import WorkspaceAttributes as WorkspaceAttributesPydantic
from click_funnels_python_sdk.pydantic.workspace_update401_response import WorkspaceUpdate401Response as WorkspaceUpdate401ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = WorkspaceUpdateRequestSchema


request_body_workspace_update_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = WorkspaceAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkspaceAttributes
...
SchemaFor400ResponseBodyApplicationJson = WorkspaceUpdateResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: WorkspaceUpdateResponse
...
SchemaFor401ResponseBodyApplicationJson = WorkspaceUpdate401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: WorkspaceUpdate401Response
...
SchemaFor404ResponseBodyApplicationJson = WorkspaceUpdate404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: WorkspaceUpdate404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_mapped_args(
        self,
        id: str,
        workspace: typing.Optional[WorkspaceParameters] = None,
    ...
    async def _aupdate_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_workspace_update_request.serialize(body, content_type)
...
class Update(BaseApi):
    ...
    async def aupdate(
        ...
        **kwargs,
        ...
        if validate:
            return WorkspaceAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(WorkspaceAttributesPydantic, raw_response.body)
