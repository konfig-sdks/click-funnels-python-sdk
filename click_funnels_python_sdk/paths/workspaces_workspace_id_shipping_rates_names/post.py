...
from click_funnels_python_sdk.model.shipping_rates_name_create_new_rate_name401_response import ShippingRatesNameCreateNewRateName401Response as ShippingRatesNameCreateNewRateName401ResponseSchema
from click_funnels_python_sdk.model.shipping_rates_name_create_new_rate_name_response import ShippingRatesNameCreateNewRateNameResponse as ShippingRatesNameCreateNewRateNameResponseSchema
from click_funnels_python_sdk.model.shipping_rates_name_attributes import ShippingRatesNameAttributes as ShippingRatesNameAttributesSchema
from click_funnels_python_sdk.model.shipping_rates_name_create_new_rate_name_request import ShippingRatesNameCreateNewRateNameRequest as ShippingRatesNameCreateNewRateNameRequestSchema

from click_funnels_python_sdk.type.shipping_rates_name_create_new_rate_name401_response import ShippingRatesNameCreateNewRateName401Response
from click_funnels_python_sdk.type.shipping_rates_name_attributes import ShippingRatesNameAttributes
from click_funnels_python_sdk.type.shipping_rates_name_create_new_rate_name_request import ShippingRatesNameCreateNewRateNameRequest
from click_funnels_python_sdk.type.shipping_rates_name_create_new_rate_name_response import ShippingRatesNameCreateNewRateNameResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_rates_name_attributes import ShippingRatesNameAttributes as ShippingRatesNameAttributesPydantic
from click_funnels_python_sdk.pydantic.shipping_rates_name_create_new_rate_name_response import ShippingRatesNameCreateNewRateNameResponse as ShippingRatesNameCreateNewRateNameResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_rates_name_create_new_rate_name401_response import ShippingRatesNameCreateNewRateName401Response as ShippingRatesNameCreateNewRateName401ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_rates_name_create_new_rate_name_request import ShippingRatesNameCreateNewRateNameRequest as ShippingRatesNameCreateNewRateNameRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ShippingRatesNameCreateNewRateNameRequestSchema


request_body_shipping_rates_name_create_new_rate_name_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ShippingRatesNameAttributesSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ShippingRatesNameAttributes
...
SchemaFor400ResponseBodyApplicationJson = ShippingRatesNameCreateNewRateNameResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ShippingRatesNameCreateNewRateNameResponse
...
SchemaFor401ResponseBodyApplicationJson = ShippingRatesNameCreateNewRateName401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingRatesNameCreateNewRateName401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_new_rate_name_mapped_args(
        self,
        workspace_id: int,
        shipping_rates_name: typing.Optional[ShippingRatesNameParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if shipping_rates_name is not None:
            _body["shipping_rates_name"] = shipping_rates_name
        args.body = _body
    ...
    async def _acreate_new_rate_name_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/shipping/rates/names',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_shipping_rates_name_create_new_rate_name_request.serialize(body, content_type)
    ...
    def _create_new_rate_name_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewRateNameRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_rate_name(
        self,
        workspace_id: int,
        shipping_rates_name: typing.Optional[ShippingRatesNameParameters] = None,
        **kwargs,
        ...
        args = self._create_new_rate_name_mapped_args(
            workspace_id=workspace_id,
            shipping_rates_name=shipping_rates_name,
        )
        return await self._acreate_new_rate_name_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_new_rate_name(
        self,
        workspace_id: int,
        shipping_rates_name: typing.Optional[ShippingRatesNameParameters] = None,
    ) -> typing.Union[
        ...
        return self._create_new_rate_name_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewRateName(BaseApi):
    ...
    async def acreate_new_rate_name(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShippingRatesNameAttributesPydantic:
        raw_response = await self.raw.acreate_new_rate_name(
            workspace_id=workspace_id,
            shipping_rates_name=shipping_rates_name,
            **kwargs,
        )
        if validate:
            return ShippingRatesNameAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ShippingRatesNameAttributesPydantic, raw_response.body)
    ...
    def create_new_rate_name(
        ...
        raw_response = self.raw.create_new_rate_name(
            workspace_id=workspace_id,
            shipping_rates_name=shipping_rates_name,
        )
        if validate:
