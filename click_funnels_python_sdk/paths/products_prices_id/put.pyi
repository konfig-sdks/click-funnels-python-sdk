...
from click_funnels_python_sdk.model.products_price_update_single_price_request import ProductsPriceUpdateSinglePriceRequest as ProductsPriceUpdateSinglePriceRequestSchema
from click_funnels_python_sdk.model.products_price_update_single_price401_response import ProductsPriceUpdateSinglePrice401Response as ProductsPriceUpdateSinglePrice401ResponseSchema
from click_funnels_python_sdk.model.products_price_update_single_price_response import ProductsPriceUpdateSinglePriceResponse as ProductsPriceUpdateSinglePriceResponseSchema
from click_funnels_python_sdk.model.products_price_attributes import ProductsPriceAttributes as ProductsPriceAttributesSchema
from click_funnels_python_sdk.model.products_price_update_single_price404_response import ProductsPriceUpdateSinglePrice404Response as ProductsPriceUpdateSinglePrice404ResponseSchema

from click_funnels_python_sdk.type.products_price_update_single_price_request import ProductsPriceUpdateSinglePriceRequest
from click_funnels_python_sdk.type.products_price_update_single_price401_response import ProductsPriceUpdateSinglePrice401Response
from click_funnels_python_sdk.type.products_price_update_single_price404_response import ProductsPriceUpdateSinglePrice404Response
from click_funnels_python_sdk.type.products_price_update_single_price_response import ProductsPriceUpdateSinglePriceResponse
from click_funnels_python_sdk.type.products_price_attributes import ProductsPriceAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.products_price_attributes import ProductsPriceAttributes as ProductsPriceAttributesPydantic
from click_funnels_python_sdk.pydantic.products_price_update_single_price_request import ProductsPriceUpdateSinglePriceRequest as ProductsPriceUpdateSinglePriceRequestPydantic
from click_funnels_python_sdk.pydantic.products_price_update_single_price_response import ProductsPriceUpdateSinglePriceResponse as ProductsPriceUpdateSinglePriceResponsePydantic
from click_funnels_python_sdk.pydantic.products_price_update_single_price401_response import ProductsPriceUpdateSinglePrice401Response as ProductsPriceUpdateSinglePrice401ResponsePydantic
from click_funnels_python_sdk.pydantic.products_price_update_single_price404_response import ProductsPriceUpdateSinglePrice404Response as ProductsPriceUpdateSinglePrice404ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProductsPriceUpdateSinglePriceRequestSchema


request_body_products_price_update_single_price_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProductsPriceAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProductsPriceAttributes
...
SchemaFor400ResponseBodyApplicationJson = ProductsPriceUpdateSinglePriceResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ProductsPriceUpdateSinglePriceResponse
...
SchemaFor401ResponseBodyApplicationJson = ProductsPriceUpdateSinglePrice401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductsPriceUpdateSinglePrice401Response
...
SchemaFor404ResponseBodyApplicationJson = ProductsPriceUpdateSinglePrice404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ProductsPriceUpdateSinglePrice404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_single_price_mapped_args(
        self,
        id: str,
        products_price: typing.Optional[ProductsPriceParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if products_price is not None:
            _body["products_price"] = products_price
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_single_price_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/prices/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_products_price_update_single_price_request.serialize(body, content_type)
...
class UpdateSinglePriceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_single_price(
        self,
        id: str,
        products_price: typing.Optional[ProductsPriceParameters] = None,
        **kwargs,
        ...
        args = self._update_single_price_mapped_args(
            id=id,
            products_price=products_price,
        )
        return await self._aupdate_single_price_oapg(
            body=args.body,
    ...
    def update_single_price(
        ...
        return self._update_single_price_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSinglePrice(BaseApi):
    ...
    async def aupdate_single_price(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProductsPriceAttributesPydantic:
        raw_response = await self.raw.aupdate_single_price(
            id=id,
            products_price=products_price,
            **kwargs,
        )
        if validate:
            return ProductsPriceAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ProductsPriceAttributesPydantic, raw_response.body)
    ...
    def update_single_price(
        ...
        raw_response = self.raw.update_single_price(
            id=id,
            products_price=products_price,
        )
        if validate:
