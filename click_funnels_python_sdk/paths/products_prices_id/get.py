...
from click_funnels_python_sdk.model.products_price_get_single_price_response import ProductsPriceGetSinglePriceResponse as ProductsPriceGetSinglePriceResponseSchema
from click_funnels_python_sdk.model.products_price_get_single_price404_response import ProductsPriceGetSinglePrice404Response as ProductsPriceGetSinglePrice404ResponseSchema
...
from click_funnels_python_sdk.type.products_price_get_single_price404_response import ProductsPriceGetSinglePrice404Response
from click_funnels_python_sdk.type.products_price_attributes import ProductsPriceAttributes
from click_funnels_python_sdk.type.products_price_get_single_price_response import ProductsPriceGetSinglePriceResponse
...
from click_funnels_python_sdk.pydantic.products_price_get_single_price404_response import ProductsPriceGetSinglePrice404Response as ProductsPriceGetSinglePrice404ResponsePydantic
from click_funnels_python_sdk.pydantic.products_price_get_single_price_response import ProductsPriceGetSinglePriceResponse as ProductsPriceGetSinglePriceResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = ProductsPriceGetSinglePriceResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductsPriceGetSinglePriceResponse
...
SchemaFor404ResponseBodyApplicationJson = ProductsPriceGetSinglePrice404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ProductsPriceGetSinglePrice404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_single_price_mapped_args(
        self,
        id: str,
    ...
    async def _aget_single_price_oapg(
        self,
...
class GetSinglePriceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_price(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_single_price_mapped_args(
            id=id,
        )
        return await self._aget_single_price_oapg(
    ...
    def get_single_price(
        ...
        return self._get_single_price_oapg(
            path_params=args.path,
        )

class GetSinglePrice(BaseApi):
    ...
    async def aget_single_price(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_price(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_single_price(
        ...
        raw_response = self.raw.get_single_price(
            id=id,
        )
        if validate:
            return ProductsPriceAttributesPydantic(**raw_response.body)
