...
from click_funnels_python_sdk.model.order_update_specific_response import OrderUpdateSpecificResponse as OrderUpdateSpecificResponseSchema
from click_funnels_python_sdk.model.order_update_specific_request import OrderUpdateSpecificRequest as OrderUpdateSpecificRequestSchema
from click_funnels_python_sdk.model.order_update_specific401_response import OrderUpdateSpecific401Response as OrderUpdateSpecific401ResponseSchema
from click_funnels_python_sdk.model.order_update_specific404_response import OrderUpdateSpecific404Response as OrderUpdateSpecific404ResponseSchema
from click_funnels_python_sdk.model.order_attributes import OrderAttributes as OrderAttributesSchema

from click_funnels_python_sdk.type.order_update_specific_response import OrderUpdateSpecificResponse
from click_funnels_python_sdk.type.order_update_specific401_response import OrderUpdateSpecific401Response
from click_funnels_python_sdk.type.order_update_specific404_response import OrderUpdateSpecific404Response
from click_funnels_python_sdk.type.order_attributes import OrderAttributes
from click_funnels_python_sdk.type.order_update_specific_request import OrderUpdateSpecificRequest

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.order_attributes import OrderAttributes as OrderAttributesPydantic
from click_funnels_python_sdk.pydantic.order_update_specific_request import OrderUpdateSpecificRequest as OrderUpdateSpecificRequestPydantic
from click_funnels_python_sdk.pydantic.order_update_specific_response import OrderUpdateSpecificResponse as OrderUpdateSpecificResponsePydantic
from click_funnels_python_sdk.pydantic.order_update_specific404_response import OrderUpdateSpecific404Response as OrderUpdateSpecific404ResponsePydantic
from click_funnels_python_sdk.pydantic.order_update_specific401_response import OrderUpdateSpecific401Response as OrderUpdateSpecific401ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = OrderUpdateSpecificRequestSchema


request_body_order_update_specific_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = OrderAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OrderAttributes
...
SchemaFor400ResponseBodyApplicationJson = OrderUpdateSpecificResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: OrderUpdateSpecificResponse
...
SchemaFor401ResponseBodyApplicationJson = OrderUpdateSpecific401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: OrderUpdateSpecific401Response
...
SchemaFor404ResponseBodyApplicationJson = OrderUpdateSpecific404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: OrderUpdateSpecific404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_specific_mapped_args(
        self,
        id: str,
        order: typing.Optional[OrderParameters] = None,
    ...
    async def _aupdate_specific_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_order_update_specific_request.serialize(body, content_type)
...
class UpdateSpecificRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_specific(
        self,
        id: str,
        order: typing.Optional[OrderParameters] = None,
        **kwargs,
        ...
        args = self._update_specific_mapped_args(
            id=id,
            order=order,
        )
        return await self._aupdate_specific_oapg(
            body=args.body,
    ...
    def update_specific(
        ...
        return self._update_specific_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSpecific(BaseApi):
    ...
    async def aupdate_specific(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrderAttributesPydantic:
        raw_response = await self.raw.aupdate_specific(
            id=id,
            order=order,
            **kwargs,
        )
        if validate:
            return OrderAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrderAttributesPydantic, raw_response.body)
    ...
    def update_specific(
        ...
        raw_response = self.raw.update_specific(
            id=id,
            order=order,
        )
        if validate:
