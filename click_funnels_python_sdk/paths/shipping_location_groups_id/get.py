...
from click_funnels_python_sdk.model.shipping_location_group_get_profile_location_group404_response import ShippingLocationGroupGetProfileLocationGroup404Response as ShippingLocationGroupGetProfileLocationGroup404ResponseSchema
from click_funnels_python_sdk.model.shipping_location_group_get_profile_location_group_response import ShippingLocationGroupGetProfileLocationGroupResponse as ShippingLocationGroupGetProfileLocationGroupResponseSchema
from click_funnels_python_sdk.model.shipping_location_group_attributes import ShippingLocationGroupAttributes as ShippingLocationGroupAttributesSchema

from click_funnels_python_sdk.type.shipping_location_group_get_profile_location_group404_response import ShippingLocationGroupGetProfileLocationGroup404Response
from click_funnels_python_sdk.type.shipping_location_group_attributes import ShippingLocationGroupAttributes
from click_funnels_python_sdk.type.shipping_location_group_get_profile_location_group_response import ShippingLocationGroupGetProfileLocationGroupResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_location_group_get_profile_location_group404_response import ShippingLocationGroupGetProfileLocationGroup404Response as ShippingLocationGroupGetProfileLocationGroup404ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_location_group_attributes import ShippingLocationGroupAttributes as ShippingLocationGroupAttributesPydantic
from click_funnels_python_sdk.pydantic.shipping_location_group_get_profile_location_group_response import ShippingLocationGroupGetProfileLocationGroupResponse as ShippingLocationGroupGetProfileLocationGroupResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ShippingLocationGroupAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ShippingLocationGroupAttributes
...
SchemaFor401ResponseBodyApplicationJson = ShippingLocationGroupGetProfileLocationGroupResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingLocationGroupGetProfileLocationGroupResponse
...
SchemaFor404ResponseBodyApplicationJson = ShippingLocationGroupGetProfileLocationGroup404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingLocationGroupGetProfileLocationGroup404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_profile_location_group_mapped_args(
        self,
        id: str,
    ...
    async def _aget_profile_location_group_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/shipping/location_groups/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_profile_location_group_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetProfileLocationGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_profile_location_group(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_profile_location_group_mapped_args(
            id=id,
        )
        return await self._aget_profile_location_group_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_profile_location_group(
        self,
        id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_profile_location_group_oapg(
            path_params=args.path,
        )

class GetProfileLocationGroup(BaseApi):
    ...
    async def aget_profile_location_group(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShippingLocationGroupAttributesPydantic:
        raw_response = await self.raw.aget_profile_location_group(
            id=id,
            **kwargs,
        )
        if validate:
            return ShippingLocationGroupAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ShippingLocationGroupAttributesPydantic, raw_response.body)
    ...
    def get_profile_location_group(
        ...
        raw_response = self.raw.get_profile_location_group(
            id=id,
        )
        if validate:
            return ShippingLocationGroupAttributesPydantic(**raw_response.body)
