...
from click_funnels_python_sdk.model.orders_transaction_attributes import OrdersTransactionAttributes as OrdersTransactionAttributesSchema
from click_funnels_python_sdk.model.orders_transaction_get_by_id_response import OrdersTransactionGetByIdResponse as OrdersTransactionGetByIdResponseSchema
from click_funnels_python_sdk.model.orders_transaction_get_by_id404_response import OrdersTransactionGetById404Response as OrdersTransactionGetById404ResponseSchema

from click_funnels_python_sdk.type.orders_transaction_attributes import OrdersTransactionAttributes
from click_funnels_python_sdk.type.orders_transaction_get_by_id_response import OrdersTransactionGetByIdResponse
from click_funnels_python_sdk.type.orders_transaction_get_by_id404_response import OrdersTransactionGetById404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.orders_transaction_attributes import OrdersTransactionAttributes as OrdersTransactionAttributesPydantic
from click_funnels_python_sdk.pydantic.orders_transaction_get_by_id_response import OrdersTransactionGetByIdResponse as OrdersTransactionGetByIdResponsePydantic
from click_funnels_python_sdk.pydantic.orders_transaction_get_by_id404_response import OrdersTransactionGetById404Response as OrdersTransactionGetById404ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OrdersTransactionAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OrdersTransactionAttributes
...
SchemaFor401ResponseBodyApplicationJson = OrdersTransactionGetByIdResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: OrdersTransactionGetByIdResponse
...
SchemaFor404ResponseBodyApplicationJson = OrdersTransactionGetById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: OrdersTransactionGetById404Response
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orders/transactions/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrdersTransactionAttributesPydantic:
        raw_response = await self.raw.aget_by_id(
            id=id,
            **kwargs,
        )
        if validate:
            return OrdersTransactionAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrdersTransactionAttributesPydantic, raw_response.body)
