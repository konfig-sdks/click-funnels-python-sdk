...
from click_funnels_python_sdk.model.form_create_new_form_request import FormCreateNewFormRequest as FormCreateNewFormRequestSchema
from click_funnels_python_sdk.model.form_create_new_form_response import FormCreateNewFormResponse as FormCreateNewFormResponseSchema
from click_funnels_python_sdk.model.form_create_new_form401_response import FormCreateNewForm401Response as FormCreateNewForm401ResponseSchema
from click_funnels_python_sdk.model.form_attributes import FormAttributes as FormAttributesSchema

from click_funnels_python_sdk.type.form_create_new_form401_response import FormCreateNewForm401Response
from click_funnels_python_sdk.type.form_create_new_form_request import FormCreateNewFormRequest
from click_funnels_python_sdk.type.form_attributes import FormAttributes
from click_funnels_python_sdk.type.form_create_new_form_response import FormCreateNewFormResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.form_create_new_form_response import FormCreateNewFormResponse as FormCreateNewFormResponsePydantic
from click_funnels_python_sdk.pydantic.form_attributes import FormAttributes as FormAttributesPydantic
from click_funnels_python_sdk.pydantic.form_create_new_form401_response import FormCreateNewForm401Response as FormCreateNewForm401ResponsePydantic
from click_funnels_python_sdk.pydantic.form_create_new_form_request import FormCreateNewFormRequest as FormCreateNewFormRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FormCreateNewFormRequestSchema


request_body_form_create_new_form_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FormAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = FormCreateNewFormResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormCreateNewFormResponse
...
SchemaFor401ResponseBodyApplicationJson = FormCreateNewForm401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormCreateNewForm401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_new_form_mapped_args(
        self,
        workspace_id: int,
    ...
    async def _acreate_new_form_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/forms',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_form_create_new_form_request.serialize(body, content_type)
...
class CreateNewFormRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_form(
        self,
        workspace_id: int,
        form: typing.Optional[FormParameters] = None,
        **kwargs,
        ...
        args = self._create_new_form_mapped_args(
            workspace_id=workspace_id,
            form=form,
        )
        return await self._acreate_new_form_oapg(
            body=args.body,
    ...
    def create_new_form(
        ...
        return self._create_new_form_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewForm(BaseApi):
    ...
    async def acreate_new_form(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_form(
            workspace_id=workspace_id,
            form=form,
            **kwargs,
        )
    ...
    def create_new_form(
        ...
        raw_response = self.raw.create_new_form(
            workspace_id=workspace_id,
            form=form,
        )
        if validate:
