...
from click_funnels_python_sdk.model.form_list_workspace_forms_response import FormListWorkspaceFormsResponse as FormListWorkspaceFormsResponseSchema
from click_funnels_python_sdk.model.form_list_workspace_forms404_response import FormListWorkspaceForms404Response as FormListWorkspaceForms404ResponseSchema
from click_funnels_python_sdk.model.form_list_workspace_forms401_response import FormListWorkspaceForms401Response as FormListWorkspaceForms401ResponseSchema

from click_funnels_python_sdk.type.form_list_workspace_forms404_response import FormListWorkspaceForms404Response
from click_funnels_python_sdk.type.form_list_workspace_forms_response import FormListWorkspaceFormsResponse
from click_funnels_python_sdk.type.form_list_workspace_forms401_response import FormListWorkspaceForms401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.form_list_workspace_forms404_response import FormListWorkspaceForms404Response as FormListWorkspaceForms404ResponsePydantic
from click_funnels_python_sdk.pydantic.form_list_workspace_forms401_response import FormListWorkspaceForms401Response as FormListWorkspaceForms401ResponsePydantic
from click_funnels_python_sdk.pydantic.form_list_workspace_forms_response import FormListWorkspaceFormsResponse as FormListWorkspaceFormsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FormListWorkspaceFormsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: FormListWorkspaceFormsResponse
...
SchemaFor401ResponseBodyApplicationJson = FormListWorkspaceForms401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormListWorkspaceForms401Response
...
SchemaFor404ResponseBodyApplicationJson = FormListWorkspaceForms404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormListWorkspaceForms404Response
...
class BaseApi(api_client.Api):
    ...
    def _list_workspace_forms_mapped_args(
        self,
        workspace_id: int,
    ...
    async def _alist_workspace_forms_oapg(
        self,
    ...
    def _list_workspace_forms_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListWorkspaceFormsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_workspace_forms(
        self,
        workspace_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_workspace_forms_mapped_args(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
        )
        return await self._alist_workspace_forms_oapg(
    ...
    def list_workspace_forms(
        ...
        return self._list_workspace_forms_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListWorkspaceForms(BaseApi):
    ...
    async def alist_workspace_forms(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FormListWorkspaceFormsResponsePydantic:
        raw_response = await self.raw.alist_workspace_forms(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
            **kwargs,
        ...
        if validate:
            return RootModel[FormListWorkspaceFormsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FormListWorkspaceFormsResponsePydantic, raw_response.body)
    ...
    def list_workspace_forms(
        ...
        raw_response = self.raw.list_workspace_forms(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
        )
