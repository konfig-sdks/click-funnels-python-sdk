...
from click_funnels_python_sdk.model.order_list_orders404_response import OrderListOrders404Response as OrderListOrders404ResponseSchema
from click_funnels_python_sdk.model.order_list_orders_response import OrderListOrdersResponse as OrderListOrdersResponseSchema
from click_funnels_python_sdk.model.order_list_orders401_response import OrderListOrders401Response as OrderListOrders401ResponseSchema

from click_funnels_python_sdk.type.order_list_orders401_response import OrderListOrders401Response
from click_funnels_python_sdk.type.order_list_orders_response import OrderListOrdersResponse
from click_funnels_python_sdk.type.order_list_orders404_response import OrderListOrders404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.order_list_orders404_response import OrderListOrders404Response as OrderListOrders404ResponsePydantic
from click_funnels_python_sdk.pydantic.order_list_orders401_response import OrderListOrders401Response as OrderListOrders401ResponsePydantic
from click_funnels_python_sdk.pydantic.order_list_orders_response import OrderListOrdersResponse as OrderListOrdersResponsePydantic
...
class FilterSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contact_id", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contact_id", "id", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        contact_id: typing.Union[MetaOapg.properties.contact_id, list, tuple, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = OrderListOrdersResponseSchema
...
SchemaFor401ResponseBodyApplicationJson = OrderListOrders401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: OrderListOrders401Response
...
SchemaFor404ResponseBodyApplicationJson = OrderListOrders404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: OrderListOrders404Response
    ...
    async def _alist_orders_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/orders',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListOrdersRaw(BaseApi):
    ...
    async def alist_orders(
        ...
        **kwargs,
        ...
        args = self._list_orders_mapped_args(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
            filter=filter,
        )
        return await self._alist_orders_oapg(
...
class ListOrders(BaseApi):
    ...
    async def alist_orders(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrderListOrdersResponsePydantic:
        raw_response = await self.raw.alist_orders(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
            filter=filter,
        ...
        if validate:
            return RootModel[OrderListOrdersResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(OrderListOrdersResponsePydantic, raw_response.body)
    ...
    def list_orders(
        ...
        raw_response = self.raw.list_orders(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
            filter=filter,
