...
from click_funnels_python_sdk.model.course_list_for_workspace_response import CourseListForWorkspaceResponse as CourseListForWorkspaceResponseSchema
from click_funnels_python_sdk.model.course_list_for_workspace401_response import CourseListForWorkspace401Response as CourseListForWorkspace401ResponseSchema
from click_funnels_python_sdk.model.course_list_for_workspace404_response import CourseListForWorkspace404Response as CourseListForWorkspace404ResponseSchema

from click_funnels_python_sdk.type.course_list_for_workspace404_response import CourseListForWorkspace404Response
from click_funnels_python_sdk.type.course_list_for_workspace_response import CourseListForWorkspaceResponse
from click_funnels_python_sdk.type.course_list_for_workspace401_response import CourseListForWorkspace401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.course_list_for_workspace_response import CourseListForWorkspaceResponse as CourseListForWorkspaceResponsePydantic
from click_funnels_python_sdk.pydantic.course_list_for_workspace401_response import CourseListForWorkspace401Response as CourseListForWorkspace401ResponsePydantic
from click_funnels_python_sdk.pydantic.course_list_for_workspace404_response import CourseListForWorkspace404Response as CourseListForWorkspace404ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CourseListForWorkspaceResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CourseListForWorkspaceResponse
...
SchemaFor401ResponseBodyApplicationJson = CourseListForWorkspace401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: CourseListForWorkspace401Response
...
SchemaFor404ResponseBodyApplicationJson = CourseListForWorkspace404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: CourseListForWorkspace404Response
    ...
    async def _alist_for_workspace_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/courses',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListForWorkspace(BaseApi):
    ...
    async def alist_for_workspace(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CourseListForWorkspaceResponsePydantic:
        ...
        if validate:
            return RootModel[CourseListForWorkspaceResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(CourseListForWorkspaceResponsePydantic, raw_response.body)
