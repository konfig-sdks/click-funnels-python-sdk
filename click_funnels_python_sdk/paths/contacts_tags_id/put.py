...
from click_funnels_python_sdk.model.contacts_tag_update_specific_tag_request import ContactsTagUpdateSpecificTagRequest as ContactsTagUpdateSpecificTagRequestSchema
from click_funnels_python_sdk.model.contacts_tag_update_specific_tag401_response import ContactsTagUpdateSpecificTag401Response as ContactsTagUpdateSpecificTag401ResponseSchema
from click_funnels_python_sdk.model.contacts_tag_attributes import ContactsTagAttributes as ContactsTagAttributesSchema
from click_funnels_python_sdk.model.contacts_tag_update_specific_tag_response import ContactsTagUpdateSpecificTagResponse as ContactsTagUpdateSpecificTagResponseSchema
from click_funnels_python_sdk.model.contacts_tag_update_specific_tag404_response import ContactsTagUpdateSpecificTag404Response as ContactsTagUpdateSpecificTag404ResponseSchema

from click_funnels_python_sdk.type.contacts_tag_update_specific_tag404_response import ContactsTagUpdateSpecificTag404Response
from click_funnels_python_sdk.type.contacts_tag_update_specific_tag401_response import ContactsTagUpdateSpecificTag401Response
from click_funnels_python_sdk.type.contacts_tag_attributes import ContactsTagAttributes
from click_funnels_python_sdk.type.contacts_tag_update_specific_tag_request import ContactsTagUpdateSpecificTagRequest
from click_funnels_python_sdk.type.contacts_tag_update_specific_tag_response import ContactsTagUpdateSpecificTagResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.contacts_tag_update_specific_tag401_response import ContactsTagUpdateSpecificTag401Response as ContactsTagUpdateSpecificTag401ResponsePydantic
from click_funnels_python_sdk.pydantic.contacts_tag_update_specific_tag_response import ContactsTagUpdateSpecificTagResponse as ContactsTagUpdateSpecificTagResponsePydantic
from click_funnels_python_sdk.pydantic.contacts_tag_update_specific_tag_request import ContactsTagUpdateSpecificTagRequest as ContactsTagUpdateSpecificTagRequestPydantic
from click_funnels_python_sdk.pydantic.contacts_tag_attributes import ContactsTagAttributes as ContactsTagAttributesPydantic
from click_funnels_python_sdk.pydantic.contacts_tag_update_specific_tag404_response import ContactsTagUpdateSpecificTag404Response as ContactsTagUpdateSpecificTag404ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ContactsTagUpdateSpecificTagRequestSchema


request_body_contacts_tag_update_specific_tag_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ContactsTagAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContactsTagAttributes
...
SchemaFor400ResponseBodyApplicationJson = ContactsTagUpdateSpecificTagResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ContactsTagUpdateSpecificTagResponse
...
SchemaFor401ResponseBodyApplicationJson = ContactsTagUpdateSpecificTag401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ContactsTagUpdateSpecificTag401Response
...
SchemaFor404ResponseBodyApplicationJson = ContactsTagUpdateSpecificTag404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ContactsTagUpdateSpecificTag404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_specific_tag_mapped_args(
        self,
        id: str,
        contacts_tag: typing.Optional[ContactsTagParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if contacts_tag is not None:
            _body["contacts_tag"] = contacts_tag
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_specific_tag_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contacts/tags/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_contacts_tag_update_specific_tag_request.serialize(body, content_type)
...
class UpdateSpecificTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_specific_tag(
        self,
        id: str,
        contacts_tag: typing.Optional[ContactsTagParameters] = None,
        **kwargs,
        ...
        args = self._update_specific_tag_mapped_args(
            id=id,
            contacts_tag=contacts_tag,
        )
        return await self._aupdate_specific_tag_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_specific_tag(
        self,
        id: str,
        contacts_tag: typing.Optional[ContactsTagParameters] = None,
    ) -> typing.Union[
        ...
        return self._update_specific_tag_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSpecificTag(BaseApi):
    ...
    async def aupdate_specific_tag(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContactsTagAttributesPydantic:
        raw_response = await self.raw.aupdate_specific_tag(
            id=id,
            contacts_tag=contacts_tag,
            **kwargs,
        )
        if validate:
            return ContactsTagAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ContactsTagAttributesPydantic, raw_response.body)
    ...
    def update_specific_tag(
        ...
        raw_response = self.raw.update_specific_tag(
            id=id,
            contacts_tag=contacts_tag,
        )
        if validate:
