...
from click_funnels_python_sdk.model.workspace_list_workspaces401_response import WorkspaceListWorkspaces401Response as WorkspaceListWorkspaces401ResponseSchema
from click_funnels_python_sdk.model.workspace_list_workspaces_response import WorkspaceListWorkspacesResponse as WorkspaceListWorkspacesResponseSchema
from click_funnels_python_sdk.model.workspace_list_workspaces404_response import WorkspaceListWorkspaces404Response as WorkspaceListWorkspaces404ResponseSchema

from click_funnels_python_sdk.type.workspace_list_workspaces404_response import WorkspaceListWorkspaces404Response
from click_funnels_python_sdk.type.workspace_list_workspaces_response import WorkspaceListWorkspacesResponse
from click_funnels_python_sdk.type.workspace_list_workspaces401_response import WorkspaceListWorkspaces401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.workspace_list_workspaces404_response import WorkspaceListWorkspaces404Response as WorkspaceListWorkspaces404ResponsePydantic
from click_funnels_python_sdk.pydantic.workspace_list_workspaces_response import WorkspaceListWorkspacesResponse as WorkspaceListWorkspacesResponsePydantic
from click_funnels_python_sdk.pydantic.workspace_list_workspaces401_response import WorkspaceListWorkspaces401Response as WorkspaceListWorkspaces401ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkspaceListWorkspacesResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkspaceListWorkspacesResponse
...
SchemaFor401ResponseBodyApplicationJson = WorkspaceListWorkspaces401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: WorkspaceListWorkspaces401Response
...
SchemaFor404ResponseBodyApplicationJson = WorkspaceListWorkspaces404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: WorkspaceListWorkspaces404Response
...
class BaseApi(api_client.Api):
    ...
    def _list_workspaces_mapped_args(
        self,
        team_id: int,
    ...
    async def _alist_workspaces_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/teams/{team_id}/workspaces',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListWorkspacesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_workspaces(
        self,
        team_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_workspaces_mapped_args(
            team_id=team_id,
            after=after,
            sort_order=sort_order,
        )
        return await self._alist_workspaces_oapg(
...
class ListWorkspaces(BaseApi):
    ...
    async def alist_workspaces(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WorkspaceListWorkspacesResponsePydantic:
        raw_response = await self.raw.alist_workspaces(
            team_id=team_id,
            after=after,
            sort_order=sort_order,
            **kwargs,
        ...
        if validate:
            return RootModel[WorkspaceListWorkspacesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(WorkspaceListWorkspacesResponsePydantic, raw_response.body)
    ...
    def list_workspaces(
        ...
        raw_response = self.raw.list_workspaces(
            team_id=team_id,
            after=after,
            sort_order=sort_order,
        )
