...
from click_funnels_python_sdk.model.shipping_rates_name_get_rate_name_response import ShippingRatesNameGetRateNameResponse as ShippingRatesNameGetRateNameResponseSchema
...
from click_funnels_python_sdk.model.shipping_rates_name_get_rate_name404_response import ShippingRatesNameGetRateName404Response as ShippingRatesNameGetRateName404ResponseSchema

from click_funnels_python_sdk.type.shipping_rates_name_attributes import ShippingRatesNameAttributes
from click_funnels_python_sdk.type.shipping_rates_name_get_rate_name404_response import ShippingRatesNameGetRateName404Response
from click_funnels_python_sdk.type.shipping_rates_name_get_rate_name_response import ShippingRatesNameGetRateNameResponse
...
from click_funnels_python_sdk.pydantic.shipping_rates_name_get_rate_name_response import ShippingRatesNameGetRateNameResponse as ShippingRatesNameGetRateNameResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_rates_name_get_rate_name404_response import ShippingRatesNameGetRateName404Response as ShippingRatesNameGetRateName404ResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = ShippingRatesNameGetRateNameResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingRatesNameGetRateNameResponse
...
SchemaFor404ResponseBodyApplicationJson = ShippingRatesNameGetRateName404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingRatesNameGetRateName404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_rate_name_mapped_args(
        self,
        id: str,
    ...
    async def _aget_rate_name_oapg(
        self,
...
class GetRateNameRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_rate_name(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_rate_name_mapped_args(
            id=id,
        )
        return await self._aget_rate_name_oapg(
    ...
    def get_rate_name(
        ...
        return self._get_rate_name_oapg(
            path_params=args.path,
        )

class GetRateName(BaseApi):
    ...
    async def aget_rate_name(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_rate_name(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_rate_name(
        ...
        raw_response = self.raw.get_rate_name(
            id=id,
        )
        if validate:
            return ShippingRatesNameAttributesPydantic(**raw_response.body)
