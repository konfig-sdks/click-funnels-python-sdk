...
from click_funnels_python_sdk.model.courses_section_update_section_by_id404_response import CoursesSectionUpdateSectionById404Response as CoursesSectionUpdateSectionById404ResponseSchema
from click_funnels_python_sdk.model.courses_section_update_section_by_id_request import CoursesSectionUpdateSectionByIdRequest as CoursesSectionUpdateSectionByIdRequestSchema
from click_funnels_python_sdk.model.courses_section_update_section_by_id401_response import CoursesSectionUpdateSectionById401Response as CoursesSectionUpdateSectionById401ResponseSchema
from click_funnels_python_sdk.model.courses_section_attributes import CoursesSectionAttributes as CoursesSectionAttributesSchema
from click_funnels_python_sdk.model.courses_section_update_section_by_id_response import CoursesSectionUpdateSectionByIdResponse as CoursesSectionUpdateSectionByIdResponseSchema

from click_funnels_python_sdk.type.courses_section_update_section_by_id404_response import CoursesSectionUpdateSectionById404Response
from click_funnels_python_sdk.type.courses_section_update_section_by_id_response import CoursesSectionUpdateSectionByIdResponse
from click_funnels_python_sdk.type.courses_section_update_section_by_id401_response import CoursesSectionUpdateSectionById401Response
from click_funnels_python_sdk.type.courses_section_attributes import CoursesSectionAttributes
from click_funnels_python_sdk.type.courses_section_update_section_by_id_request import CoursesSectionUpdateSectionByIdRequest

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.courses_section_update_section_by_id_request import CoursesSectionUpdateSectionByIdRequest as CoursesSectionUpdateSectionByIdRequestPydantic
from click_funnels_python_sdk.pydantic.courses_section_attributes import CoursesSectionAttributes as CoursesSectionAttributesPydantic
from click_funnels_python_sdk.pydantic.courses_section_update_section_by_id401_response import CoursesSectionUpdateSectionById401Response as CoursesSectionUpdateSectionById401ResponsePydantic
from click_funnels_python_sdk.pydantic.courses_section_update_section_by_id404_response import CoursesSectionUpdateSectionById404Response as CoursesSectionUpdateSectionById404ResponsePydantic
from click_funnels_python_sdk.pydantic.courses_section_update_section_by_id_response import CoursesSectionUpdateSectionByIdResponse as CoursesSectionUpdateSectionByIdResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = CoursesSectionUpdateSectionByIdRequestSchema


request_body_courses_section_update_section_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CoursesSectionAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CoursesSectionAttributes
...
SchemaFor400ResponseBodyApplicationJson = CoursesSectionUpdateSectionByIdResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: CoursesSectionUpdateSectionByIdResponse
...
SchemaFor401ResponseBodyApplicationJson = CoursesSectionUpdateSectionById401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: CoursesSectionUpdateSectionById401Response
...
SchemaFor404ResponseBodyApplicationJson = CoursesSectionUpdateSectionById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: CoursesSectionUpdateSectionById404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_section_by_id_mapped_args(
        self,
        id: str,
        courses_section: typing.Optional[CoursesSectionParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if courses_section is not None:
            _body["courses_section"] = courses_section
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_section_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/courses/sections/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_courses_section_update_section_by_id_request.serialize(body, content_type)
    ...
    def _update_section_by_id_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateSectionByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_section_by_id(
        self,
        id: str,
        courses_section: typing.Optional[CoursesSectionParameters] = None,
        **kwargs,
        ...
        args = self._update_section_by_id_mapped_args(
            id=id,
            courses_section=courses_section,
        )
        return await self._aupdate_section_by_id_oapg(
            body=args.body,
    ...
    def update_section_by_id(
        ...
        return self._update_section_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSectionById(BaseApi):
    ...
    async def aupdate_section_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CoursesSectionAttributesPydantic:
        raw_response = await self.raw.aupdate_section_by_id(
            id=id,
            courses_section=courses_section,
            **kwargs,
        )
        if validate:
            return CoursesSectionAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(CoursesSectionAttributesPydantic, raw_response.body)
    ...
    def update_section_by_id(
        ...
        raw_response = self.raw.update_section_by_id(
            id=id,
            courses_section=courses_section,
        )
        if validate:
