...
from click_funnels_python_sdk.model.courses_section_get_section404_response import CoursesSectionGetSection404Response as CoursesSectionGetSection404ResponseSchema
from click_funnels_python_sdk.model.courses_section_get_section_response import CoursesSectionGetSectionResponse as CoursesSectionGetSectionResponseSchema
...
from click_funnels_python_sdk.type.courses_section_get_section_response import CoursesSectionGetSectionResponse
from click_funnels_python_sdk.type.courses_section_attributes import CoursesSectionAttributes
from click_funnels_python_sdk.type.courses_section_get_section404_response import CoursesSectionGetSection404Response
...
from click_funnels_python_sdk.pydantic.courses_section_get_section_response import CoursesSectionGetSectionResponse as CoursesSectionGetSectionResponsePydantic
from click_funnels_python_sdk.pydantic.courses_section_get_section404_response import CoursesSectionGetSection404Response as CoursesSectionGetSection404ResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = CoursesSectionGetSectionResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: CoursesSectionGetSectionResponse
...
SchemaFor404ResponseBodyApplicationJson = CoursesSectionGetSection404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: CoursesSectionGetSection404Response
...
class GetSectionRaw(BaseApi):
    ...
    async def aget_section(
        ...
        **kwargs,
        ...
        args = self._get_section_mapped_args(
            id=id,
        )
        return await self._aget_section_oapg(
...
class GetSection(BaseApi):
    ...
    async def aget_section(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_section(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_section(
        ...
        raw_response = self.raw.get_section(
            id=id,
        )
        if validate:
            return CoursesSectionAttributesPydantic(**raw_response.body)
