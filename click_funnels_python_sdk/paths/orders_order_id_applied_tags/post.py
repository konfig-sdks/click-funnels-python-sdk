...
from click_funnels_python_sdk.model.orders_applied_tag_create_applied_tag401_response import OrdersAppliedTagCreateAppliedTag401Response as OrdersAppliedTagCreateAppliedTag401ResponseSchema
from click_funnels_python_sdk.model.orders_applied_tag_create_applied_tag_response import OrdersAppliedTagCreateAppliedTagResponse as OrdersAppliedTagCreateAppliedTagResponseSchema
from click_funnels_python_sdk.model.orders_applied_tag_attributes import OrdersAppliedTagAttributes as OrdersAppliedTagAttributesSchema
from click_funnels_python_sdk.model.orders_applied_tag_create_applied_tag_request import OrdersAppliedTagCreateAppliedTagRequest as OrdersAppliedTagCreateAppliedTagRequestSchema

from click_funnels_python_sdk.type.orders_applied_tag_attributes import OrdersAppliedTagAttributes
from click_funnels_python_sdk.type.orders_applied_tag_create_applied_tag_response import OrdersAppliedTagCreateAppliedTagResponse
from click_funnels_python_sdk.type.orders_applied_tag_create_applied_tag401_response import OrdersAppliedTagCreateAppliedTag401Response
from click_funnels_python_sdk.type.orders_applied_tag_create_applied_tag_request import OrdersAppliedTagCreateAppliedTagRequest

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.orders_applied_tag_create_applied_tag401_response import OrdersAppliedTagCreateAppliedTag401Response as OrdersAppliedTagCreateAppliedTag401ResponsePydantic
from click_funnels_python_sdk.pydantic.orders_applied_tag_attributes import OrdersAppliedTagAttributes as OrdersAppliedTagAttributesPydantic
from click_funnels_python_sdk.pydantic.orders_applied_tag_create_applied_tag_response import OrdersAppliedTagCreateAppliedTagResponse as OrdersAppliedTagCreateAppliedTagResponsePydantic
from click_funnels_python_sdk.pydantic.orders_applied_tag_create_applied_tag_request import OrdersAppliedTagCreateAppliedTagRequest as OrdersAppliedTagCreateAppliedTagRequestPydantic

from . import path

# Path params
OrderIdSchema = schemas.IntSchema
...
# body param
SchemaForRequestBodyApplicationJson = OrdersAppliedTagCreateAppliedTagRequestSchema


request_body_orders_applied_tag_create_applied_tag_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = OrdersAppliedTagAttributesSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: OrdersAppliedTagAttributes
...
SchemaFor400ResponseBodyApplicationJson = OrdersAppliedTagCreateAppliedTagResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: OrdersAppliedTagCreateAppliedTagResponse
...
SchemaFor401ResponseBodyApplicationJson = OrdersAppliedTagCreateAppliedTag401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: OrdersAppliedTagCreateAppliedTag401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_applied_tag_mapped_args(
        self,
        order_id: int,
        orders_applied_tag: typing.Optional[OrdersAppliedTagParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if orders_applied_tag is not None:
            _body["orders_applied_tag"] = orders_applied_tag
        args.body = _body
    ...
    async def _acreate_applied_tag_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orders/{order_id}/applied_tags',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_orders_applied_tag_create_applied_tag_request.serialize(body, content_type)
...
class CreateAppliedTag(BaseApi):
    ...
    async def acreate_applied_tag(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrdersAppliedTagAttributesPydantic:
        ...
        if validate:
            return OrdersAppliedTagAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrdersAppliedTagAttributesPydantic, raw_response.body)
