...
from click_funnels_python_sdk.model.shipping_rate_list_for_zone401_response import ShippingRateListForZone401Response as ShippingRateListForZone401ResponseSchema
from click_funnels_python_sdk.model.shipping_rate_list_for_zone_response import ShippingRateListForZoneResponse as ShippingRateListForZoneResponseSchema
from click_funnels_python_sdk.model.shipping_rate_list_for_zone404_response import ShippingRateListForZone404Response as ShippingRateListForZone404ResponseSchema

from click_funnels_python_sdk.type.shipping_rate_list_for_zone404_response import ShippingRateListForZone404Response
from click_funnels_python_sdk.type.shipping_rate_list_for_zone_response import ShippingRateListForZoneResponse
from click_funnels_python_sdk.type.shipping_rate_list_for_zone401_response import ShippingRateListForZone401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_rate_list_for_zone404_response import ShippingRateListForZone404Response as ShippingRateListForZone404ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_rate_list_for_zone_response import ShippingRateListForZoneResponse as ShippingRateListForZoneResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_rate_list_for_zone401_response import ShippingRateListForZone401Response as ShippingRateListForZone401ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ShippingRateListForZoneResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ShippingRateListForZoneResponse
...
SchemaFor401ResponseBodyApplicationJson = ShippingRateListForZone401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingRateListForZone401Response
...
SchemaFor404ResponseBodyApplicationJson = ShippingRateListForZone404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingRateListForZone404Response
...
class BaseApi(api_client.Api):
    ...
    def _list_for_zone_mapped_args(
        self,
        zone_id: int,
    ...
    async def _alist_for_zone_oapg(
        self,
...
class ListForZoneRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_for_zone(
        self,
        zone_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_for_zone_mapped_args(
            zone_id=zone_id,
            after=after,
            sort_order=sort_order,
        )
        return await self._alist_for_zone_oapg(
    ...
    def list_for_zone(
        ...
        return self._list_for_zone_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListForZone(BaseApi):
    ...
    async def alist_for_zone(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShippingRateListForZoneResponsePydantic:
        raw_response = await self.raw.alist_for_zone(
            zone_id=zone_id,
            after=after,
            sort_order=sort_order,
            **kwargs,
        ...
        if validate:
            return RootModel[ShippingRateListForZoneResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ShippingRateListForZoneResponsePydantic, raw_response.body)
    ...
    def list_for_zone(
        ...
        raw_response = self.raw.list_for_zone(
            zone_id=zone_id,
            after=after,
            sort_order=sort_order,
        )
