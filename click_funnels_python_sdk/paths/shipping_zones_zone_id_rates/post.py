...
from click_funnels_python_sdk.model.shipping_rate_create_rate_for_zone_request import ShippingRateCreateRateForZoneRequest as ShippingRateCreateRateForZoneRequestSchema
from click_funnels_python_sdk.model.shipping_rate_create_rate_for_zone_response import ShippingRateCreateRateForZoneResponse as ShippingRateCreateRateForZoneResponseSchema
from click_funnels_python_sdk.model.shipping_rate_create_rate_for_zone401_response import ShippingRateCreateRateForZone401Response as ShippingRateCreateRateForZone401ResponseSchema
...
from click_funnels_python_sdk.type.shipping_rate_create_rate_for_zone_response import ShippingRateCreateRateForZoneResponse
from click_funnels_python_sdk.type.shipping_rate_create_rate_for_zone_request import ShippingRateCreateRateForZoneRequest
from click_funnels_python_sdk.type.shipping_rate_create_rate_for_zone401_response import ShippingRateCreateRateForZone401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_rate_create_rate_for_zone401_response import ShippingRateCreateRateForZone401Response as ShippingRateCreateRateForZone401ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_rate_create_rate_for_zone_request import ShippingRateCreateRateForZoneRequest as ShippingRateCreateRateForZoneRequestPydantic
...
from click_funnels_python_sdk.pydantic.shipping_rate_create_rate_for_zone_response import ShippingRateCreateRateForZoneResponse as ShippingRateCreateRateForZoneResponsePydantic

from . import path

# Path params
ZoneIdSchema = schemas.IntSchema
...
# body param
SchemaForRequestBodyApplicationJson = ShippingRateCreateRateForZoneRequestSchema


request_body_shipping_rate_create_rate_for_zone_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ShippingRateAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = ShippingRateCreateRateForZoneResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ShippingRateCreateRateForZoneResponse
...
SchemaFor401ResponseBodyApplicationJson = ShippingRateCreateRateForZone401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingRateCreateRateForZone401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_rate_for_zone_mapped_args(
        self,
        zone_id: int,
    ...
    async def _acreate_rate_for_zone_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/shipping/zones/{zone_id}/rates',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_shipping_rate_create_rate_for_zone_request.serialize(body, content_type)
    ...
    def _create_rate_for_zone_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateRateForZoneRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_rate_for_zone(
        self,
        zone_id: int,
        shipping_rate: typing.Optional[ShippingRateParameters] = None,
        **kwargs,
        ...
        args = self._create_rate_for_zone_mapped_args(
            zone_id=zone_id,
            shipping_rate=shipping_rate,
        )
        return await self._acreate_rate_for_zone_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_rate_for_zone(
        self,
        zone_id: int,
        shipping_rate: typing.Optional[ShippingRateParameters] = None,
    ) -> typing.Union[
        ...
        return self._create_rate_for_zone_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateRateForZone(BaseApi):
    ...
    async def acreate_rate_for_zone(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_rate_for_zone(
            zone_id=zone_id,
            shipping_rate=shipping_rate,
            **kwargs,
        )
    ...
    def create_rate_for_zone(
        ...
        raw_response = self.raw.create_rate_for_zone(
            zone_id=zone_id,
            shipping_rate=shipping_rate,
        )
        if validate:
