...
from click_funnels_python_sdk.model.webhooks_outgoing_event_get_for_workspace404_response import WebhooksOutgoingEventGetForWorkspace404Response as WebhooksOutgoingEventGetForWorkspace404ResponseSchema
from click_funnels_python_sdk.model.webhooks_outgoing_event_attributes import WebhooksOutgoingEventAttributes as WebhooksOutgoingEventAttributesSchema
from click_funnels_python_sdk.model.webhooks_outgoing_event_get_for_workspace_response import WebhooksOutgoingEventGetForWorkspaceResponse as WebhooksOutgoingEventGetForWorkspaceResponseSchema

from click_funnels_python_sdk.type.webhooks_outgoing_event_get_for_workspace_response import WebhooksOutgoingEventGetForWorkspaceResponse
from click_funnels_python_sdk.type.webhooks_outgoing_event_attributes import WebhooksOutgoingEventAttributes
from click_funnels_python_sdk.type.webhooks_outgoing_event_get_for_workspace404_response import WebhooksOutgoingEventGetForWorkspace404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.webhooks_outgoing_event_get_for_workspace404_response import WebhooksOutgoingEventGetForWorkspace404Response as WebhooksOutgoingEventGetForWorkspace404ResponsePydantic
from click_funnels_python_sdk.pydantic.webhooks_outgoing_event_get_for_workspace_response import WebhooksOutgoingEventGetForWorkspaceResponse as WebhooksOutgoingEventGetForWorkspaceResponsePydantic
from click_funnels_python_sdk.pydantic.webhooks_outgoing_event_attributes import WebhooksOutgoingEventAttributes as WebhooksOutgoingEventAttributesPydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhooksOutgoingEventAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksOutgoingEventAttributes
...
SchemaFor401ResponseBodyApplicationJson = WebhooksOutgoingEventGetForWorkspaceResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: WebhooksOutgoingEventGetForWorkspaceResponse
...
SchemaFor404ResponseBodyApplicationJson = WebhooksOutgoingEventGetForWorkspace404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: WebhooksOutgoingEventGetForWorkspace404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_for_workspace_mapped_args(
        self,
        id: str,
    ...
    async def _aget_for_workspace_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/webhooks/outgoing/events/{id}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetForWorkspaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_for_workspace(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_for_workspace_mapped_args(
            id=id,
        )
        return await self._aget_for_workspace_oapg(
    ...
    def get_for_workspace(
        ...
        return self._get_for_workspace_oapg(
            path_params=args.path,
        )

class GetForWorkspace(BaseApi):
    ...
    async def aget_for_workspace(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksOutgoingEventAttributesPydantic:
        raw_response = await self.raw.aget_for_workspace(
            id=id,
            **kwargs,
        )
        if validate:
            return WebhooksOutgoingEventAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksOutgoingEventAttributesPydantic, raw_response.body)
    ...
    def get_for_workspace(
        ...
        raw_response = self.raw.get_for_workspace(
            id=id,
        )
        if validate:
            return WebhooksOutgoingEventAttributesPydantic(**raw_response.body)
