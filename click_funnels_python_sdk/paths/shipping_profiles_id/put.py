...
from click_funnels_python_sdk.model.shipping_profile_update_for_workspace401_response import ShippingProfileUpdateForWorkspace401Response as ShippingProfileUpdateForWorkspace401ResponseSchema
from click_funnels_python_sdk.model.shipping_profile_attributes import ShippingProfileAttributes as ShippingProfileAttributesSchema
from click_funnels_python_sdk.model.shipping_profile_update_for_workspace_request import ShippingProfileUpdateForWorkspaceRequest as ShippingProfileUpdateForWorkspaceRequestSchema
from click_funnels_python_sdk.model.shipping_profile_update_for_workspace_response import ShippingProfileUpdateForWorkspaceResponse as ShippingProfileUpdateForWorkspaceResponseSchema
from click_funnels_python_sdk.model.shipping_profile_update_for_workspace404_response import ShippingProfileUpdateForWorkspace404Response as ShippingProfileUpdateForWorkspace404ResponseSchema

from click_funnels_python_sdk.type.shipping_profile_update_for_workspace401_response import ShippingProfileUpdateForWorkspace401Response
from click_funnels_python_sdk.type.shipping_profile_attributes import ShippingProfileAttributes
from click_funnels_python_sdk.type.shipping_profile_update_for_workspace404_response import ShippingProfileUpdateForWorkspace404Response
from click_funnels_python_sdk.type.shipping_profile_update_for_workspace_request import ShippingProfileUpdateForWorkspaceRequest
from click_funnels_python_sdk.type.shipping_profile_update_for_workspace_response import ShippingProfileUpdateForWorkspaceResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_profile_update_for_workspace_response import ShippingProfileUpdateForWorkspaceResponse as ShippingProfileUpdateForWorkspaceResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_profile_update_for_workspace_request import ShippingProfileUpdateForWorkspaceRequest as ShippingProfileUpdateForWorkspaceRequestPydantic
from click_funnels_python_sdk.pydantic.shipping_profile_update_for_workspace401_response import ShippingProfileUpdateForWorkspace401Response as ShippingProfileUpdateForWorkspace401ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_profile_update_for_workspace404_response import ShippingProfileUpdateForWorkspace404Response as ShippingProfileUpdateForWorkspace404ResponsePydantic
from click_funnels_python_sdk.pydantic.shipping_profile_attributes import ShippingProfileAttributes as ShippingProfileAttributesPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ShippingProfileUpdateForWorkspaceRequestSchema


request_body_shipping_profile_update_for_workspace_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ShippingProfileAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ShippingProfileAttributes
...
SchemaFor400ResponseBodyApplicationJson = ShippingProfileUpdateForWorkspaceResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ShippingProfileUpdateForWorkspaceResponse
...
SchemaFor401ResponseBodyApplicationJson = ShippingProfileUpdateForWorkspace401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingProfileUpdateForWorkspace401Response
...
SchemaFor404ResponseBodyApplicationJson = ShippingProfileUpdateForWorkspace404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingProfileUpdateForWorkspace404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_for_workspace_mapped_args(
        self,
        id: str,
        shipping_profile: typing.Optional[ShippingProfileParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if shipping_profile is not None:
            _body["shipping_profile"] = shipping_profile
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_for_workspace_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/shipping/profiles/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_shipping_profile_update_for_workspace_request.serialize(body, content_type)
...
class UpdateForWorkspace(BaseApi):
    ...
    async def aupdate_for_workspace(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ShippingProfileAttributesPydantic:
        ...
        if validate:
            return ShippingProfileAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ShippingProfileAttributesPydantic, raw_response.body)
