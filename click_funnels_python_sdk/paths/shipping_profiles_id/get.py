...
from click_funnels_python_sdk.model.shipping_profile_get_workspace_profile404_response import ShippingProfileGetWorkspaceProfile404Response as ShippingProfileGetWorkspaceProfile404ResponseSchema
from click_funnels_python_sdk.model.shipping_profile_get_workspace_profile_response import ShippingProfileGetWorkspaceProfileResponse as ShippingProfileGetWorkspaceProfileResponseSchema

from click_funnels_python_sdk.type.shipping_profile_get_workspace_profile404_response import ShippingProfileGetWorkspaceProfile404Response
from click_funnels_python_sdk.type.shipping_profile_get_workspace_profile_response import ShippingProfileGetWorkspaceProfileResponse
from click_funnels_python_sdk.type.shipping_profile_attributes import ShippingProfileAttributes

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.shipping_profile_get_workspace_profile_response import ShippingProfileGetWorkspaceProfileResponse as ShippingProfileGetWorkspaceProfileResponsePydantic
...
from click_funnels_python_sdk.pydantic.shipping_profile_get_workspace_profile404_response import ShippingProfileGetWorkspaceProfile404Response as ShippingProfileGetWorkspaceProfile404ResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = ShippingProfileGetWorkspaceProfileResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ShippingProfileGetWorkspaceProfileResponse
...
SchemaFor404ResponseBodyApplicationJson = ShippingProfileGetWorkspaceProfile404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ShippingProfileGetWorkspaceProfile404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_workspace_profile_mapped_args(
        self,
        id: str,
    ...
    async def _aget_workspace_profile_oapg(
        self,
    ...
    def _get_workspace_profile_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetWorkspaceProfileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_workspace_profile(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_workspace_profile_mapped_args(
            id=id,
        )
        return await self._aget_workspace_profile_oapg(
    ...
    def get_workspace_profile(
        ...
        return self._get_workspace_profile_oapg(
            path_params=args.path,
        )

class GetWorkspaceProfile(BaseApi):
    ...
    async def aget_workspace_profile(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_workspace_profile(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_workspace_profile(
        ...
        raw_response = self.raw.get_workspace_profile(
            id=id,
        )
        if validate:
            return ShippingProfileAttributesPydantic(**raw_response.body)
