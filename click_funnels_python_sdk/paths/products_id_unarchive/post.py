...
class BaseApi(api_client.Api):
    ...
    def _unarchive_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aunarchive_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/{id}/unarchive',
            auth_settings=_auth,
            headers=_headers,
        )
...
class UnarchiveByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aunarchive_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._unarchive_by_id_mapped_args(
            id=id,
        )
        return await self._aunarchive_by_id_oapg(
    ...
    def unarchive_by_id(
        ...
        return self._unarchive_by_id_oapg(
            path_params=args.path,
        )

class UnarchiveById(BaseApi):
    ...
    async def aunarchive_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aunarchive_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def unarchive_by_id(
        ...
        raw_response = self.raw.unarchive_by_id(
            id=id,
        )
        if validate:
            return ProductAttributesPydantic(**raw_response.body)
