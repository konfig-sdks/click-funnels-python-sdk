...
from click_funnels_python_sdk.model.contacts_tag_create_new_tag_response import ContactsTagCreateNewTagResponse as ContactsTagCreateNewTagResponseSchema
from click_funnels_python_sdk.model.contacts_tag_attributes import ContactsTagAttributes as ContactsTagAttributesSchema
from click_funnels_python_sdk.model.contacts_tag_create_new_tag_request import ContactsTagCreateNewTagRequest as ContactsTagCreateNewTagRequestSchema
from click_funnels_python_sdk.model.contacts_tag_create_new_tag401_response import ContactsTagCreateNewTag401Response as ContactsTagCreateNewTag401ResponseSchema

from click_funnels_python_sdk.type.contacts_tag_create_new_tag_request import ContactsTagCreateNewTagRequest
from click_funnels_python_sdk.type.contacts_tag_create_new_tag401_response import ContactsTagCreateNewTag401Response
from click_funnels_python_sdk.type.contacts_tag_attributes import ContactsTagAttributes
from click_funnels_python_sdk.type.contacts_tag_create_new_tag_response import ContactsTagCreateNewTagResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.contacts_tag_create_new_tag_response import ContactsTagCreateNewTagResponse as ContactsTagCreateNewTagResponsePydantic
from click_funnels_python_sdk.pydantic.contacts_tag_create_new_tag401_response import ContactsTagCreateNewTag401Response as ContactsTagCreateNewTag401ResponsePydantic
from click_funnels_python_sdk.pydantic.contacts_tag_create_new_tag_request import ContactsTagCreateNewTagRequest as ContactsTagCreateNewTagRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ContactsTagCreateNewTagRequestSchema


request_body_contacts_tag_create_new_tag_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ContactsTagAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = ContactsTagCreateNewTagResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ContactsTagCreateNewTagResponse
...
SchemaFor401ResponseBodyApplicationJson = ContactsTagCreateNewTag401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ContactsTagCreateNewTag401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_new_tag_mapped_args(
        self,
        workspace_id: int,
    ...
    async def _acreate_new_tag_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/contacts/tags',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_contacts_tag_create_new_tag_request.serialize(body, content_type)
...
class CreateNewTagRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_tag(
        self,
        workspace_id: int,
        contacts_tag: typing.Optional[ContactsTagParameters] = None,
        **kwargs,
        ...
        args = self._create_new_tag_mapped_args(
            workspace_id=workspace_id,
            contacts_tag=contacts_tag,
        )
        return await self._acreate_new_tag_oapg(
            body=args.body,
    ...
    def create_new_tag(
        ...
        return self._create_new_tag_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewTag(BaseApi):
    ...
    async def acreate_new_tag(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_tag(
            workspace_id=workspace_id,
            contacts_tag=contacts_tag,
            **kwargs,
        )
    ...
    def create_new_tag(
        ...
        raw_response = self.raw.create_new_tag(
            workspace_id=workspace_id,
            contacts_tag=contacts_tag,
        )
        if validate:
