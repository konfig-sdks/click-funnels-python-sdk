...
from click_funnels_python_sdk.model.product_add_new_to_workspace_request import ProductAddNewToWorkspaceRequest as ProductAddNewToWorkspaceRequestSchema
from click_funnels_python_sdk.model.product_add_new_to_workspace401_response import ProductAddNewToWorkspace401Response as ProductAddNewToWorkspace401ResponseSchema
from click_funnels_python_sdk.model.product_attributes import ProductAttributes as ProductAttributesSchema
from click_funnels_python_sdk.model.product_add_new_to_workspace_response import ProductAddNewToWorkspaceResponse as ProductAddNewToWorkspaceResponseSchema

from click_funnels_python_sdk.type.product_add_new_to_workspace401_response import ProductAddNewToWorkspace401Response
from click_funnels_python_sdk.type.product_add_new_to_workspace_response import ProductAddNewToWorkspaceResponse
from click_funnels_python_sdk.type.product_attributes import ProductAttributes
from click_funnels_python_sdk.type.product_add_new_to_workspace_request import ProductAddNewToWorkspaceRequest

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.product_add_new_to_workspace_response import ProductAddNewToWorkspaceResponse as ProductAddNewToWorkspaceResponsePydantic
from click_funnels_python_sdk.pydantic.product_add_new_to_workspace_request import ProductAddNewToWorkspaceRequest as ProductAddNewToWorkspaceRequestPydantic
from click_funnels_python_sdk.pydantic.product_attributes import ProductAttributes as ProductAttributesPydantic
from click_funnels_python_sdk.pydantic.product_add_new_to_workspace401_response import ProductAddNewToWorkspace401Response as ProductAddNewToWorkspace401ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProductAddNewToWorkspaceRequestSchema


request_body_product_add_new_to_workspace_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ProductAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = ProductAddNewToWorkspaceResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ProductAddNewToWorkspaceResponse
...
SchemaFor401ResponseBodyApplicationJson = ProductAddNewToWorkspace401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductAddNewToWorkspace401Response
...
class BaseApi(api_client.Api):
    ...
    def _add_new_to_workspace_mapped_args(
        self,
        workspace_id: int,
    ...
    async def _aadd_new_to_workspace_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/products',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_product_add_new_to_workspace_request.serialize(body, content_type)
    ...
    def _add_new_to_workspace_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class AddNewToWorkspaceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_to_workspace(
        self,
        workspace_id: int,
        product: typing.Optional[ProductParameters] = None,
        **kwargs,
        ...
        args = self._add_new_to_workspace_mapped_args(
            workspace_id=workspace_id,
            product=product,
        )
        return await self._aadd_new_to_workspace_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def add_new_to_workspace(
        self,
        workspace_id: int,
        product: typing.Optional[ProductParameters] = None,
    ) -> typing.Union[
        ...
        return self._add_new_to_workspace_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddNewToWorkspace(BaseApi):
    ...
    async def aadd_new_to_workspace(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_new_to_workspace(
            workspace_id=workspace_id,
            product=product,
            **kwargs,
        )
    ...
    def add_new_to_workspace(
        ...
        raw_response = self.raw.add_new_to_workspace(
            workspace_id=workspace_id,
            product=product,
        )
        if validate:
