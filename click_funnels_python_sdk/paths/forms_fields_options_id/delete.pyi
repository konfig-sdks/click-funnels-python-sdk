...
from click_funnels_python_sdk.model.forms_fields_option_delete_option_for_field404_response import FormsFieldsOptionDeleteOptionForField404Response as FormsFieldsOptionDeleteOptionForField404ResponseSchema
from click_funnels_python_sdk.model.forms_fields_option_delete_option_for_field_response import FormsFieldsOptionDeleteOptionForFieldResponse as FormsFieldsOptionDeleteOptionForFieldResponseSchema

from click_funnels_python_sdk.type.forms_fields_option_delete_option_for_field404_response import FormsFieldsOptionDeleteOptionForField404Response
from click_funnels_python_sdk.type.forms_fields_option_delete_option_for_field_response import FormsFieldsOptionDeleteOptionForFieldResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_fields_option_delete_option_for_field_response import FormsFieldsOptionDeleteOptionForFieldResponse as FormsFieldsOptionDeleteOptionForFieldResponsePydantic
from click_funnels_python_sdk.pydantic.forms_fields_option_delete_option_for_field404_response import FormsFieldsOptionDeleteOptionForField404Response as FormsFieldsOptionDeleteOptionForField404ResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = FormsFieldsOptionDeleteOptionForFieldResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldsOptionDeleteOptionForFieldResponse
...
SchemaFor404ResponseBodyApplicationJson = FormsFieldsOptionDeleteOptionForField404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormsFieldsOptionDeleteOptionForField404Response
...
class BaseApi(api_client.Api):
    ...
    def _delete_option_for_field_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_option_for_field_oapg(
        self,
    ...
    def _delete_option_for_field_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteOptionForFieldRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_option_for_field(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_option_for_field_mapped_args(
            id=id,
        )
        return await self._adelete_option_for_field_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_option_for_field(
        self,
        id: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_option_for_field_oapg(
            path_params=args.path,
        )

class DeleteOptionForField(BaseApi):
    ...
    async def adelete_option_for_field(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_option_for_field(
            id=id,
            **kwargs,
        )
    ...
    def delete_option_for_field(
        ...
        raw_response = self.raw.delete_option_for_field(
            id=id,
        )
