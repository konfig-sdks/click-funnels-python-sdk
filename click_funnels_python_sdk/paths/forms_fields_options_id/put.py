...
from click_funnels_python_sdk.model.forms_fields_option_update_field_option404_response import FormsFieldsOptionUpdateFieldOption404Response as FormsFieldsOptionUpdateFieldOption404ResponseSchema
from click_funnels_python_sdk.model.forms_fields_option_update_field_option_response import FormsFieldsOptionUpdateFieldOptionResponse as FormsFieldsOptionUpdateFieldOptionResponseSchema
from click_funnels_python_sdk.model.forms_fields_option_attributes import FormsFieldsOptionAttributes as FormsFieldsOptionAttributesSchema
from click_funnels_python_sdk.model.forms_fields_option_update_field_option401_response import FormsFieldsOptionUpdateFieldOption401Response as FormsFieldsOptionUpdateFieldOption401ResponseSchema
from click_funnels_python_sdk.model.forms_fields_option_update_field_option_request import FormsFieldsOptionUpdateFieldOptionRequest as FormsFieldsOptionUpdateFieldOptionRequestSchema

from click_funnels_python_sdk.type.forms_fields_option_update_field_option_request import FormsFieldsOptionUpdateFieldOptionRequest
from click_funnels_python_sdk.type.forms_fields_option_update_field_option404_response import FormsFieldsOptionUpdateFieldOption404Response
from click_funnels_python_sdk.type.forms_fields_option_update_field_option401_response import FormsFieldsOptionUpdateFieldOption401Response
from click_funnels_python_sdk.type.forms_fields_option_attributes import FormsFieldsOptionAttributes
from click_funnels_python_sdk.type.forms_fields_option_update_field_option_response import FormsFieldsOptionUpdateFieldOptionResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_fields_option_attributes import FormsFieldsOptionAttributes as FormsFieldsOptionAttributesPydantic
from click_funnels_python_sdk.pydantic.forms_fields_option_update_field_option_response import FormsFieldsOptionUpdateFieldOptionResponse as FormsFieldsOptionUpdateFieldOptionResponsePydantic
from click_funnels_python_sdk.pydantic.forms_fields_option_update_field_option404_response import FormsFieldsOptionUpdateFieldOption404Response as FormsFieldsOptionUpdateFieldOption404ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_fields_option_update_field_option401_response import FormsFieldsOptionUpdateFieldOption401Response as FormsFieldsOptionUpdateFieldOption401ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_fields_option_update_field_option_request import FormsFieldsOptionUpdateFieldOptionRequest as FormsFieldsOptionUpdateFieldOptionRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FormsFieldsOptionUpdateFieldOptionRequestSchema


request_body_forms_fields_option_update_field_option_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FormsFieldsOptionAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FormsFieldsOptionAttributes
...
SchemaFor400ResponseBodyApplicationJson = FormsFieldsOptionUpdateFieldOptionResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormsFieldsOptionUpdateFieldOptionResponse
...
SchemaFor401ResponseBodyApplicationJson = FormsFieldsOptionUpdateFieldOption401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldsOptionUpdateFieldOption401Response
...
SchemaFor404ResponseBodyApplicationJson = FormsFieldsOptionUpdateFieldOption404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormsFieldsOptionUpdateFieldOption404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_field_option_mapped_args(
        self,
        id: str,
        forms_fields_option: typing.Optional[FormsFieldsOptionParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if forms_fields_option is not None:
            _body["forms_fields_option"] = forms_fields_option
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_field_option_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/forms/fields/options/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_forms_fields_option_update_field_option_request.serialize(body, content_type)
...
class UpdateFieldOptionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_field_option(
        self,
        id: str,
        forms_fields_option: typing.Optional[FormsFieldsOptionParameters] = None,
        **kwargs,
        ...
        args = self._update_field_option_mapped_args(
            id=id,
            forms_fields_option=forms_fields_option,
        )
        return await self._aupdate_field_option_oapg(
            body=args.body,
...
class UpdateFieldOption(BaseApi):
    ...
    async def aupdate_field_option(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FormsFieldsOptionAttributesPydantic:
        raw_response = await self.raw.aupdate_field_option(
            id=id,
            forms_fields_option=forms_fields_option,
            **kwargs,
        )
        if validate:
            return FormsFieldsOptionAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(FormsFieldsOptionAttributesPydantic, raw_response.body)
    ...
    def update_field_option(
        ...
        raw_response = self.raw.update_field_option(
            id=id,
            forms_fields_option=forms_fields_option,
        )
        if validate:
