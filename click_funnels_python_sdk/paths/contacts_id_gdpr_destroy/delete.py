...
class BaseApi(api_client.Api):
    ...
    def _redact_personally_identifiable_mapped_args(
        self,
        id: str,
    ...
    async def _aredact_personally_identifiable_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/contacts/{id}/gdpr_destroy',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _redact_personally_identifiable_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RedactPersonallyIdentifiableRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aredact_personally_identifiable(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._redact_personally_identifiable_mapped_args(
            id=id,
        )
        return await self._aredact_personally_identifiable_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def redact_personally_identifiable(
        self,
        id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._redact_personally_identifiable_oapg(
            path_params=args.path,
        )

class RedactPersonallyIdentifiable(BaseApi):
    ...
    async def aredact_personally_identifiable(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aredact_personally_identifiable(
            id=id,
            **kwargs,
        )
    ...
    def redact_personally_identifiable(
        ...
        raw_response = self.raw.redact_personally_identifiable(
            id=id,
        )
