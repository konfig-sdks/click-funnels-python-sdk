...
from click_funnels_python_sdk.model.forms_field_list_fields_for_field_set404_response import FormsFieldListFieldsForFieldSet404Response as FormsFieldListFieldsForFieldSet404ResponseSchema
from click_funnels_python_sdk.model.forms_field_list_fields_for_field_set_response import FormsFieldListFieldsForFieldSetResponse as FormsFieldListFieldsForFieldSetResponseSchema
from click_funnels_python_sdk.model.forms_field_list_fields_for_field_set401_response import FormsFieldListFieldsForFieldSet401Response as FormsFieldListFieldsForFieldSet401ResponseSchema

from click_funnels_python_sdk.type.forms_field_list_fields_for_field_set404_response import FormsFieldListFieldsForFieldSet404Response
from click_funnels_python_sdk.type.forms_field_list_fields_for_field_set_response import FormsFieldListFieldsForFieldSetResponse
from click_funnels_python_sdk.type.forms_field_list_fields_for_field_set401_response import FormsFieldListFieldsForFieldSet401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_field_list_fields_for_field_set401_response import FormsFieldListFieldsForFieldSet401Response as FormsFieldListFieldsForFieldSet401ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_list_fields_for_field_set_response import FormsFieldListFieldsForFieldSetResponse as FormsFieldListFieldsForFieldSetResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_list_fields_for_field_set404_response import FormsFieldListFieldsForFieldSet404Response as FormsFieldListFieldsForFieldSet404ResponsePydantic
...
# Path params
FieldSetIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'field_set_id': typing.Union[FieldSetIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_field_set_id = api_client.PathParameter(
    name="field_set_id",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FieldSetIdSchema,
    required=True,
)
_auth = [
    'BearerAuth',
]
PaginationNextSchema = schemas.StrSchema
pagination_next_parameter = api_client.HeaderParameter(
    name="Pagination-Next",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PaginationNextSchema,
)
...
SchemaFor200ResponseBodyApplicationJson = FormsFieldListFieldsForFieldSetResponseSchema
ResponseHeadersFor200 = typing_extensions.TypedDict(
    'ResponseHeadersFor200',
    {
        'Pagination-Next': PaginationNextSchema,
        'Link': LinkSchema,
    }
)
...
class ApiResponseFor200(api_client.ApiResponse):
    body: FormsFieldListFieldsForFieldSetResponse
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    headers=[
        pagination_next_parameter,
        link_parameter,
    ]
)
SchemaFor401ResponseBodyApplicationJson = FormsFieldListFieldsForFieldSet401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldListFieldsForFieldSet401Response
...
SchemaFor404ResponseBodyApplicationJson = FormsFieldListFieldsForFieldSet404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormsFieldListFieldsForFieldSet404Response
...
class BaseApi(api_client.Api):
    ...
    def _list_fields_for_field_set_mapped_args(
        self,
        field_set_id: int,
        ...
        if field_set_id is not None:
            _path_params["field_set_id"] = field_set_id
        args.query = _query_params
        args.path = _path_params
        return args

    async def _alist_fields_for_field_set_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/forms/field_sets/{field_set_id}/fields',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_fields_for_field_set_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListFieldsForFieldSetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_fields_for_field_set(
        self,
        field_set_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_fields_for_field_set_mapped_args(
            field_set_id=field_set_id,
            after=after,
            sort_order=sort_order,
        )
        return await self._alist_fields_for_field_set_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_fields_for_field_set(
        self,
        field_set_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        ...
        return self._list_fields_for_field_set_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListFieldsForFieldSet(BaseApi):
    ...
    async def alist_fields_for_field_set(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FormsFieldListFieldsForFieldSetResponsePydantic:
        raw_response = await self.raw.alist_fields_for_field_set(
            field_set_id=field_set_id,
            after=after,
            sort_order=sort_order,
            **kwargs,
        ...
        if validate:
            return RootModel[FormsFieldListFieldsForFieldSetResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FormsFieldListFieldsForFieldSetResponsePydantic, raw_response.body)
    ...
    def list_fields_for_field_set(
        ...
        raw_response = self.raw.list_fields_for_field_set(
            field_set_id=field_set_id,
            after=after,
            sort_order=sort_order,
        )
