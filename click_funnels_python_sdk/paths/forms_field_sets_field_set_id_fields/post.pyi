...
from click_funnels_python_sdk.model.forms_field_add_new_field_request import FormsFieldAddNewFieldRequest as FormsFieldAddNewFieldRequestSchema
from click_funnels_python_sdk.model.forms_field_attributes import FormsFieldAttributes as FormsFieldAttributesSchema
from click_funnels_python_sdk.model.forms_field_add_new_field401_response import FormsFieldAddNewField401Response as FormsFieldAddNewField401ResponseSchema
from click_funnels_python_sdk.model.forms_field_add_new_field_response import FormsFieldAddNewFieldResponse as FormsFieldAddNewFieldResponseSchema

from click_funnels_python_sdk.type.forms_field_add_new_field_request import FormsFieldAddNewFieldRequest
from click_funnels_python_sdk.type.forms_field_attributes import FormsFieldAttributes
from click_funnels_python_sdk.type.forms_field_add_new_field_response import FormsFieldAddNewFieldResponse
from click_funnels_python_sdk.type.forms_field_add_new_field401_response import FormsFieldAddNewField401Response
...
from click_funnels_python_sdk.pydantic.forms_field_add_new_field401_response import FormsFieldAddNewField401Response as FormsFieldAddNewField401ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_add_new_field_response import FormsFieldAddNewFieldResponse as FormsFieldAddNewFieldResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_add_new_field_request import FormsFieldAddNewFieldRequest as FormsFieldAddNewFieldRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FormsFieldAddNewFieldRequestSchema


request_body_forms_field_add_new_field_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FormsFieldAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = FormsFieldAddNewFieldResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormsFieldAddNewFieldResponse
...
SchemaFor401ResponseBodyApplicationJson = FormsFieldAddNewField401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldAddNewField401Response
...
class BaseApi(api_client.Api):
    ...
    def _add_new_field_mapped_args(
        self,
        field_set_id: int,
    ...
    async def _aadd_new_field_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_forms_field_add_new_field_request.serialize(body, content_type)
...
class AddNewFieldRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_field(
        self,
        field_set_id: int,
        forms_field: typing.Optional[FormsFieldParameters] = None,
        **kwargs,
        ...
        args = self._add_new_field_mapped_args(
            field_set_id=field_set_id,
            forms_field=forms_field,
        )
        return await self._aadd_new_field_oapg(
            body=args.body,
    ...
    def add_new_field(
        ...
        return self._add_new_field_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddNewField(BaseApi):
    ...
    async def aadd_new_field(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_new_field(
            field_set_id=field_set_id,
            forms_field=forms_field,
            **kwargs,
        )
    ...
    def add_new_field(
        ...
        raw_response = self.raw.add_new_field(
            field_set_id=field_set_id,
            forms_field=forms_field,
        )
        if validate:
