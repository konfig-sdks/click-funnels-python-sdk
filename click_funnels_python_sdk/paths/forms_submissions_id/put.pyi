...
from click_funnels_python_sdk.model.forms_submission_update_submission_response import FormsSubmissionUpdateSubmissionResponse as FormsSubmissionUpdateSubmissionResponseSchema
from click_funnels_python_sdk.model.forms_submission_update_submission404_response import FormsSubmissionUpdateSubmission404Response as FormsSubmissionUpdateSubmission404ResponseSchema
from click_funnels_python_sdk.model.forms_submission_attributes import FormsSubmissionAttributes as FormsSubmissionAttributesSchema
from click_funnels_python_sdk.model.forms_submission_update_submission_request import FormsSubmissionUpdateSubmissionRequest as FormsSubmissionUpdateSubmissionRequestSchema
from click_funnels_python_sdk.model.forms_submission_update_submission401_response import FormsSubmissionUpdateSubmission401Response as FormsSubmissionUpdateSubmission401ResponseSchema

from click_funnels_python_sdk.type.forms_submission_update_submission404_response import FormsSubmissionUpdateSubmission404Response
from click_funnels_python_sdk.type.forms_submission_update_submission_request import FormsSubmissionUpdateSubmissionRequest
from click_funnels_python_sdk.type.forms_submission_attributes import FormsSubmissionAttributes
from click_funnels_python_sdk.type.forms_submission_update_submission_response import FormsSubmissionUpdateSubmissionResponse
from click_funnels_python_sdk.type.forms_submission_update_submission401_response import FormsSubmissionUpdateSubmission401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_submission_update_submission404_response import FormsSubmissionUpdateSubmission404Response as FormsSubmissionUpdateSubmission404ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_submission_update_submission_request import FormsSubmissionUpdateSubmissionRequest as FormsSubmissionUpdateSubmissionRequestPydantic
from click_funnels_python_sdk.pydantic.forms_submission_update_submission401_response import FormsSubmissionUpdateSubmission401Response as FormsSubmissionUpdateSubmission401ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_submission_update_submission_response import FormsSubmissionUpdateSubmissionResponse as FormsSubmissionUpdateSubmissionResponsePydantic
from click_funnels_python_sdk.pydantic.forms_submission_attributes import FormsSubmissionAttributes as FormsSubmissionAttributesPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FormsSubmissionUpdateSubmissionRequestSchema


request_body_forms_submission_update_submission_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FormsSubmissionAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FormsSubmissionAttributes
...
SchemaFor400ResponseBodyApplicationJson = FormsSubmissionUpdateSubmissionResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormsSubmissionUpdateSubmissionResponse
...
SchemaFor401ResponseBodyApplicationJson = FormsSubmissionUpdateSubmission401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsSubmissionUpdateSubmission401Response
...
SchemaFor404ResponseBodyApplicationJson = FormsSubmissionUpdateSubmission404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormsSubmissionUpdateSubmission404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_submission_mapped_args(
        self,
        id: str,
        forms_submission: typing.Optional[FormsSubmissionParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if forms_submission is not None:
            _body["forms_submission"] = forms_submission
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_submission_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/forms/submissions/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_forms_submission_update_submission_request.serialize(body, content_type)
...
class UpdateSubmissionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_submission(
        self,
        id: str,
        forms_submission: typing.Optional[FormsSubmissionParameters] = None,
        **kwargs,
        ...
        args = self._update_submission_mapped_args(
            id=id,
            forms_submission=forms_submission,
        )
        return await self._aupdate_submission_oapg(
            body=args.body,
    ...
    def update_submission(
        ...
        return self._update_submission_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSubmission(BaseApi):
    ...
    async def aupdate_submission(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FormsSubmissionAttributesPydantic:
        raw_response = await self.raw.aupdate_submission(
            id=id,
            forms_submission=forms_submission,
            **kwargs,
        )
        if validate:
            return FormsSubmissionAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(FormsSubmissionAttributesPydantic, raw_response.body)
    ...
    def update_submission(
        ...
        raw_response = self.raw.update_submission(
            id=id,
            forms_submission=forms_submission,
        )
        if validate:
