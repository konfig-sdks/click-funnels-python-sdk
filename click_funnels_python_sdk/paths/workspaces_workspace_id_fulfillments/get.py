...
from click_funnels_python_sdk.model.fulfillment_list401_response import FulfillmentList401Response as FulfillmentList401ResponseSchema
from click_funnels_python_sdk.model.fulfillment_list_response import FulfillmentListResponse as FulfillmentListResponseSchema
from click_funnels_python_sdk.model.fulfillment_list404_response import FulfillmentList404Response as FulfillmentList404ResponseSchema

from click_funnels_python_sdk.type.fulfillment_list401_response import FulfillmentList401Response
from click_funnels_python_sdk.type.fulfillment_list_response import FulfillmentListResponse
from click_funnels_python_sdk.type.fulfillment_list404_response import FulfillmentList404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.fulfillment_list_response import FulfillmentListResponse as FulfillmentListResponsePydantic
from click_funnels_python_sdk.pydantic.fulfillment_list404_response import FulfillmentList404Response as FulfillmentList404ResponsePydantic
from click_funnels_python_sdk.pydantic.fulfillment_list401_response import FulfillmentList401Response as FulfillmentList401ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = FulfillmentListResponseSchema
...
SchemaFor401ResponseBodyApplicationJson = FulfillmentList401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FulfillmentList401Response
...
SchemaFor404ResponseBodyApplicationJson = FulfillmentList404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FulfillmentList404Response
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FulfillmentListResponsePydantic:
        ...
        if validate:
            return RootModel[FulfillmentListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(FulfillmentListResponsePydantic, raw_response.body)
