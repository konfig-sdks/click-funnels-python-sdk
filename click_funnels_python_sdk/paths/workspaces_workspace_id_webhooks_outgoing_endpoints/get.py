...
from click_funnels_python_sdk.model.webhooks_outgoing_endpoint_list_endpoints401_response import WebhooksOutgoingEndpointListEndpoints401Response as WebhooksOutgoingEndpointListEndpoints401ResponseSchema
from click_funnels_python_sdk.model.webhooks_outgoing_endpoint_list_endpoints404_response import WebhooksOutgoingEndpointListEndpoints404Response as WebhooksOutgoingEndpointListEndpoints404ResponseSchema
from click_funnels_python_sdk.model.webhooks_outgoing_endpoint_list_endpoints_response import WebhooksOutgoingEndpointListEndpointsResponse as WebhooksOutgoingEndpointListEndpointsResponseSchema

from click_funnels_python_sdk.type.webhooks_outgoing_endpoint_list_endpoints_response import WebhooksOutgoingEndpointListEndpointsResponse
from click_funnels_python_sdk.type.webhooks_outgoing_endpoint_list_endpoints401_response import WebhooksOutgoingEndpointListEndpoints401Response
from click_funnels_python_sdk.type.webhooks_outgoing_endpoint_list_endpoints404_response import WebhooksOutgoingEndpointListEndpoints404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.webhooks_outgoing_endpoint_list_endpoints_response import WebhooksOutgoingEndpointListEndpointsResponse as WebhooksOutgoingEndpointListEndpointsResponsePydantic
from click_funnels_python_sdk.pydantic.webhooks_outgoing_endpoint_list_endpoints404_response import WebhooksOutgoingEndpointListEndpoints404Response as WebhooksOutgoingEndpointListEndpoints404ResponsePydantic
from click_funnels_python_sdk.pydantic.webhooks_outgoing_endpoint_list_endpoints401_response import WebhooksOutgoingEndpointListEndpoints401Response as WebhooksOutgoingEndpointListEndpoints401ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WebhooksOutgoingEndpointListEndpointsResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: WebhooksOutgoingEndpointListEndpointsResponse
...
SchemaFor401ResponseBodyApplicationJson = WebhooksOutgoingEndpointListEndpoints401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: WebhooksOutgoingEndpointListEndpoints401Response
...
SchemaFor404ResponseBodyApplicationJson = WebhooksOutgoingEndpointListEndpoints404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: WebhooksOutgoingEndpointListEndpoints404Response
...
class BaseApi(api_client.Api):
    ...
    def _list_endpoints_mapped_args(
        self,
        workspace_id: int,
    ...
    async def _alist_endpoints_oapg(
        self,
...
class ListEndpointsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_endpoints(
        self,
        workspace_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_endpoints_mapped_args(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
        )
        return await self._alist_endpoints_oapg(
    ...
    def list_endpoints(
        ...
        return self._list_endpoints_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListEndpoints(BaseApi):
    ...
    async def alist_endpoints(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksOutgoingEndpointListEndpointsResponsePydantic:
        raw_response = await self.raw.alist_endpoints(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
            **kwargs,
        ...
        if validate:
            return RootModel[WebhooksOutgoingEndpointListEndpointsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(WebhooksOutgoingEndpointListEndpointsResponsePydantic, raw_response.body)
    ...
    def list_endpoints(
        ...
        raw_response = self.raw.list_endpoints(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
        )
