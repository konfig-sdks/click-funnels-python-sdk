...
from click_funnels_python_sdk.model.contact_upsert_request_contact import ContactUpsertRequestContact as ContactUpsertRequestContactSchema
from click_funnels_python_sdk.model.contact_upsert_response import ContactUpsertResponse as ContactUpsertResponseSchema
from click_funnels_python_sdk.model.contact_upsert201_response import ContactUpsert201Response as ContactUpsert201ResponseSchema
from click_funnels_python_sdk.model.contact_upsert_request import ContactUpsertRequest as ContactUpsertRequestSchema

from click_funnels_python_sdk.type.contact_upsert201_response import ContactUpsert201Response
from click_funnels_python_sdk.type.contact_upsert_response import ContactUpsertResponse
from click_funnels_python_sdk.type.contact_upsert_request import ContactUpsertRequest
from click_funnels_python_sdk.type.contact_upsert_request_contact import ContactUpsertRequestContact

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.contact_upsert_response import ContactUpsertResponse as ContactUpsertResponsePydantic
from click_funnels_python_sdk.pydantic.contact_upsert_request_contact import ContactUpsertRequestContact as ContactUpsertRequestContactPydantic
from click_funnels_python_sdk.pydantic.contact_upsert201_response import ContactUpsert201Response as ContactUpsert201ResponsePydantic
from click_funnels_python_sdk.pydantic.contact_upsert_request import ContactUpsertRequest as ContactUpsertRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ContactUpsertRequestSchema


request_body_contact_upsert_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ContactUpsertResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ContactUpsertResponse
...
SchemaFor201ResponseBodyApplicationJson = ContactUpsert201ResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: ContactUpsert201Response
...
class BaseApi(api_client.Api):
    ...
    def _upsert_mapped_args(
        self,
        workspace_id: str,
        contact: typing.Optional[ContactUpsertRequestContact] = None,
    ...
    async def _aupsert_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/contacts/upsert',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_contact_upsert_request.serialize(body, content_type)
...
class UpsertRaw(BaseApi):
    ...
    async def aupsert(
        ...
        **kwargs,
        ...
        args = self._upsert_mapped_args(
            workspace_id=workspace_id,
            contact=contact,
        )
        return await self._aupsert_oapg(
            body=args.body,
    ...
    def upsert(
        ...
        return self._upsert_oapg(
            body=args.body,
            path_params=args.path,
        )

class Upsert(BaseApi):
    ...
    async def aupsert(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ContactUpsertResponsePydantic:
        raw_response = await self.raw.aupsert(
            workspace_id=workspace_id,
            contact=contact,
            **kwargs,
        )
        if validate:
            return RootModel[ContactUpsertResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ContactUpsertResponsePydantic, raw_response.body)
