...
from click_funnels_python_sdk.model.forms_field_set_get_field_set_response import FormsFieldSetGetFieldSetResponse as FormsFieldSetGetFieldSetResponseSchema
from click_funnels_python_sdk.model.forms_field_set_get_field_set404_response import FormsFieldSetGetFieldSet404Response as FormsFieldSetGetFieldSet404ResponseSchema
...
from click_funnels_python_sdk.type.forms_field_set_get_field_set_response import FormsFieldSetGetFieldSetResponse
from click_funnels_python_sdk.type.forms_field_set_attributes import FormsFieldSetAttributes
from click_funnels_python_sdk.type.forms_field_set_get_field_set404_response import FormsFieldSetGetFieldSet404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_field_set_get_field_set_response import FormsFieldSetGetFieldSetResponse as FormsFieldSetGetFieldSetResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_set_get_field_set404_response import FormsFieldSetGetFieldSet404Response as FormsFieldSetGetFieldSet404ResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = FormsFieldSetGetFieldSetResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldSetGetFieldSetResponse
...
SchemaFor404ResponseBodyApplicationJson = FormsFieldSetGetFieldSet404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormsFieldSetGetFieldSet404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_field_set_mapped_args(
        self,
        id: str,
    ...
    async def _aget_field_set_oapg(
        self,
...
class GetFieldSetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_field_set(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_field_set_mapped_args(
            id=id,
        )
        return await self._aget_field_set_oapg(
    ...
    def get_field_set(
        ...
        return self._get_field_set_oapg(
            path_params=args.path,
        )

class GetFieldSet(BaseApi):
    ...
    async def aget_field_set(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_field_set(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_field_set(
        ...
        raw_response = self.raw.get_field_set(
            id=id,
        )
        if validate:
            return FormsFieldSetAttributesPydantic(**raw_response.body)
