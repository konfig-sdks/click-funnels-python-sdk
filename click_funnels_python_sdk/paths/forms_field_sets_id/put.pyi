...
from click_funnels_python_sdk.model.forms_field_set_update_field_set_by_id401_response import FormsFieldSetUpdateFieldSetById401Response as FormsFieldSetUpdateFieldSetById401ResponseSchema
from click_funnels_python_sdk.model.forms_field_set_update_field_set_by_id_response import FormsFieldSetUpdateFieldSetByIdResponse as FormsFieldSetUpdateFieldSetByIdResponseSchema
from click_funnels_python_sdk.model.forms_field_set_attributes import FormsFieldSetAttributes as FormsFieldSetAttributesSchema
from click_funnels_python_sdk.model.forms_field_set_update_field_set_by_id404_response import FormsFieldSetUpdateFieldSetById404Response as FormsFieldSetUpdateFieldSetById404ResponseSchema
from click_funnels_python_sdk.model.forms_field_set_update_field_set_by_id_request import FormsFieldSetUpdateFieldSetByIdRequest as FormsFieldSetUpdateFieldSetByIdRequestSchema

from click_funnels_python_sdk.type.forms_field_set_update_field_set_by_id404_response import FormsFieldSetUpdateFieldSetById404Response
from click_funnels_python_sdk.type.forms_field_set_attributes import FormsFieldSetAttributes
from click_funnels_python_sdk.type.forms_field_set_update_field_set_by_id_request import FormsFieldSetUpdateFieldSetByIdRequest
from click_funnels_python_sdk.type.forms_field_set_update_field_set_by_id401_response import FormsFieldSetUpdateFieldSetById401Response
from click_funnels_python_sdk.type.forms_field_set_update_field_set_by_id_response import FormsFieldSetUpdateFieldSetByIdResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_field_set_update_field_set_by_id401_response import FormsFieldSetUpdateFieldSetById401Response as FormsFieldSetUpdateFieldSetById401ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_set_update_field_set_by_id_request import FormsFieldSetUpdateFieldSetByIdRequest as FormsFieldSetUpdateFieldSetByIdRequestPydantic
from click_funnels_python_sdk.pydantic.forms_field_set_update_field_set_by_id_response import FormsFieldSetUpdateFieldSetByIdResponse as FormsFieldSetUpdateFieldSetByIdResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_set_update_field_set_by_id404_response import FormsFieldSetUpdateFieldSetById404Response as FormsFieldSetUpdateFieldSetById404ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_set_attributes import FormsFieldSetAttributes as FormsFieldSetAttributesPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FormsFieldSetUpdateFieldSetByIdRequestSchema


request_body_forms_field_set_update_field_set_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FormsFieldSetAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FormsFieldSetAttributes
...
SchemaFor400ResponseBodyApplicationJson = FormsFieldSetUpdateFieldSetByIdResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormsFieldSetUpdateFieldSetByIdResponse
...
SchemaFor401ResponseBodyApplicationJson = FormsFieldSetUpdateFieldSetById401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldSetUpdateFieldSetById401Response
...
SchemaFor404ResponseBodyApplicationJson = FormsFieldSetUpdateFieldSetById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormsFieldSetUpdateFieldSetById404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_field_set_by_id_mapped_args(
        self,
        id: str,
        forms_field_set: typing.Optional[FormsFieldSetParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if forms_field_set is not None:
            _body["forms_field_set"] = forms_field_set
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_field_set_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/forms/field_sets/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_forms_field_set_update_field_set_by_id_request.serialize(body, content_type)
    ...
    def _update_field_set_by_id_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateFieldSetByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_field_set_by_id(
        self,
        id: str,
        forms_field_set: typing.Optional[FormsFieldSetParameters] = None,
        **kwargs,
        ...
        args = self._update_field_set_by_id_mapped_args(
            id=id,
            forms_field_set=forms_field_set,
        )
        return await self._aupdate_field_set_by_id_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_field_set_by_id(
        self,
        id: str,
        forms_field_set: typing.Optional[FormsFieldSetParameters] = None,
    ) -> typing.Union[
        ...
        return self._update_field_set_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFieldSetById(BaseApi):
    ...
    async def aupdate_field_set_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FormsFieldSetAttributesPydantic:
        raw_response = await self.raw.aupdate_field_set_by_id(
            id=id,
            forms_field_set=forms_field_set,
            **kwargs,
        )
        if validate:
            return FormsFieldSetAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(FormsFieldSetAttributesPydantic, raw_response.body)
    ...
    def update_field_set_by_id(
        ...
        raw_response = self.raw.update_field_set_by_id(
            id=id,
            forms_field_set=forms_field_set,
        )
        if validate:
