...
from click_funnels_python_sdk.model.products_tag_attributes import ProductsTagAttributes as ProductsTagAttributesSchema
from click_funnels_python_sdk.model.products_tag_update_tag_by_id_response import ProductsTagUpdateTagByIdResponse as ProductsTagUpdateTagByIdResponseSchema
from click_funnels_python_sdk.model.products_tag_update_tag_by_id_request import ProductsTagUpdateTagByIdRequest as ProductsTagUpdateTagByIdRequestSchema
from click_funnels_python_sdk.model.products_tag_update_tag_by_id404_response import ProductsTagUpdateTagById404Response as ProductsTagUpdateTagById404ResponseSchema
from click_funnels_python_sdk.model.products_tag_update_tag_by_id401_response import ProductsTagUpdateTagById401Response as ProductsTagUpdateTagById401ResponseSchema

from click_funnels_python_sdk.type.products_tag_update_tag_by_id_request import ProductsTagUpdateTagByIdRequest
from click_funnels_python_sdk.type.products_tag_attributes import ProductsTagAttributes
from click_funnels_python_sdk.type.products_tag_update_tag_by_id_response import ProductsTagUpdateTagByIdResponse
from click_funnels_python_sdk.type.products_tag_update_tag_by_id404_response import ProductsTagUpdateTagById404Response
from click_funnels_python_sdk.type.products_tag_update_tag_by_id401_response import ProductsTagUpdateTagById401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.products_tag_update_tag_by_id_request import ProductsTagUpdateTagByIdRequest as ProductsTagUpdateTagByIdRequestPydantic
from click_funnels_python_sdk.pydantic.products_tag_update_tag_by_id404_response import ProductsTagUpdateTagById404Response as ProductsTagUpdateTagById404ResponsePydantic
from click_funnels_python_sdk.pydantic.products_tag_update_tag_by_id401_response import ProductsTagUpdateTagById401Response as ProductsTagUpdateTagById401ResponsePydantic
from click_funnels_python_sdk.pydantic.products_tag_attributes import ProductsTagAttributes as ProductsTagAttributesPydantic
from click_funnels_python_sdk.pydantic.products_tag_update_tag_by_id_response import ProductsTagUpdateTagByIdResponse as ProductsTagUpdateTagByIdResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProductsTagUpdateTagByIdRequestSchema


request_body_products_tag_update_tag_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ProductsTagAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ProductsTagAttributes
...
SchemaFor400ResponseBodyApplicationJson = ProductsTagUpdateTagByIdResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ProductsTagUpdateTagByIdResponse
...
SchemaFor401ResponseBodyApplicationJson = ProductsTagUpdateTagById401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductsTagUpdateTagById401Response
...
SchemaFor404ResponseBodyApplicationJson = ProductsTagUpdateTagById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ProductsTagUpdateTagById404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_tag_by_id_mapped_args(
        self,
        id: str,
        products_tag: typing.Optional[ProductsTagParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if products_tag is not None:
            _body["products_tag"] = products_tag
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_tag_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/tags/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_products_tag_update_tag_by_id_request.serialize(body, content_type)
...
class UpdateTagByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_tag_by_id(
        self,
        id: str,
        products_tag: typing.Optional[ProductsTagParameters] = None,
        **kwargs,
        ...
        args = self._update_tag_by_id_mapped_args(
            id=id,
            products_tag=products_tag,
        )
        return await self._aupdate_tag_by_id_oapg(
            body=args.body,
    ...
    def update_tag_by_id(
        ...
        return self._update_tag_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateTagById(BaseApi):
    ...
    async def aupdate_tag_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProductsTagAttributesPydantic:
        raw_response = await self.raw.aupdate_tag_by_id(
            id=id,
            products_tag=products_tag,
            **kwargs,
        )
        if validate:
            return ProductsTagAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ProductsTagAttributesPydantic, raw_response.body)
    ...
    def update_tag_by_id(
        ...
        raw_response = self.raw.update_tag_by_id(
            id=id,
            products_tag=products_tag,
        )
        if validate:
