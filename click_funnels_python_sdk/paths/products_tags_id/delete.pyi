...
from click_funnels_python_sdk.model.products_tag_delete_tag_by_id404_response import ProductsTagDeleteTagById404Response as ProductsTagDeleteTagById404ResponseSchema
from click_funnels_python_sdk.model.products_tag_delete_tag_by_id_response import ProductsTagDeleteTagByIdResponse as ProductsTagDeleteTagByIdResponseSchema

from click_funnels_python_sdk.type.products_tag_delete_tag_by_id404_response import ProductsTagDeleteTagById404Response
from click_funnels_python_sdk.type.products_tag_delete_tag_by_id_response import ProductsTagDeleteTagByIdResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.products_tag_delete_tag_by_id404_response import ProductsTagDeleteTagById404Response as ProductsTagDeleteTagById404ResponsePydantic
from click_funnels_python_sdk.pydantic.products_tag_delete_tag_by_id_response import ProductsTagDeleteTagByIdResponse as ProductsTagDeleteTagByIdResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = ProductsTagDeleteTagByIdResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductsTagDeleteTagByIdResponse
...
SchemaFor404ResponseBodyApplicationJson = ProductsTagDeleteTagById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ProductsTagDeleteTagById404Response
...
class BaseApi(api_client.Api):
    ...
    def _delete_tag_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _adelete_tag_by_id_oapg(
        self,
...
class DeleteTagByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_tag_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_tag_by_id_mapped_args(
            id=id,
        )
        return await self._adelete_tag_by_id_oapg(
    ...
    def delete_tag_by_id(
        ...
        return self._delete_tag_by_id_oapg(
            path_params=args.path,
        )

class DeleteTagById(BaseApi):
    ...
    async def adelete_tag_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_tag_by_id(
            id=id,
            **kwargs,
        )
    ...
    def delete_tag_by_id(
        ...
        raw_response = self.raw.delete_tag_by_id(
            id=id,
        )
