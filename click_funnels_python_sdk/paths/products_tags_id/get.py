...
from click_funnels_python_sdk.model.products_tag_get_tag_by_id_response import ProductsTagGetTagByIdResponse as ProductsTagGetTagByIdResponseSchema
from click_funnels_python_sdk.model.products_tag_get_tag_by_id404_response import ProductsTagGetTagById404Response as ProductsTagGetTagById404ResponseSchema

from click_funnels_python_sdk.type.products_tag_attributes import ProductsTagAttributes
from click_funnels_python_sdk.type.products_tag_get_tag_by_id404_response import ProductsTagGetTagById404Response
from click_funnels_python_sdk.type.products_tag_get_tag_by_id_response import ProductsTagGetTagByIdResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.products_tag_get_tag_by_id_response import ProductsTagGetTagByIdResponse as ProductsTagGetTagByIdResponsePydantic
...
from click_funnels_python_sdk.pydantic.products_tag_get_tag_by_id404_response import ProductsTagGetTagById404Response as ProductsTagGetTagById404ResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = ProductsTagGetTagByIdResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductsTagGetTagByIdResponse
...
SchemaFor404ResponseBodyApplicationJson = ProductsTagGetTagById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ProductsTagGetTagById404Response
...
class BaseApi(api_client.Api):
    ...
    def _get_tag_by_id_mapped_args(
        self,
        id: str,
    ...
    async def _aget_tag_by_id_oapg(
        self,
...
class GetTagByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tag_by_id(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_tag_by_id_mapped_args(
            id=id,
        )
        return await self._aget_tag_by_id_oapg(
    ...
    def get_tag_by_id(
        ...
        return self._get_tag_by_id_oapg(
            path_params=args.path,
        )

class GetTagById(BaseApi):
    ...
    async def aget_tag_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_tag_by_id(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_tag_by_id(
        ...
        raw_response = self.raw.get_tag_by_id(
            id=id,
        )
        if validate:
            return ProductsTagAttributesPydantic(**raw_response.body)
