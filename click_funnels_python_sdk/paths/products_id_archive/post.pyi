...
class BaseApi(api_client.Api):
    ...
    def _archive_product_mapped_args(
        self,
        id: str,
    ...
    async def _aarchive_product_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/products/{id}/archive',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ArchiveProductRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aarchive_product(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._archive_product_mapped_args(
            id=id,
        )
        return await self._aarchive_product_oapg(
    ...
    def archive_product(
        ...
        return self._archive_product_oapg(
            path_params=args.path,
        )

class ArchiveProduct(BaseApi):
    ...
    async def aarchive_product(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aarchive_product(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def archive_product(
        ...
        raw_response = self.raw.archive_product(
            id=id,
        )
        if validate:
            return ProductAttributesPydantic(**raw_response.body)
