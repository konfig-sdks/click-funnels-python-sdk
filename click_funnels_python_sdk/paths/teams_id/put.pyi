...
from click_funnels_python_sdk.model.team_update_team_by_id404_response import TeamUpdateTeamById404Response as TeamUpdateTeamById404ResponseSchema
from click_funnels_python_sdk.model.team_update_team_by_id_response import TeamUpdateTeamByIdResponse as TeamUpdateTeamByIdResponseSchema
from click_funnels_python_sdk.model.team_update_team_by_id401_response import TeamUpdateTeamById401Response as TeamUpdateTeamById401ResponseSchema
from click_funnels_python_sdk.model.team_attributes import TeamAttributes as TeamAttributesSchema
from click_funnels_python_sdk.model.team_update_team_by_id_request import TeamUpdateTeamByIdRequest as TeamUpdateTeamByIdRequestSchema

from click_funnels_python_sdk.type.team_attributes import TeamAttributes
from click_funnels_python_sdk.type.team_update_team_by_id_request import TeamUpdateTeamByIdRequest
from click_funnels_python_sdk.type.team_update_team_by_id_response import TeamUpdateTeamByIdResponse
from click_funnels_python_sdk.type.team_update_team_by_id401_response import TeamUpdateTeamById401Response
from click_funnels_python_sdk.type.team_update_team_by_id404_response import TeamUpdateTeamById404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.team_update_team_by_id_request import TeamUpdateTeamByIdRequest as TeamUpdateTeamByIdRequestPydantic
from click_funnels_python_sdk.pydantic.team_update_team_by_id404_response import TeamUpdateTeamById404Response as TeamUpdateTeamById404ResponsePydantic
from click_funnels_python_sdk.pydantic.team_update_team_by_id401_response import TeamUpdateTeamById401Response as TeamUpdateTeamById401ResponsePydantic
from click_funnels_python_sdk.pydantic.team_attributes import TeamAttributes as TeamAttributesPydantic
from click_funnels_python_sdk.pydantic.team_update_team_by_id_response import TeamUpdateTeamByIdResponse as TeamUpdateTeamByIdResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = TeamUpdateTeamByIdRequestSchema


request_body_team_update_team_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TeamAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = TeamUpdateTeamByIdResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: TeamUpdateTeamByIdResponse
...
SchemaFor401ResponseBodyApplicationJson = TeamUpdateTeamById401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: TeamUpdateTeamById401Response
...
SchemaFor404ResponseBodyApplicationJson = TeamUpdateTeamById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: TeamUpdateTeamById404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_team_by_id_mapped_args(
        self,
        id: str,
        team: typing.Optional[TeamParameters] = None,
    ...
    async def _aupdate_team_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_team_update_team_by_id_request.serialize(body, content_type)
...
class UpdateTeamByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_team_by_id(
        self,
        id: str,
        team: typing.Optional[TeamParameters] = None,
        **kwargs,
        ...
        args = self._update_team_by_id_mapped_args(
            id=id,
            team=team,
        )
        return await self._aupdate_team_by_id_oapg(
            body=args.body,
    ...
    def update_team_by_id(
        ...
        return self._update_team_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateTeamById(BaseApi):
    ...
    async def aupdate_team_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TeamAttributesPydantic:
        raw_response = await self.raw.aupdate_team_by_id(
            id=id,
            team=team,
            **kwargs,
        )
        if validate:
            return TeamAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamAttributesPydantic, raw_response.body)
    ...
    def update_team_by_id(
        ...
        raw_response = self.raw.update_team_by_id(
            id=id,
            team=team,
        )
        if validate:
