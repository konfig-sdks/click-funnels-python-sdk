...
from click_funnels_python_sdk.model.products_price_list_for_variant404_response import ProductsPriceListForVariant404Response as ProductsPriceListForVariant404ResponseSchema
from click_funnels_python_sdk.model.products_price_list_for_variant_response import ProductsPriceListForVariantResponse as ProductsPriceListForVariantResponseSchema
from click_funnels_python_sdk.model.products_price_list_for_variant401_response import ProductsPriceListForVariant401Response as ProductsPriceListForVariant401ResponseSchema

from click_funnels_python_sdk.type.products_price_list_for_variant_response import ProductsPriceListForVariantResponse
from click_funnels_python_sdk.type.products_price_list_for_variant401_response import ProductsPriceListForVariant401Response
from click_funnels_python_sdk.type.products_price_list_for_variant404_response import ProductsPriceListForVariant404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.products_price_list_for_variant_response import ProductsPriceListForVariantResponse as ProductsPriceListForVariantResponsePydantic
from click_funnels_python_sdk.pydantic.products_price_list_for_variant404_response import ProductsPriceListForVariant404Response as ProductsPriceListForVariant404ResponsePydantic
from click_funnels_python_sdk.pydantic.products_price_list_for_variant401_response import ProductsPriceListForVariant401Response as ProductsPriceListForVariant401ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ProductsPriceListForVariantResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: ProductsPriceListForVariantResponse
...
SchemaFor401ResponseBodyApplicationJson = ProductsPriceListForVariant401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductsPriceListForVariant401Response
...
SchemaFor404ResponseBodyApplicationJson = ProductsPriceListForVariant404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: ProductsPriceListForVariant404Response
...
class BaseApi(api_client.Api):
    ...
    def _list_for_variant_mapped_args(
        self,
        product_id: int,
    ...
    async def _alist_for_variant_oapg(
        self,
...
class ListForVariantRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_for_variant(
        self,
        product_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_for_variant_mapped_args(
            product_id=product_id,
            after=after,
            sort_order=sort_order,
        )
        return await self._alist_for_variant_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_for_variant(
        self,
        product_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        ...
        return self._list_for_variant_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListForVariant(BaseApi):
    ...
    async def alist_for_variant(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ProductsPriceListForVariantResponsePydantic:
        raw_response = await self.raw.alist_for_variant(
            product_id=product_id,
            after=after,
            sort_order=sort_order,
            **kwargs,
        ...
        if validate:
            return RootModel[ProductsPriceListForVariantResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ProductsPriceListForVariantResponsePydantic, raw_response.body)
    ...
    def list_for_variant(
        ...
        raw_response = self.raw.list_for_variant(
            product_id=product_id,
            after=after,
            sort_order=sort_order,
        )
