...
from click_funnels_python_sdk.model.products_price_create_variant_price401_response import ProductsPriceCreateVariantPrice401Response as ProductsPriceCreateVariantPrice401ResponseSchema
from click_funnels_python_sdk.model.products_price_create_variant_price_request import ProductsPriceCreateVariantPriceRequest as ProductsPriceCreateVariantPriceRequestSchema
from click_funnels_python_sdk.model.products_price_create_variant_price_response import ProductsPriceCreateVariantPriceResponse as ProductsPriceCreateVariantPriceResponseSchema

from click_funnels_python_sdk.type.products_price_create_variant_price401_response import ProductsPriceCreateVariantPrice401Response
from click_funnels_python_sdk.type.products_price_create_variant_price_request import ProductsPriceCreateVariantPriceRequest
from click_funnels_python_sdk.type.products_price_attributes import ProductsPriceAttributes
from click_funnels_python_sdk.type.products_price_create_variant_price_response import ProductsPriceCreateVariantPriceResponse
...
from click_funnels_python_sdk.pydantic.products_price_create_variant_price_request import ProductsPriceCreateVariantPriceRequest as ProductsPriceCreateVariantPriceRequestPydantic
from click_funnels_python_sdk.pydantic.products_price_create_variant_price_response import ProductsPriceCreateVariantPriceResponse as ProductsPriceCreateVariantPriceResponsePydantic
from click_funnels_python_sdk.pydantic.products_price_create_variant_price401_response import ProductsPriceCreateVariantPrice401Response as ProductsPriceCreateVariantPrice401ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProductsPriceCreateVariantPriceRequestSchema


request_body_products_price_create_variant_price_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = ProductsPriceAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = ProductsPriceCreateVariantPriceResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: ProductsPriceCreateVariantPriceResponse
...
SchemaFor401ResponseBodyApplicationJson = ProductsPriceCreateVariantPrice401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: ProductsPriceCreateVariantPrice401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_variant_price_mapped_args(
        self,
        product_id: int,
    ...
    async def _acreate_variant_price_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_products_price_create_variant_price_request.serialize(body, content_type)
    ...
    def _create_variant_price_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateVariantPriceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_variant_price(
        self,
        product_id: int,
        products_price: typing.Optional[ProductsPriceParameters] = None,
        **kwargs,
        ...
        args = self._create_variant_price_mapped_args(
            product_id=product_id,
            products_price=products_price,
        )
        return await self._acreate_variant_price_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_variant_price(
        self,
        product_id: int,
        products_price: typing.Optional[ProductsPriceParameters] = None,
    ) -> typing.Union[
        ...
        return self._create_variant_price_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateVariantPrice(BaseApi):
    ...
    async def acreate_variant_price(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_variant_price(
            product_id=product_id,
            products_price=products_price,
            **kwargs,
        )
    ...
    def create_variant_price(
        ...
        raw_response = self.raw.create_variant_price(
            product_id=product_id,
            products_price=products_price,
        )
        if validate:
