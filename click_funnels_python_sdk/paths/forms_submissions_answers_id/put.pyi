...
from click_funnels_python_sdk.model.forms_submissions_answer_update_answer_response import FormsSubmissionsAnswerUpdateAnswerResponse as FormsSubmissionsAnswerUpdateAnswerResponseSchema
from click_funnels_python_sdk.model.forms_submissions_answer_update_answer404_response import FormsSubmissionsAnswerUpdateAnswer404Response as FormsSubmissionsAnswerUpdateAnswer404ResponseSchema
from click_funnels_python_sdk.model.forms_submissions_answer_attributes import FormsSubmissionsAnswerAttributes as FormsSubmissionsAnswerAttributesSchema
from click_funnels_python_sdk.model.forms_submissions_answer_update_answer401_response import FormsSubmissionsAnswerUpdateAnswer401Response as FormsSubmissionsAnswerUpdateAnswer401ResponseSchema
from click_funnels_python_sdk.model.forms_submissions_answer_update_answer_request import FormsSubmissionsAnswerUpdateAnswerRequest as FormsSubmissionsAnswerUpdateAnswerRequestSchema

from click_funnels_python_sdk.type.forms_submissions_answer_update_answer404_response import FormsSubmissionsAnswerUpdateAnswer404Response
from click_funnels_python_sdk.type.forms_submissions_answer_attributes import FormsSubmissionsAnswerAttributes
from click_funnels_python_sdk.type.forms_submissions_answer_update_answer_response import FormsSubmissionsAnswerUpdateAnswerResponse
from click_funnels_python_sdk.type.forms_submissions_answer_update_answer_request import FormsSubmissionsAnswerUpdateAnswerRequest
from click_funnels_python_sdk.type.forms_submissions_answer_update_answer401_response import FormsSubmissionsAnswerUpdateAnswer401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_submissions_answer_update_answer_response import FormsSubmissionsAnswerUpdateAnswerResponse as FormsSubmissionsAnswerUpdateAnswerResponsePydantic
from click_funnels_python_sdk.pydantic.forms_submissions_answer_update_answer_request import FormsSubmissionsAnswerUpdateAnswerRequest as FormsSubmissionsAnswerUpdateAnswerRequestPydantic
from click_funnels_python_sdk.pydantic.forms_submissions_answer_attributes import FormsSubmissionsAnswerAttributes as FormsSubmissionsAnswerAttributesPydantic
from click_funnels_python_sdk.pydantic.forms_submissions_answer_update_answer401_response import FormsSubmissionsAnswerUpdateAnswer401Response as FormsSubmissionsAnswerUpdateAnswer401ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_submissions_answer_update_answer404_response import FormsSubmissionsAnswerUpdateAnswer404Response as FormsSubmissionsAnswerUpdateAnswer404ResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FormsSubmissionsAnswerUpdateAnswerRequestSchema


request_body_forms_submissions_answer_update_answer_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FormsSubmissionsAnswerAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FormsSubmissionsAnswerAttributes
...
SchemaFor400ResponseBodyApplicationJson = FormsSubmissionsAnswerUpdateAnswerResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormsSubmissionsAnswerUpdateAnswerResponse
...
SchemaFor401ResponseBodyApplicationJson = FormsSubmissionsAnswerUpdateAnswer401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsSubmissionsAnswerUpdateAnswer401Response
...
SchemaFor404ResponseBodyApplicationJson = FormsSubmissionsAnswerUpdateAnswer404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormsSubmissionsAnswerUpdateAnswer404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_answer_mapped_args(
        self,
        id: str,
        forms_submissions_answer: typing.Optional[FormsSubmissionsAnswerParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if forms_submissions_answer is not None:
            _body["forms_submissions_answer"] = forms_submissions_answer
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_answer_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/forms/submissions/answers/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_forms_submissions_answer_update_answer_request.serialize(body, content_type)
...
class UpdateAnswerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_answer(
        self,
        id: str,
        forms_submissions_answer: typing.Optional[FormsSubmissionsAnswerParameters] = None,
        **kwargs,
        ...
        args = self._update_answer_mapped_args(
            id=id,
            forms_submissions_answer=forms_submissions_answer,
        )
        return await self._aupdate_answer_oapg(
            body=args.body,
    ...
    def update_answer(
        ...
        return self._update_answer_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateAnswer(BaseApi):
    ...
    async def aupdate_answer(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FormsSubmissionsAnswerAttributesPydantic:
        raw_response = await self.raw.aupdate_answer(
            id=id,
            forms_submissions_answer=forms_submissions_answer,
            **kwargs,
        )
        if validate:
            return FormsSubmissionsAnswerAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(FormsSubmissionsAnswerAttributesPydantic, raw_response.body)
    ...
    def update_answer(
        ...
        raw_response = self.raw.update_answer(
            id=id,
            forms_submissions_answer=forms_submissions_answer,
        )
        if validate:
