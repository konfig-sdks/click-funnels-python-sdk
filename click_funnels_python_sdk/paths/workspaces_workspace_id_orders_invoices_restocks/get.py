...
from click_funnels_python_sdk.model.orders_invoices_restock_list_restocks401_response import OrdersInvoicesRestockListRestocks401Response as OrdersInvoicesRestockListRestocks401ResponseSchema
from click_funnels_python_sdk.model.orders_invoices_restock_list_restocks_response import OrdersInvoicesRestockListRestocksResponse as OrdersInvoicesRestockListRestocksResponseSchema
from click_funnels_python_sdk.model.orders_invoices_restock_list_restocks404_response import OrdersInvoicesRestockListRestocks404Response as OrdersInvoicesRestockListRestocks404ResponseSchema

from click_funnels_python_sdk.type.orders_invoices_restock_list_restocks404_response import OrdersInvoicesRestockListRestocks404Response
from click_funnels_python_sdk.type.orders_invoices_restock_list_restocks401_response import OrdersInvoicesRestockListRestocks401Response
from click_funnels_python_sdk.type.orders_invoices_restock_list_restocks_response import OrdersInvoicesRestockListRestocksResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.orders_invoices_restock_list_restocks401_response import OrdersInvoicesRestockListRestocks401Response as OrdersInvoicesRestockListRestocks401ResponsePydantic
from click_funnels_python_sdk.pydantic.orders_invoices_restock_list_restocks404_response import OrdersInvoicesRestockListRestocks404Response as OrdersInvoicesRestockListRestocks404ResponsePydantic
from click_funnels_python_sdk.pydantic.orders_invoices_restock_list_restocks_response import OrdersInvoicesRestockListRestocksResponse as OrdersInvoicesRestockListRestocksResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OrdersInvoicesRestockListRestocksResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: OrdersInvoicesRestockListRestocksResponse
...
SchemaFor401ResponseBodyApplicationJson = OrdersInvoicesRestockListRestocks401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: OrdersInvoicesRestockListRestocks401Response
...
SchemaFor404ResponseBodyApplicationJson = OrdersInvoicesRestockListRestocks404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: OrdersInvoicesRestockListRestocks404Response
...
class BaseApi(api_client.Api):
    ...
    def _list_restocks_mapped_args(
        self,
        workspace_id: int,
    ...
    async def _alist_restocks_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/workspaces/{workspace_id}/orders/invoices/restocks',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListRestocksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_restocks(
        self,
        workspace_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_restocks_mapped_args(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
        )
        return await self._alist_restocks_oapg(
    ...
    def list_restocks(
        ...
        return self._list_restocks_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListRestocks(BaseApi):
    ...
    async def alist_restocks(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrdersInvoicesRestockListRestocksResponsePydantic:
        raw_response = await self.raw.alist_restocks(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
            **kwargs,
        ...
        if validate:
            return RootModel[OrdersInvoicesRestockListRestocksResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(OrdersInvoicesRestockListRestocksResponsePydantic, raw_response.body)
    ...
    def list_restocks(
        ...
        raw_response = self.raw.list_restocks(
            workspace_id=workspace_id,
            after=after,
            sort_order=sort_order,
        )
