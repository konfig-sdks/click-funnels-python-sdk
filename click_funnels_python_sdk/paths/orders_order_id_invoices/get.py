...
from click_funnels_python_sdk.model.orders_invoice_list_for_order_response import OrdersInvoiceListForOrderResponse as OrdersInvoiceListForOrderResponseSchema
from click_funnels_python_sdk.model.orders_invoice_list_for_order401_response import OrdersInvoiceListForOrder401Response as OrdersInvoiceListForOrder401ResponseSchema
from click_funnels_python_sdk.model.orders_invoice_list_for_order404_response import OrdersInvoiceListForOrder404Response as OrdersInvoiceListForOrder404ResponseSchema

from click_funnels_python_sdk.type.orders_invoice_list_for_order_response import OrdersInvoiceListForOrderResponse
from click_funnels_python_sdk.type.orders_invoice_list_for_order404_response import OrdersInvoiceListForOrder404Response
from click_funnels_python_sdk.type.orders_invoice_list_for_order401_response import OrdersInvoiceListForOrder401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.orders_invoice_list_for_order401_response import OrdersInvoiceListForOrder401Response as OrdersInvoiceListForOrder401ResponsePydantic
from click_funnels_python_sdk.pydantic.orders_invoice_list_for_order404_response import OrdersInvoiceListForOrder404Response as OrdersInvoiceListForOrder404ResponsePydantic
from click_funnels_python_sdk.pydantic.orders_invoice_list_for_order_response import OrdersInvoiceListForOrderResponse as OrdersInvoiceListForOrderResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OrdersInvoiceListForOrderResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: OrdersInvoiceListForOrderResponse
...
SchemaFor401ResponseBodyApplicationJson = OrdersInvoiceListForOrder401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: OrdersInvoiceListForOrder401Response
...
SchemaFor404ResponseBodyApplicationJson = OrdersInvoiceListForOrder404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: OrdersInvoiceListForOrder404Response
...
class BaseApi(api_client.Api):
    ...
    def _list_for_order_mapped_args(
        self,
        order_id: int,
    ...
    async def _alist_for_order_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/orders/{order_id}/invoices',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListForOrderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_for_order(
        self,
        order_id: int,
        after: typing.Optional[str] = None,
        sort_order: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_for_order_mapped_args(
            order_id=order_id,
            after=after,
            sort_order=sort_order,
        )
        return await self._alist_for_order_oapg(
    ...
    def list_for_order(
        ...
        return self._list_for_order_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListForOrder(BaseApi):
    ...
    async def alist_for_order(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OrdersInvoiceListForOrderResponsePydantic:
        raw_response = await self.raw.alist_for_order(
            order_id=order_id,
            after=after,
            sort_order=sort_order,
            **kwargs,
        ...
        if validate:
            return RootModel[OrdersInvoiceListForOrderResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(OrdersInvoiceListForOrderResponsePydantic, raw_response.body)
    ...
    def list_for_order(
        ...
        raw_response = self.raw.list_for_order(
            order_id=order_id,
            after=after,
            sort_order=sort_order,
        )
