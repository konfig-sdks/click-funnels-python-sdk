...
from click_funnels_python_sdk.model.courses_enrollment_list401_response import CoursesEnrollmentList401Response as CoursesEnrollmentList401ResponseSchema
from click_funnels_python_sdk.model.courses_enrollment_list404_response import CoursesEnrollmentList404Response as CoursesEnrollmentList404ResponseSchema
from click_funnels_python_sdk.model.courses_enrollment_list_response import CoursesEnrollmentListResponse as CoursesEnrollmentListResponseSchema

from click_funnels_python_sdk.type.courses_enrollment_list404_response import CoursesEnrollmentList404Response
from click_funnels_python_sdk.type.courses_enrollment_list401_response import CoursesEnrollmentList401Response
from click_funnels_python_sdk.type.courses_enrollment_list_response import CoursesEnrollmentListResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.courses_enrollment_list401_response import CoursesEnrollmentList401Response as CoursesEnrollmentList401ResponsePydantic
from click_funnels_python_sdk.pydantic.courses_enrollment_list_response import CoursesEnrollmentListResponse as CoursesEnrollmentListResponsePydantic
from click_funnels_python_sdk.pydantic.courses_enrollment_list404_response import CoursesEnrollmentList404Response as CoursesEnrollmentList404ResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CoursesEnrollmentListResponseSchema
...
class ApiResponseFor200(api_client.ApiResponse):
    body: CoursesEnrollmentListResponse
...
SchemaFor401ResponseBodyApplicationJson = CoursesEnrollmentList401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: CoursesEnrollmentList401Response
...
SchemaFor404ResponseBodyApplicationJson = CoursesEnrollmentList404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: CoursesEnrollmentList404Response
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CoursesEnrollmentListResponsePydantic:
        ...
        if validate:
            return RootModel[CoursesEnrollmentListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(CoursesEnrollmentListResponsePydantic, raw_response.body)
