...
from click_funnels_python_sdk.model.courses_enrollment_create_new_enrollment401_response import CoursesEnrollmentCreateNewEnrollment401Response as CoursesEnrollmentCreateNewEnrollment401ResponseSchema
from click_funnels_python_sdk.model.courses_enrollment_create_new_enrollment_request import CoursesEnrollmentCreateNewEnrollmentRequest as CoursesEnrollmentCreateNewEnrollmentRequestSchema
...
from click_funnels_python_sdk.model.courses_enrollment_create_new_enrollment_response import CoursesEnrollmentCreateNewEnrollmentResponse as CoursesEnrollmentCreateNewEnrollmentResponseSchema

from click_funnels_python_sdk.type.courses_enrollment_attributes import CoursesEnrollmentAttributes
from click_funnels_python_sdk.type.courses_enrollment_create_new_enrollment_response import CoursesEnrollmentCreateNewEnrollmentResponse
from click_funnels_python_sdk.type.courses_enrollment_create_new_enrollment_request import CoursesEnrollmentCreateNewEnrollmentRequest
from click_funnels_python_sdk.type.courses_enrollment_create_new_enrollment401_response import CoursesEnrollmentCreateNewEnrollment401Response
...
from click_funnels_python_sdk.pydantic.courses_enrollment_create_new_enrollment401_response import CoursesEnrollmentCreateNewEnrollment401Response as CoursesEnrollmentCreateNewEnrollment401ResponsePydantic
from click_funnels_python_sdk.pydantic.courses_enrollment_create_new_enrollment_request import CoursesEnrollmentCreateNewEnrollmentRequest as CoursesEnrollmentCreateNewEnrollmentRequestPydantic
from click_funnels_python_sdk.pydantic.courses_enrollment_create_new_enrollment_response import CoursesEnrollmentCreateNewEnrollmentResponse as CoursesEnrollmentCreateNewEnrollmentResponsePydantic

# Path params
CourseIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'course_id': typing.Union[CourseIdSchema, decimal.Decimal, int, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = CoursesEnrollmentCreateNewEnrollmentRequestSchema


request_body_courses_enrollment_create_new_enrollment_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CoursesEnrollmentAttributesSchema
...
SchemaFor400ResponseBodyApplicationJson = CoursesEnrollmentCreateNewEnrollmentResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: CoursesEnrollmentCreateNewEnrollmentResponse
...
SchemaFor401ResponseBodyApplicationJson = CoursesEnrollmentCreateNewEnrollment401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: CoursesEnrollmentCreateNewEnrollment401Response
...
class BaseApi(api_client.Api):
    ...
    def _create_new_enrollment_mapped_args(
        self,
        course_id: int,
    ...
    async def _acreate_new_enrollment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/courses/{course_id}/enrollments',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_courses_enrollment_create_new_enrollment_request.serialize(body, content_type)
    ...
    def _create_new_enrollment_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewEnrollmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_enrollment(
        self,
        course_id: int,
        courses_enrollment: typing.Optional[CoursesEnrollmentParameters] = None,
        **kwargs,
        ...
        args = self._create_new_enrollment_mapped_args(
            course_id=course_id,
            courses_enrollment=courses_enrollment,
        )
        return await self._acreate_new_enrollment_oapg(
            body=args.body,
    ...
    def create_new_enrollment(
        ...
        return self._create_new_enrollment_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewEnrollment(BaseApi):
    ...
    async def acreate_new_enrollment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_enrollment(
            course_id=course_id,
            courses_enrollment=courses_enrollment,
            **kwargs,
        )
    ...
    def create_new_enrollment(
        ...
        raw_response = self.raw.create_new_enrollment(
            course_id=course_id,
            courses_enrollment=courses_enrollment,
        )
        if validate:
