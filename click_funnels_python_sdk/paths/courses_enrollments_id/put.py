...
from click_funnels_python_sdk.model.courses_enrollment_update_specific_enrollment_response import CoursesEnrollmentUpdateSpecificEnrollmentResponse as CoursesEnrollmentUpdateSpecificEnrollmentResponseSchema
from click_funnels_python_sdk.model.courses_enrollment_update_specific_enrollment401_response import CoursesEnrollmentUpdateSpecificEnrollment401Response as CoursesEnrollmentUpdateSpecificEnrollment401ResponseSchema
from click_funnels_python_sdk.model.courses_enrollment_update_specific_enrollment_request import CoursesEnrollmentUpdateSpecificEnrollmentRequest as CoursesEnrollmentUpdateSpecificEnrollmentRequestSchema
from click_funnels_python_sdk.model.courses_enrollment_update_specific_enrollment404_response import CoursesEnrollmentUpdateSpecificEnrollment404Response as CoursesEnrollmentUpdateSpecificEnrollment404ResponseSchema
from click_funnels_python_sdk.model.courses_enrollment_attributes import CoursesEnrollmentAttributes as CoursesEnrollmentAttributesSchema

from click_funnels_python_sdk.type.courses_enrollment_attributes import CoursesEnrollmentAttributes
from click_funnels_python_sdk.type.courses_enrollment_update_specific_enrollment404_response import CoursesEnrollmentUpdateSpecificEnrollment404Response
from click_funnels_python_sdk.type.courses_enrollment_update_specific_enrollment_response import CoursesEnrollmentUpdateSpecificEnrollmentResponse
from click_funnels_python_sdk.type.courses_enrollment_update_specific_enrollment_request import CoursesEnrollmentUpdateSpecificEnrollmentRequest
from click_funnels_python_sdk.type.courses_enrollment_update_specific_enrollment401_response import CoursesEnrollmentUpdateSpecificEnrollment401Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.courses_enrollment_update_specific_enrollment404_response import CoursesEnrollmentUpdateSpecificEnrollment404Response as CoursesEnrollmentUpdateSpecificEnrollment404ResponsePydantic
from click_funnels_python_sdk.pydantic.courses_enrollment_attributes import CoursesEnrollmentAttributes as CoursesEnrollmentAttributesPydantic
from click_funnels_python_sdk.pydantic.courses_enrollment_update_specific_enrollment401_response import CoursesEnrollmentUpdateSpecificEnrollment401Response as CoursesEnrollmentUpdateSpecificEnrollment401ResponsePydantic
from click_funnels_python_sdk.pydantic.courses_enrollment_update_specific_enrollment_request import CoursesEnrollmentUpdateSpecificEnrollmentRequest as CoursesEnrollmentUpdateSpecificEnrollmentRequestPydantic
from click_funnels_python_sdk.pydantic.courses_enrollment_update_specific_enrollment_response import CoursesEnrollmentUpdateSpecificEnrollmentResponse as CoursesEnrollmentUpdateSpecificEnrollmentResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = CoursesEnrollmentUpdateSpecificEnrollmentRequestSchema


request_body_courses_enrollment_update_specific_enrollment_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CoursesEnrollmentAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CoursesEnrollmentAttributes
...
SchemaFor400ResponseBodyApplicationJson = CoursesEnrollmentUpdateSpecificEnrollmentResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: CoursesEnrollmentUpdateSpecificEnrollmentResponse
...
SchemaFor401ResponseBodyApplicationJson = CoursesEnrollmentUpdateSpecificEnrollment401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: CoursesEnrollmentUpdateSpecificEnrollment401Response
...
SchemaFor404ResponseBodyApplicationJson = CoursesEnrollmentUpdateSpecificEnrollment404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: CoursesEnrollmentUpdateSpecificEnrollment404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_specific_enrollment_mapped_args(
        self,
        id: str,
        courses_enrollment: typing.Optional[CoursesEnrollmentParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if courses_enrollment is not None:
            _body["courses_enrollment"] = courses_enrollment
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_specific_enrollment_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/courses/enrollments/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_courses_enrollment_update_specific_enrollment_request.serialize(body, content_type)
    ...
    def _update_specific_enrollment_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateSpecificEnrollmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_specific_enrollment(
        self,
        id: str,
        courses_enrollment: typing.Optional[CoursesEnrollmentParameters] = None,
        **kwargs,
        ...
        args = self._update_specific_enrollment_mapped_args(
            id=id,
            courses_enrollment=courses_enrollment,
        )
        return await self._aupdate_specific_enrollment_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_specific_enrollment(
        self,
        id: str,
        courses_enrollment: typing.Optional[CoursesEnrollmentParameters] = None,
    ) -> typing.Union[
        ...
        return self._update_specific_enrollment_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSpecificEnrollment(BaseApi):
    ...
    async def aupdate_specific_enrollment(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CoursesEnrollmentAttributesPydantic:
        raw_response = await self.raw.aupdate_specific_enrollment(
            id=id,
            courses_enrollment=courses_enrollment,
            **kwargs,
        )
        if validate:
            return CoursesEnrollmentAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(CoursesEnrollmentAttributesPydantic, raw_response.body)
    ...
    def update_specific_enrollment(
        ...
        raw_response = self.raw.update_specific_enrollment(
            id=id,
            courses_enrollment=courses_enrollment,
        )
        if validate:
