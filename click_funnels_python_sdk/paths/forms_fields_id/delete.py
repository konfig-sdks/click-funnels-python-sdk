...
from click_funnels_python_sdk.model.forms_field_remove_field_response import FormsFieldRemoveFieldResponse as FormsFieldRemoveFieldResponseSchema
from click_funnels_python_sdk.model.forms_field_remove_field404_response import FormsFieldRemoveField404Response as FormsFieldRemoveField404ResponseSchema

from click_funnels_python_sdk.type.forms_field_remove_field_response import FormsFieldRemoveFieldResponse
from click_funnels_python_sdk.type.forms_field_remove_field404_response import FormsFieldRemoveField404Response

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_field_remove_field404_response import FormsFieldRemoveField404Response as FormsFieldRemoveField404ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_remove_field_response import FormsFieldRemoveFieldResponse as FormsFieldRemoveFieldResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = FormsFieldRemoveFieldResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldRemoveFieldResponse
...
SchemaFor404ResponseBodyApplicationJson = FormsFieldRemoveField404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormsFieldRemoveField404Response
...
class RemoveFieldRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_field(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_field_mapped_args(
            id=id,
        )
        return await self._aremove_field_oapg(
    ...
    def remove_field(
        ...
        return self._remove_field_oapg(
            path_params=args.path,
        )

class RemoveField(BaseApi):
    ...
    async def aremove_field(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_field(
            id=id,
            **kwargs,
        )
    ...
    def remove_field(
        ...
        raw_response = self.raw.remove_field(
            id=id,
        )
