...
from click_funnels_python_sdk.model.forms_field_update_field_by_id401_response import FormsFieldUpdateFieldById401Response as FormsFieldUpdateFieldById401ResponseSchema
from click_funnels_python_sdk.model.forms_field_update_field_by_id_response import FormsFieldUpdateFieldByIdResponse as FormsFieldUpdateFieldByIdResponseSchema
from click_funnels_python_sdk.model.forms_field_attributes import FormsFieldAttributes as FormsFieldAttributesSchema
from click_funnels_python_sdk.model.forms_field_update_field_by_id404_response import FormsFieldUpdateFieldById404Response as FormsFieldUpdateFieldById404ResponseSchema
from click_funnels_python_sdk.model.forms_field_update_field_by_id_request import FormsFieldUpdateFieldByIdRequest as FormsFieldUpdateFieldByIdRequestSchema

from click_funnels_python_sdk.type.forms_field_update_field_by_id_request import FormsFieldUpdateFieldByIdRequest
from click_funnels_python_sdk.type.forms_field_update_field_by_id401_response import FormsFieldUpdateFieldById401Response
from click_funnels_python_sdk.type.forms_field_update_field_by_id404_response import FormsFieldUpdateFieldById404Response
from click_funnels_python_sdk.type.forms_field_attributes import FormsFieldAttributes
from click_funnels_python_sdk.type.forms_field_update_field_by_id_response import FormsFieldUpdateFieldByIdResponse

from ...api_client import Dictionary
from click_funnels_python_sdk.pydantic.forms_field_update_field_by_id404_response import FormsFieldUpdateFieldById404Response as FormsFieldUpdateFieldById404ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_update_field_by_id401_response import FormsFieldUpdateFieldById401Response as FormsFieldUpdateFieldById401ResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_attributes import FormsFieldAttributes as FormsFieldAttributesPydantic
from click_funnels_python_sdk.pydantic.forms_field_update_field_by_id_request import FormsFieldUpdateFieldByIdRequest as FormsFieldUpdateFieldByIdRequestPydantic
from click_funnels_python_sdk.pydantic.forms_field_update_field_by_id_response import FormsFieldUpdateFieldByIdResponse as FormsFieldUpdateFieldByIdResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = FormsFieldUpdateFieldByIdRequestSchema


request_body_forms_field_update_field_by_id_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = FormsFieldAttributesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FormsFieldAttributes
...
SchemaFor400ResponseBodyApplicationJson = FormsFieldUpdateFieldByIdResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: FormsFieldUpdateFieldByIdResponse
...
SchemaFor401ResponseBodyApplicationJson = FormsFieldUpdateFieldById401ResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldUpdateFieldById401Response
...
SchemaFor404ResponseBodyApplicationJson = FormsFieldUpdateFieldById404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormsFieldUpdateFieldById404Response
...
class BaseApi(api_client.Api):
    ...
    def _update_field_by_id_mapped_args(
        self,
        id: str,
        forms_field: typing.Optional[FormsFieldParameters] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _path_params = {}
        _body = {}
        if forms_field is not None:
            _body["forms_field"] = forms_field
        args.body = _body
        if id is not None:
            _path_params["id"] = id
    ...
    async def _aupdate_field_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/forms/fields/{id}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_forms_field_update_field_by_id_request.serialize(body, content_type)
...
class UpdateFieldByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_field_by_id(
        self,
        id: str,
        forms_field: typing.Optional[FormsFieldParameters] = None,
        **kwargs,
        ...
        args = self._update_field_by_id_mapped_args(
            id=id,
            forms_field=forms_field,
        )
        return await self._aupdate_field_by_id_oapg(
            body=args.body,
    ...
    def update_field_by_id(
        ...
        return self._update_field_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFieldById(BaseApi):
    ...
    async def aupdate_field_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FormsFieldAttributesPydantic:
        raw_response = await self.raw.aupdate_field_by_id(
            id=id,
            forms_field=forms_field,
            **kwargs,
        )
        if validate:
            return FormsFieldAttributesPydantic(**raw_response.body)
        return api_client.construct_model_instance(FormsFieldAttributesPydantic, raw_response.body)
    ...
    def update_field_by_id(
        ...
        raw_response = self.raw.update_field_by_id(
            id=id,
            forms_field=forms_field,
        )
        if validate:
