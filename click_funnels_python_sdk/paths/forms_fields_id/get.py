...
from click_funnels_python_sdk.model.forms_field_get_field404_response import FormsFieldGetField404Response as FormsFieldGetField404ResponseSchema
from click_funnels_python_sdk.model.forms_field_attributes import FormsFieldAttributes as FormsFieldAttributesSchema
from click_funnels_python_sdk.model.forms_field_get_field_response import FormsFieldGetFieldResponse as FormsFieldGetFieldResponseSchema

from click_funnels_python_sdk.type.forms_field_attributes import FormsFieldAttributes
from click_funnels_python_sdk.type.forms_field_get_field_response import FormsFieldGetFieldResponse
from click_funnels_python_sdk.type.forms_field_get_field404_response import FormsFieldGetField404Response
...
from click_funnels_python_sdk.pydantic.forms_field_get_field_response import FormsFieldGetFieldResponse as FormsFieldGetFieldResponsePydantic
from click_funnels_python_sdk.pydantic.forms_field_get_field404_response import FormsFieldGetField404Response as FormsFieldGetField404ResponsePydantic
...
SchemaFor401ResponseBodyApplicationJson = FormsFieldGetFieldResponseSchema


@dataclass
class ApiResponseFor401(api_client.ApiResponse):
    body: FormsFieldGetFieldResponse
...
SchemaFor404ResponseBodyApplicationJson = FormsFieldGetField404ResponseSchema


@dataclass
class ApiResponseFor404(api_client.ApiResponse):
    body: FormsFieldGetField404Response
...
class GetFieldRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_field(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_field_mapped_args(
            id=id,
        )
        return await self._aget_field_oapg(
    ...
    def get_field(
        ...
        return self._get_field_oapg(
            path_params=args.path,
        )

class GetField(BaseApi):
    ...
    async def aget_field(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_field(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_field(
        ...
        raw_response = self.raw.get_field(
            id=id,
        )
        if validate:
            return FormsFieldAttributesPydantic(**raw_response.body)
