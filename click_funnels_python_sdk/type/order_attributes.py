...
from click_funnels_python_sdk.type.contact_attributes import ContactAttributes
from click_funnels_python_sdk.type.order_contact_group_attributes import OrderContactGroupAttributes
from click_funnels_python_sdk.type.order_segment_attributes import OrderSegmentAttributes
from click_funnels_python_sdk.type.orders_line_item_attributes import OrdersLineItemAttributes
from click_funnels_python_sdk.type.workspace_attributes import WorkspaceAttributes

class RequiredOrderAttributes(TypedDict):
...
class OptionalOrderAttributes(TypedDict, total=False):
    # ClickFunnels Order public ID
    public_id: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Order Number
    order_number: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Total
    total_amount: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Origination Channel Type
    origination_channel_type: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # First Name
    shipping_address_first_name: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Last Name
    shipping_address_last_name: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Organization Name
    shipping_address_organization_name: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Phone Number
    shipping_address_phone_number: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Street One
    shipping_address_street_one: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Street Two
    shipping_address_street_two: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # City
    shipping_address_city: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # State
    shipping_address_region: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Country
    shipping_address_country: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Postal Code
    shipping_address_postal_code: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Street One
    billing_address_street_one: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Street Two
    billing_address_street_two: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # City
    billing_address_city: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # State
    billing_address_region: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Country
    billing_address_country: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Postal Code
    billing_address_postal_code: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Page ID
    page_id: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Notes
    notes: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # In Trial
    in_trial: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Billing Status
    billing_status: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Order Status
    service_status: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Order Type
    order_type: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Next Charge At
    next_charge_at: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Tax Amount
    tax_amount: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Trial End At
    trial_end_at: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Payment Method
    billing_payment_method_id: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Funnel Name
    funnel_name: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Tags
    tag_ids: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Discounts
    discount_ids: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Date Activated
    activated_at: typing.Union[bool, date, datetime, dict, float, int, list, str, None]
    ...
    # Phone Number
    phone_number: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Page Name
    page_name: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Origination Channel Name
    origination_channel_name: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Pages
    order_page: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

    # Contact Groups
    contact_groups: typing.List[OrderContactGroupAttributes]

    # Segments
    segments: typing.List[OrderSegmentAttributes]

    # Order Line Items
    line_items: typing.List[OrdersLineItemAttributes]
    ...
    previous_line_item: typing.Union[bool, date, datetime, dict, float, int, list, str, None]

class OrderAttributes(RequiredOrderAttributes, OptionalOrderAttributes):
    pass
