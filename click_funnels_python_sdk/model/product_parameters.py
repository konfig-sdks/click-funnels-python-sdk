...
class ProductParameters(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            current_path = schemas.AnyTypeSchema
            visible_in_store = schemas.AnyTypeSchema
            visible_in_customer_center = schemas.AnyTypeSchema
            seo_title = schemas.AnyTypeSchema
            seo_description = schemas.AnyTypeSchema
            seo_image_id = schemas.AnyTypeSchema
            commissionable = schemas.AnyTypeSchema
            image_ids = schemas.AnyTypeSchema
            variant_ids = schemas.AnyTypeSchema
            price_ids = schemas.AnyTypeSchema
            redirect_funnel_id = schemas.AnyTypeSchema
            cancellation_funnel_url = schemas.AnyTypeSchema
        
            @staticmethod
            def tag_ids() -> typing.Type['ProductParametersTagIds']:
                return ProductParametersTagIds
        
            @staticmethod
            def variant_properties() -> typing.Type['ProductParametersVariantProperties']:
                return ProductParametersVariantProperties
            __annotations__ = {
                "name": name,
                "current_path": current_path,
                "visible_in_store": visible_in_store,
                "visible_in_customer_center": visible_in_customer_center,
                "seo_title": seo_title,
                "seo_description": seo_description,
                "seo_image_id": seo_image_id,
                "commissionable": commissionable,
                "image_ids": image_ids,
                "variant_ids": variant_ids,
                "price_ids": price_ids,
                "redirect_funnel_id": redirect_funnel_id,
                "cancellation_funnel_url": cancellation_funnel_url,
                "tag_ids": tag_ids,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["current_path"]) -> MetaOapg.properties.current_path: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["visible_in_store"]) -> MetaOapg.properties.visible_in_store: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["visible_in_customer_center"]) -> MetaOapg.properties.visible_in_customer_center: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["seo_image_id"]) -> MetaOapg.properties.seo_image_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["commissionable"]) -> MetaOapg.properties.commissionable: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["image_ids"]) -> MetaOapg.properties.image_ids: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["variant_ids"]) -> MetaOapg.properties.variant_ids: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["price_ids"]) -> MetaOapg.properties.price_ids: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["redirect_funnel_id"]) -> MetaOapg.properties.redirect_funnel_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["cancellation_funnel_url"]) -> MetaOapg.properties.cancellation_funnel_url: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tag_ids"]) -> 'ProductParametersTagIds': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["variant_properties"]) -> 'ProductParametersVariantProperties': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "current_path", "visible_in_store", "visible_in_customer_center", "seo_title", "seo_description", "seo_image_id", "commissionable", "image_ids", "variant_ids", "price_ids", "redirect_funnel_id", "cancellation_funnel_url", "tag_ids", "variant_properties", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["current_path"]) -> typing.Union[MetaOapg.properties.current_path, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["visible_in_store"]) -> typing.Union[MetaOapg.properties.visible_in_store, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["visible_in_customer_center"]) -> typing.Union[MetaOapg.properties.visible_in_customer_center, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["seo_title"]) -> typing.Union[MetaOapg.properties.seo_title, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["seo_description"]) -> typing.Union[MetaOapg.properties.seo_description, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["seo_image_id"]) -> typing.Union[MetaOapg.properties.seo_image_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["commissionable"]) -> typing.Union[MetaOapg.properties.commissionable, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["image_ids"]) -> typing.Union[MetaOapg.properties.image_ids, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["variant_ids"]) -> typing.Union[MetaOapg.properties.variant_ids, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["price_ids"]) -> typing.Union[MetaOapg.properties.price_ids, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["redirect_funnel_id"]) -> typing.Union[MetaOapg.properties.redirect_funnel_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cancellation_funnel_url"]) -> typing.Union[MetaOapg.properties.cancellation_funnel_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tag_ids"]) -> typing.Union['ProductParametersTagIds', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["variant_properties"]) -> typing.Union['ProductParametersVariantProperties', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "current_path", "visible_in_store", "visible_in_customer_center", "seo_title", "seo_description", "seo_image_id", "commissionable", "image_ids", "variant_ids", "price_ids", "redirect_funnel_id", "cancellation_funnel_url", "tag_ids", "variant_properties", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        current_path: typing.Union[MetaOapg.properties.current_path, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        visible_in_store: typing.Union[MetaOapg.properties.visible_in_store, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        visible_in_customer_center: typing.Union[MetaOapg.properties.visible_in_customer_center, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        seo_title: typing.Union[MetaOapg.properties.seo_title, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        seo_description: typing.Union[MetaOapg.properties.seo_description, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        seo_image_id: typing.Union[MetaOapg.properties.seo_image_id, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        commissionable: typing.Union[MetaOapg.properties.commissionable, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        variant_ids: typing.Union[MetaOapg.properties.variant_ids, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        redirect_funnel_id: typing.Union[MetaOapg.properties.redirect_funnel_id, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        cancellation_funnel_url: typing.Union[MetaOapg.properties.cancellation_funnel_url, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        tag_ids: typing.Union['ProductParametersTagIds', schemas.Unset] = schemas.unset,
        variant_properties: typing.Union['ProductParametersVariantProperties', schemas.Unset] = schemas.unset,
