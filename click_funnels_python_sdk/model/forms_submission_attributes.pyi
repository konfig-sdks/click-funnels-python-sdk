...
class FormsSubmissionAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            form_id = schemas.IntSchema
            public_id = schemas.AnyTypeSchema
            contact_id = schemas.AnyTypeSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "form_id", "public_id", "contact_id", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "form_id", "public_id", "contact_id", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        form_id: typing.Union[MetaOapg.properties.form_id, decimal.Decimal, int, ],
        ...
        contact_id: typing.Union[MetaOapg.properties.contact_id, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
