...
class ContactsAppliedTagAttributes(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "contact_id", "tag_id", "public_id", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "contact_id", "tag_id", "public_id", "created_at", "updated_at", ], str]):
