...
class ShippingProfileAttributes(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "public_id", "variant_ids", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "public_id", "variant_ids", "created_at", "updated_at", ], str]):
