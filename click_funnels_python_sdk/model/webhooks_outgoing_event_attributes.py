...
class WebhooksOutgoingEventAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            subject_id = schemas.IntSchema
            public_id = schemas.AnyTypeSchema
            uuid = schemas.AnyTypeSchema
            event_type_id = schemas.AnyTypeSchema
            subject_type = schemas.AnyTypeSchema
            ...
            class data(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["example", "x-konfig-original-example", ], str]):
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["example", "x-konfig-original-example", ], str]):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["subject_type"]) -> MetaOapg.properties.subject_type: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "subject_id", "public_id", "uuid", "event_type_id", "subject_type", "data", "created_at", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subject_type"]) -> typing.Union[MetaOapg.properties.subject_type, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "subject_id", "public_id", "uuid", "event_type_id", "subject_type", "data", "created_at", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        subject_id: typing.Union[MetaOapg.properties.subject_id, decimal.Decimal, int, ],
        ...
        event_type_id: typing.Union[MetaOapg.properties.event_type_id, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        subject_type: typing.Union[MetaOapg.properties.subject_type, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
