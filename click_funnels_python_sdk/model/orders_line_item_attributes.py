...
class OrdersLineItemAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def original_product() -> typing.Type['OrdersLineItemAttributesOriginalProduct']:
                return OrdersLineItemAttributesOriginalProduct
        
            @staticmethod
            def products_price() -> typing.Type['OrdersLineItemAttributesProductsPrice']:
                return OrdersLineItemAttributesProductsPrice
            public_id = schemas.AnyTypeSchema
            quantity = schemas.AnyTypeSchema
            prorated = schemas.AnyTypeSchema
    ...
    original_product: 'OrdersLineItemAttributesOriginalProduct'
    products_price: 'OrdersLineItemAttributesProductsPrice'
    id: MetaOapg.properties.id
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["original_product"]) -> 'OrdersLineItemAttributesOriginalProduct': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["products_price"]) -> 'OrdersLineItemAttributesProductsPrice': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "order_id", "original_product", "products_price", "public_id", "quantity", "prorated", "created_at", "updated_at", "products_variant", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["original_product"]) -> 'OrdersLineItemAttributesOriginalProduct': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["products_price"]) -> 'OrdersLineItemAttributesProductsPrice': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "order_id", "original_product", "products_price", "public_id", "quantity", "prorated", "created_at", "updated_at", "products_variant", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        prorated: typing.Union[MetaOapg.properties.prorated, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
