...
class FormsFieldsOptionAttributes(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "field_id", "label", "public_id", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "field_id", "label", "public_id", "created_at", "updated_at", ], str]):
