...
class OrdersInvoiceAttributes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            due_amount = schemas.AnyTypeSchema
            total_amount = schemas.AnyTypeSchema
            subtotal_amount = schemas.AnyTypeSchema
            tax_amount = schemas.AnyTypeSchema
            shipping_amount = schemas.AnyTypeSchema
            ...
            class invoice_type(
                ...
                @schemas.classproperty
                def CANCELLATION(cls):
                    return cls("cancellation")
                ...
                @schemas.classproperty
                def ONE_TIME_SALE(cls):
                    return cls("one_time_sale")
            ...
            class line_items(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OrdersInvoicesLineItemAttributes']:
                        return OrdersInvoicesLineItemAttributes
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['OrdersInvoicesLineItemAttributes'], typing.List['OrdersInvoicesLineItemAttributes']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'line_items':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'OrdersInvoicesLineItemAttributes':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["due_amount"]) -> MetaOapg.properties.due_amount: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["invoice_type"]) -> MetaOapg.properties.invoice_type: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "order_id", "status", "public_id", "due_amount", "total_amount", "subtotal_amount", "tax_amount", "shipping_amount", "discount_amount", "currency", "issued_at", "due_at", "paid_at", "invoice_type", "created_at", "updated_at", "line_items", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["due_amount"]) -> typing.Union[MetaOapg.properties.due_amount, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["subtotal_amount"]) -> typing.Union[MetaOapg.properties.subtotal_amount, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["issued_at"]) -> typing.Union[MetaOapg.properties.issued_at, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["due_at"]) -> typing.Union[MetaOapg.properties.due_at, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["paid_at"]) -> typing.Union[MetaOapg.properties.paid_at, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["invoice_type"]) -> typing.Union[MetaOapg.properties.invoice_type, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "order_id", "status", "public_id", "due_amount", "total_amount", "subtotal_amount", "tax_amount", "shipping_amount", "discount_amount", "currency", "issued_at", "due_at", "paid_at", "invoice_type", "created_at", "updated_at", "line_items", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        due_amount: typing.Union[MetaOapg.properties.due_amount, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        subtotal_amount: typing.Union[MetaOapg.properties.subtotal_amount, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        shipping_amount: typing.Union[MetaOapg.properties.shipping_amount, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        issued_at: typing.Union[MetaOapg.properties.issued_at, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        due_at: typing.Union[MetaOapg.properties.due_at, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        paid_at: typing.Union[MetaOapg.properties.paid_at, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        invoice_type: typing.Union[MetaOapg.properties.invoice_type, str, schemas.Unset] = schemas.unset,
