...
class WebhooksOutgoingEndpointAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            event_type_ids = schemas.AnyTypeSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["event_type_ids"]) -> MetaOapg.properties.event_type_ids: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "url", "name", "public_id", "event_type_ids", "created_at", "updated_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["event_type_ids"]) -> typing.Union[MetaOapg.properties.event_type_ids, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "url", "name", "public_id", "event_type_ids", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        event_type_ids: typing.Union[MetaOapg.properties.event_type_ids, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
