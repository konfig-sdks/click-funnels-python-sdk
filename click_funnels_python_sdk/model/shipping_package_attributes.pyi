...
class ShippingPackageAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class package_type(
                ...
                @schemas.classproperty
                def SOFT_PACKAGE(cls):
                    return cls("soft_package")
            ...
            empty_weight = schemas.AnyTypeSchema
            ...
            class weight_unit(
                ...
                def OZ(cls):
                    return cls("oz")
            default_package = schemas.AnyTypeSchema
    ...
    distance_unit: MetaOapg.properties.distance_unit
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["distance_unit"]) -> MetaOapg.properties.distance_unit: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["empty_weight"]) -> MetaOapg.properties.empty_weight: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["default_package"]) -> MetaOapg.properties.default_package: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "package_type", "height", "width", "length", "distance_unit", "name", "public_id", "empty_weight", "weight", "weight_unit", "default_package", "token", "carrier", "created_at", "updated_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["distance_unit"]) -> MetaOapg.properties.distance_unit: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["empty_weight"]) -> typing.Union[MetaOapg.properties.empty_weight, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["weight"]) -> typing.Union[MetaOapg.properties.weight, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["weight_unit"]) -> typing.Union[MetaOapg.properties.weight_unit, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["default_package"]) -> typing.Union[MetaOapg.properties.default_package, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "package_type", "height", "width", "length", "distance_unit", "name", "public_id", "empty_weight", "weight", "weight_unit", "default_package", "token", "carrier", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        distance_unit: typing.Union[MetaOapg.properties.distance_unit, str, ],
        package_type: typing.Union[MetaOapg.properties.package_type, str, ],
        ...
        empty_weight: typing.Union[MetaOapg.properties.empty_weight, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        weight_unit: typing.Union[MetaOapg.properties.weight_unit, str, schemas.Unset] = schemas.unset,
        default_package: typing.Union[MetaOapg.properties.default_package, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
