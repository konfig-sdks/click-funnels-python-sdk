...
class WorkspaceAttributes(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "team_id", "name", "subdomain", "public_id", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "team_id", "name", "subdomain", "public_id", "created_at", "updated_at", ], str]):
