...
class CoursesLessonAttributes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            section_id = schemas.AnyTypeSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "id", "public_id", "body", "section_id", "published_at", "current_path", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "id", "public_id", "body", "section_id", "published_at", "current_path", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        section_id: typing.Union[MetaOapg.properties.section_id, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
