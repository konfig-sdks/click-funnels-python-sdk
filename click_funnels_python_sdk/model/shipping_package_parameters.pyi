...
class ShippingPackageParameters(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["package_type", "height", "width", "length", "distance_unit", "name", "empty_weight", "weight", "weight_unit", "default_package", "carrier", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["package_type", "height", "width", "length", "distance_unit", "name", "empty_weight", "weight", "weight_unit", "default_package", "carrier", ], str]):
