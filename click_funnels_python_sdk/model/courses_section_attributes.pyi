...
class CoursesSectionAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            blocker_lesson_id = schemas.StrSchema
            description = schemas.AnyTypeSchema
            public_id = schemas.AnyTypeSchema
            published_at = schemas.AnyTypeSchema
            days_till_drip_access = schemas.AnyTypeSchema
            blocker_section_id = schemas.AnyTypeSchema
            current_path = schemas.AnyTypeSchema
            is_hidden_from_non_members = schemas.AnyTypeSchema
            ...
            __annotations__ = {
                ...
                "id": id,
                "course_id": course_id,
                "blocker_lesson_id": blocker_lesson_id,
                "description": description,
                "public_id": public_id,
                "published_at": published_at,
                "days_till_drip_access": days_till_drip_access,
                "blocker_section_id": blocker_section_id,
    ...
    course_id: MetaOapg.properties.course_id
    blocker_lesson_id: MetaOapg.properties.blocker_lesson_id
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["blocker_lesson_id"]) -> MetaOapg.properties.blocker_lesson_id: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["days_till_drip_access"]) -> MetaOapg.properties.days_till_drip_access: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["blocker_section_id"]) -> MetaOapg.properties.blocker_section_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["current_path"]) -> MetaOapg.properties.current_path: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["is_hidden_from_non_members"]) -> MetaOapg.properties.is_hidden_from_non_members: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "id", "course_id", "blocker_lesson_id", "description", "public_id", "published_at", "days_till_drip_access", "blocker_section_id", "current_path", "is_hidden_from_non_members", "upgrade_url", "created_at", "updated_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["course_id"]) -> MetaOapg.properties.course_id: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["blocker_lesson_id"]) -> MetaOapg.properties.blocker_lesson_id: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["days_till_drip_access"]) -> typing.Union[MetaOapg.properties.days_till_drip_access, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["blocker_section_id"]) -> typing.Union[MetaOapg.properties.blocker_section_id, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["is_hidden_from_non_members"]) -> typing.Union[MetaOapg.properties.is_hidden_from_non_members, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "id", "course_id", "blocker_lesson_id", "description", "public_id", "published_at", "days_till_drip_access", "blocker_section_id", "current_path", "is_hidden_from_non_members", "upgrade_url", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        course_id: typing.Union[MetaOapg.properties.course_id, str, ],
        blocker_lesson_id: typing.Union[MetaOapg.properties.blocker_lesson_id, str, ],
        ...
        days_till_drip_access: typing.Union[MetaOapg.properties.days_till_drip_access, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        blocker_section_id: typing.Union[MetaOapg.properties.blocker_section_id, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        is_hidden_from_non_members: typing.Union[MetaOapg.properties.is_hidden_from_non_members, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
