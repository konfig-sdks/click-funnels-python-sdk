...
class OrdersInvoicesRestockGetRestockResponse(
    schemas.DictSchema
):
    """
            ...
            class included_invoices_line_items(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        included_invoices_line_items: schemas.AnyTypeSchema
                        ...
                        def __new__(
                            ...
                            *args: typing.Union[dict, frozendict.frozendict, ],
                            ...
                            included_invoices_line_items: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
                            updated_at: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "contact_id", "status", "created_at", "updated_at", "public_id", "included_invoices_line_items", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "contact_id", "status", "created_at", "updated_at", "public_id", "included_invoices_line_items", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        updated_at: typing.Union[MetaOapg.properties.updated_at, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
