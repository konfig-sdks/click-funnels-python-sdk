...
class ProductsPriceParameters(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "currency", "duration", "interval", "trial_interval", "trial_duration", "trial_amount", "interval_count", "name", "cost", "setup_amount", "self_cancel", "self_upgrade", "self_downgrade", "self_reactivate", "payment_type", "visible", "compare_at_amount", "key", "archived", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "currency", "duration", "interval", "trial_interval", "trial_duration", "trial_amount", "interval_count", "name", "cost", "setup_amount", "self_cancel", "self_upgrade", "self_downgrade", "self_reactivate", "payment_type", "visible", "compare_at_amount", "key", "archived", ], str]):
