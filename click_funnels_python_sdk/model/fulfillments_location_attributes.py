...
class FulfillmentsLocationAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            address_name = schemas.StrSchema
            email_address = schemas.StrSchema
        
            @staticmethod
            def address() -> typing.Type['FulfillmentsLocationAttributesAddress']:
                return FulfillmentsLocationAttributesAddress
            public_id = schemas.AnyTypeSchema
            phone_number = schemas.AnyTypeSchema
            sort_order = schemas.AnyTypeSchema
            external_app = schemas.AnyTypeSchema
    ...
    address: 'FulfillmentsLocationAttributesAddress'
    email_address: MetaOapg.properties.email_address
    name: MetaOapg.properties.name
    address_name: MetaOapg.properties.address_name
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address_name"]) -> MetaOapg.properties.address_name: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["email_address"]) -> MetaOapg.properties.email_address: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'FulfillmentsLocationAttributesAddress': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["external_app"]) -> MetaOapg.properties.external_app: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "name", "address_name", "email_address", "address", "public_id", "phone_number", "sort_order", "external_app", "created_at", "updated_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address_name"]) -> MetaOapg.properties.address_name: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["email_address"]) -> MetaOapg.properties.email_address: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> 'FulfillmentsLocationAttributesAddress': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["external_app"]) -> typing.Union[MetaOapg.properties.external_app, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "name", "address_name", "email_address", "address", "public_id", "phone_number", "sort_order", "external_app", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        address_name: typing.Union[MetaOapg.properties.address_name, str, ],
        ...
        sort_order: typing.Union[MetaOapg.properties.sort_order, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        external_app: typing.Union[MetaOapg.properties.external_app, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
