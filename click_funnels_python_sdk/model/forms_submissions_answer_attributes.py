...
class FormsSubmissionsAnswerAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            submission_id = schemas.IntSchema
            field_id = schemas.IntSchema
            public_id = schemas.AnyTypeSchema
            fields_option_id = schemas.AnyTypeSchema
            entry = schemas.AnyTypeSchema
            fields_option_ids = schemas.AnyTypeSchema
            ...
            __annotations__ = {
                ...
                "field_id": field_id,
                "public_id": public_id,
                "fields_option_id": fields_option_id,
                "entry": entry,
                "fields_option_ids": fields_option_ids,
                "created_at": created_at,
                "updated_at": updated_at,
            }
    
    field_id: MetaOapg.properties.field_id
    submission_id: MetaOapg.properties.submission_id
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fields_option_id"]) -> MetaOapg.properties.fields_option_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["entry"]) -> MetaOapg.properties.entry: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fields_option_ids"]) -> MetaOapg.properties.fields_option_ids: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "submission_id", "field_id", "public_id", "fields_option_id", "entry", "fields_option_ids", "created_at", "updated_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["submission_id"]) -> MetaOapg.properties.submission_id: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fields_option_id"]) -> typing.Union[MetaOapg.properties.fields_option_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["entry"]) -> typing.Union[MetaOapg.properties.entry, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fields_option_ids"]) -> typing.Union[MetaOapg.properties.fields_option_ids, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "submission_id", "field_id", "public_id", "fields_option_id", "entry", "fields_option_ids", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        field_id: typing.Union[MetaOapg.properties.field_id, decimal.Decimal, int, ],
        submission_id: typing.Union[MetaOapg.properties.submission_id, decimal.Decimal, int, ],
        ...
        fields_option_id: typing.Union[MetaOapg.properties.fields_option_id, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        entry: typing.Union[MetaOapg.properties.entry, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        fields_option_ids: typing.Union[MetaOapg.properties.fields_option_ids, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
