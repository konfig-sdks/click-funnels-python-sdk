...
class OrdersInvoicesRestockListRestocksResponseItem(
    schemas.DictSchema
):
    """
    ...
    included_invoices_line_items: MetaOapg.properties.included_invoices_line_items
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "contact_id", "status", "created_at", "updated_at", "included_invoices_line_items", "public_id", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["included_invoices_line_items"]) -> MetaOapg.properties.included_invoices_line_items: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "contact_id", "status", "created_at", "updated_at", "included_invoices_line_items", "public_id", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        included_invoices_line_items: typing.Union[MetaOapg.properties.included_invoices_line_items, list, tuple, ],
        ...
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'OrdersInvoicesRestockListRestocksResponseItem':
        return super().__new__(
            cls,
            *args,
            workspace_id=workspace_id,
