...
class OrdersAppliedTagAttributes(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "order_id", "tag_id", "public_id", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "order_id", "tag_id", "public_id", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        tag_id: typing.Union[MetaOapg.properties.tag_id, decimal.Decimal, int, ],
