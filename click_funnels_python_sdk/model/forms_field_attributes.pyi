...
class FormsFieldAttributes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            field_set_id = schemas.IntSchema
            label = schemas.StrSchema
            public_id = schemas.AnyTypeSchema
            field_type = schemas.AnyTypeSchema
            allow_multiple = schemas.AnyTypeSchema
    ...
    field_set_id: MetaOapg.properties.field_set_id
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["field_set_id"]) -> MetaOapg.properties.field_set_id: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["allow_multiple"]) -> MetaOapg.properties.allow_multiple: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "field_set_id", "label", "public_id", "field_type", "allow_multiple", "key", "hidden", "created_at", "updated_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["field_set_id"]) -> MetaOapg.properties.field_set_id: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["allow_multiple"]) -> typing.Union[MetaOapg.properties.allow_multiple, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "field_set_id", "label", "public_id", "field_type", "allow_multiple", "key", "hidden", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        field_set_id: typing.Union[MetaOapg.properties.field_set_id, decimal.Decimal, int, ],
        ...
        field_type: typing.Union[MetaOapg.properties.field_type, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        allow_multiple: typing.Union[MetaOapg.properties.allow_multiple, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        hidden: typing.Union[MetaOapg.properties.hidden, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
