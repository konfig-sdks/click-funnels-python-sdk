...
class ContactParameters(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email_address", "first_name", "last_name", "phone_number", "time_zone", "fb_url", "twitter_url", "instagram_url", "linkedin_url", "website_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email_address", "first_name", "last_name", "phone_number", "time_zone", "fb_url", "twitter_url", "instagram_url", "linkedin_url", "website_url", ], str]):
