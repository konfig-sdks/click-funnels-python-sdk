...
class ShippingLocationGroupAttributes(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "profile_id", "name", "public_id", "fulfillments_location_ids", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "profile_id", "name", "public_id", "fulfillments_location_ids", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        profile_id: typing.Union[MetaOapg.properties.profile_id, decimal.Decimal, int, ],
