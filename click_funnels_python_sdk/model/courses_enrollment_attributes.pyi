...
class CoursesEnrollmentAttributes(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            course_id = schemas.IntSchema
            origination_source_id = schemas.IntSchema
            ...
            suspended = schemas.AnyTypeSchema
            suspension_reason = schemas.AnyTypeSchema
            current_path = schemas.AnyTypeSchema
            origination_source_type = schemas.AnyTypeSchema
            __annotations__ = {
                "id": id,
                "contact_id": contact_id,
                "course_id": course_id,
                "origination_source_id": origination_source_id,
                "public_id": public_id,
                ...
                "origination_source_type": origination_source_type,
            }
    
    course_id: MetaOapg.properties.course_id
    id: MetaOapg.properties.id
    contact_id: MetaOapg.properties.contact_id
    origination_source_id: MetaOapg.properties.origination_source_id
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["origination_source_id"]) -> MetaOapg.properties.origination_source_id: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["suspension_reason"]) -> MetaOapg.properties.suspension_reason: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["current_path"]) -> MetaOapg.properties.current_path: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["origination_source_type"]) -> MetaOapg.properties.origination_source_type: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "contact_id", "course_id", "origination_source_id", "public_id", "created_at", "updated_at", "suspended", "suspension_reason", "current_path", "origination_source_type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["origination_source_id"]) -> MetaOapg.properties.origination_source_id: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["suspension_reason"]) -> typing.Union[MetaOapg.properties.suspension_reason, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["origination_source_type"]) -> typing.Union[MetaOapg.properties.origination_source_type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "contact_id", "course_id", "origination_source_id", "public_id", "created_at", "updated_at", "suspended", "suspension_reason", "current_path", "origination_source_type", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        course_id: typing.Union[MetaOapg.properties.course_id, decimal.Decimal, int, ],
        id: typing.Union[MetaOapg.properties.id, decimal.Decimal, int, ],
        contact_id: typing.Union[MetaOapg.properties.contact_id, decimal.Decimal, int, ],
        origination_source_id: typing.Union[MetaOapg.properties.origination_source_id, decimal.Decimal, int, ],
        ...
        suspended: typing.Union[MetaOapg.properties.suspended, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        suspension_reason: typing.Union[MetaOapg.properties.suspension_reason, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        ...
        origination_source_type: typing.Union[MetaOapg.properties.origination_source_type, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
