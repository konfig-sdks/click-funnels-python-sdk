...
class UserAttributes(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "email", "first_name", "last_name", "public_id", "time_zone", "locale", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "email", "first_name", "last_name", "public_id", "time_zone", "locale", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        locale: typing.Union[MetaOapg.properties.locale, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
