...
class ImageAttributes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            alt_text = schemas.AnyTypeSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "public_id", "url", "alt_text", "name", "created_at", "updated_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "workspace_id", "public_id", "url", "alt_text", "name", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        alt_text: typing.Union[MetaOapg.properties.alt_text, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
