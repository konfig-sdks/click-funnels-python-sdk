...
class ShippingZoneAttributes(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            location_group_id = schemas.IntSchema
            name = schemas.StrSchema
            public_id = schemas.AnyTypeSchema
            address_filter_id = schemas.AnyTypeSchema
            region_ids = schemas.AnyTypeSchema
            country_ids = schemas.AnyTypeSchema
            includes_rest_of_world = schemas.AnyTypeSchema
            ...
            __annotations__ = {
                ...
                "name": name,
                "public_id": public_id,
                "address_filter_id": address_filter_id,
                "region_ids": region_ids,
                "country_ids": country_ids,
                "includes_rest_of_world": includes_rest_of_world,
                "created_at": created_at,
                "updated_at": updated_at,
            }
    
    location_group_id: MetaOapg.properties.location_group_id
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["location_group_id"]) -> MetaOapg.properties.location_group_id: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address_filter_id"]) -> MetaOapg.properties.address_filter_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["region_ids"]) -> MetaOapg.properties.region_ids: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["country_ids"]) -> MetaOapg.properties.country_ids: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["includes_rest_of_world"]) -> MetaOapg.properties.includes_rest_of_world: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "location_group_id", "name", "public_id", "address_filter_id", "region_ids", "country_ids", "includes_rest_of_world", "created_at", "updated_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["location_group_id"]) -> MetaOapg.properties.location_group_id: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address_filter_id"]) -> typing.Union[MetaOapg.properties.address_filter_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["region_ids"]) -> typing.Union[MetaOapg.properties.region_ids, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["country_ids"]) -> typing.Union[MetaOapg.properties.country_ids, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["includes_rest_of_world"]) -> typing.Union[MetaOapg.properties.includes_rest_of_world, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "location_group_id", "name", "public_id", "address_filter_id", "region_ids", "country_ids", "includes_rest_of_world", "created_at", "updated_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        location_group_id: typing.Union[MetaOapg.properties.location_group_id, decimal.Decimal, int, ],
        ...
        address_filter_id: typing.Union[MetaOapg.properties.address_filter_id, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        region_ids: typing.Union[MetaOapg.properties.region_ids, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        country_ids: typing.Union[MetaOapg.properties.country_ids, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
        includes_rest_of_world: typing.Union[MetaOapg.properties.includes_rest_of_world, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
