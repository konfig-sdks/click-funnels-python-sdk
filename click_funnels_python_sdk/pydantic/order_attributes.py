...
from click_funnels_python_sdk.pydantic.contact_attributes import ContactAttributes
from click_funnels_python_sdk.pydantic.order_contact_group_attributes import OrderContactGroupAttributes
from click_funnels_python_sdk.pydantic.order_segment_attributes import OrderSegmentAttributes
from click_funnels_python_sdk.pydantic.orders_line_item_attributes import OrdersLineItemAttributes
from click_funnels_python_sdk.pydantic.workspace_attributes import WorkspaceAttributes
...
class OrderAttributes(BaseModel):
    ...
    # Customer
    contact_id: int = Field(alias='contact_id')

    # Currency
    currency: str = Field(alias='currency')

    # Origination Channel ID
    origination_channel_id: int = Field(alias='origination_channel_id')

    # Customer Email
    contact: ContactAttributes = Field(alias='contact')

    # Workspace
    workspace: WorkspaceAttributes = Field(alias='workspace')

    # ClickFunnels Order public ID
    public_id: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='public_id')

    # Order Number
    order_number: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='order_number')

    # Total
    total_amount: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='total_amount')

    # Origination Channel Type
    origination_channel_type: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='origination_channel_type')

    # First Name
    shipping_address_first_name: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='shipping_address_first_name')

    # Last Name
    shipping_address_last_name: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='shipping_address_last_name')

    # Organization Name
    shipping_address_organization_name: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='shipping_address_organization_name')

    # Phone Number
    shipping_address_phone_number: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='shipping_address_phone_number')

    # Street One
    shipping_address_street_one: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='shipping_address_street_one')

    # Street Two
    shipping_address_street_two: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='shipping_address_street_two')

    # City
    shipping_address_city: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='shipping_address_city')

    # State
    shipping_address_region: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='shipping_address_region')

    # Country
    shipping_address_country: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='shipping_address_country')

    # Postal Code
    shipping_address_postal_code: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='shipping_address_postal_code')

    # Street One
    billing_address_street_one: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='billing_address_street_one')

    # Street Two
    billing_address_street_two: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='billing_address_street_two')

    # City
    billing_address_city: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='billing_address_city')

    # State
    billing_address_region: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='billing_address_region')

    # Country
    billing_address_country: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='billing_address_country')

    # Postal Code
    billing_address_postal_code: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='billing_address_postal_code')

    # Page ID
    page_id: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='page_id')

    # Notes
    notes: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='notes')

    # In Trial
    in_trial: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='in_trial')

    # Billing Status
    billing_status: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='billing_status')

    # Order Status
    service_status: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='service_status')

    # Order Type
    order_type: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='order_type')

    # Next Charge At
    next_charge_at: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='next_charge_at')

    # Tax Amount
    tax_amount: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='tax_amount')

    # Trial End At
    trial_end_at: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='trial_end_at')

    # Payment Method
    billing_payment_method_id: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='billing_payment_method_id')

    # Funnel Name
    funnel_name: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='funnel_name')

    # Tags
    tag_ids: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='tag_ids')

    # Discounts
    discount_ids: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='discount_ids')

    # Date Activated
    activated_at: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='activated_at')
    ...
    # Phone Number
    phone_number: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='phone_number')

    # Page Name
    page_name: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='page_name')

    # Origination Channel Name
    origination_channel_name: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='origination_channel_name')

    # Pages
    order_page: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='order_page')

    # Contact Groups
    contact_groups: typing.Optional[typing.List[OrderContactGroupAttributes]] = Field(None, alias='contact_groups')

    # Segments
    segments: typing.Optional[typing.List[OrderSegmentAttributes]] = Field(None, alias='segments')

    # Order Line Items
    line_items: typing.Optional[typing.List[OrdersLineItemAttributes]] = Field(None, alias='line_items')
    ...
    previous_line_item: typing.Optional[typing.Union[bool, date, datetime, dict, float, int, list, str, None]] = Field(None, alias='previous_line_item')
